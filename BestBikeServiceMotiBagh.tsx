// BestBikeServiceMotiBagh.tsx
// Moti Bagh specific SEO/content + Home.tsx design system (video hero, Framer Motion, marquees)
...
// Moti Bagh specific / existing assets — kept from the master page
...
const BestBikeServiceMotiBagh = () => {
  ...
  // hero's top offset so the hero video always starts immediately below the navbar with 0px gap.
  ...
  // Hot Deals marquee images — Moti Bagh specific copy/alt text, Home-style assets
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Moti Bagh' },
    { src: hotDealsImage2, alt: 'Doorstep scooty service near Moti Bagh Metro Station' },
    { src: hotDealsImage3, alt: 'Car engine repair near Nanakpura and R.K. Puram' },
    { src: hotDealsImage4, alt: 'Roadside vehicle assistance near Shanti Niketan and Dhaula Kuan' },
    { src: hotDealsImage5, alt: 'Doorstep bike repair deal near South Moti Bagh and Vasant Vihar' },
  ];
  const hotDealsAreaBadges = ['Moti Bagh', 'Nanakpura', 'R.K. Puram', 'Shanti Niketan', 'Dhaula Kuan', 'Vasant Vihar'];
  ...
  // Service Available marquee — Moti Bagh specific phrases
  const serviceCities = [
    { name: 'Bike Service in Moti Bagh', color: 'text-indigo-700' },
    { name: 'Scooty Service in Moti Bagh', color: 'text-red-700' },
    { name: 'Car Service in Moti Bagh', color: 'text-teal-700' },
    { name: 'Doorstep Vehicle Service in Moti Bagh', color: 'text-gray-900' },
    { name: 'Bike Repair in Moti Bagh', color: 'text-orange-700' },
    { name: 'Scooty Repair in Moti Bagh', color: 'text-slate-700' },
    { name: 'Car Repair in Moti Bagh', color: 'text-blue-800' },
    { name: 'Same-Day Vehicle Service in Moti Bagh', color: 'text-emerald-700' },
    { name: 'Bike Service in South Moti Bagh', color: 'text-purple-700' },
    { name: 'Bike Service in North Moti Bagh', color: 'text-pink-700' },
    { name: 'Scooty Service near Nanakpura', color: 'text-cyan-700' },
    { name: 'Car Service near Moti Bagh Metro', color: 'text-amber-700' },
  ];

  // Areas Covered — Moti Bagh and nearby service areas
  const coveredAreas = [
    'Moti Bagh', 'North Moti Bagh', 'South Moti Bagh', 'Moti Bagh I', 'Moti Bagh II',
    'New Moti Bagh', 'Nanakpura', 'Nanakpura Market', 'Begum Zaidi Market', 'Basrurkar Market',
    'Moti Bagh Market', 'Moti Bagh Metro area', 'Sir Vishweshwaraiah Moti Bagh Metro Station',
    'Rao Tula Ram Marg', 'Ring Road', 'Shanti Niketan', 'Anand Niketan', 'Satya Niketan',
    'R.K. Puram', 'Rama Krishna Puram', 'R.K. Puram Sector 8', 'R.K. Puram Sector 9', 'R.K. Puram Sector 12',
    'Vasant Vihar', 'Vasant Enclave', 'West End', 'Chanakyapuri', 'Diplomatic Enclave',
    'Dhaula Kuan', 'Delhi Cantonment', 'Delhi Cantt', 'Naraina', 'Naraina Vihar',
    'Safdarjung Enclave', 'Bhikaji Cama Place', 'Netaji Nagar', 'Sarojini Nagar', 'South Campus',
    'Benito Juarez Road', 'Africa Avenue', 'Shankar Vihar', 'Munirka', 'Ber Sarai',
  ];
  ...
  const cityPages = [
    ...
    { name: 'R.K. Puram', path: '/best-bike-service-rk-puram' },
    { name: 'Vasant Vihar', path: '/best-bike-service-vasant-vihar' },
    { name: 'Sarojini Nagar', path: '/best-bike-service-sarojini-nagar' },
    { name: 'Shanti Niketan', path: '/best-bike-service-shanti-niketan' },
    { name: 'Anand Niketan', path: '/best-bike-service-anand-niketan' },
    { name: 'Satya Niketan', path: '/best-bike-service-satya-niketan' },
    { name: 'Naraina', path: '/best-bike-service-naraina' },
    { name: 'Safdarjung Enclave', path: '/best-bike-service-safdarjung-enclave' },
    { name: 'Bhikaji Cama Place', path: '/best-bike-service-bhikaji-cama-place' },
    { name: 'New Friends Colony', path: '/best-bike-service-new-friends-colony' },
    { name: 'Malviya Nagar', path: '/best-bike-service-malviya-nagar' },
    { name: 'Kalkaji', path: '/best-bike-service-kalkaji' },
    ...
    { name: 'Rohini', path: '/best-bike-service-rohini' },
  ...
  // FAQs — visible + FAQPage schema MUST match exactly
  const faqs = [
    { q: 'What is the best bike, scooty and car service in Moti Bagh?', a: 'Garage Fix Care is Moti Bagh\'s highest-rated doorstep service for bikes, scooties and cars, starting at ₹299 with certified mechanics, transparent pricing, genuine parts, and a 10-day service guarantee.' },
    { q: 'How much does bike or scooty service cost in Moti Bagh, Delhi?', a: 'Bike and scooty service in Moti Bagh at Garage Fix Care starts from ₹299 for 100–125cc vehicles (Regular Service). Classic Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Royal Service (350–450 CC) is ₹599, and Sports Service (above 500 CC) is ₹999. All prices include labour with zero hidden charges.' },
    { q: 'Do you provide car service in Moti Bagh too?', a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing in Moti Bagh and nearby areas like Nanakpura, R.K. Puram and Vasant Vihar. Car service pricing is quoted based on your car\'s model and the work required — just book online or call us for a quote.' },
    { q: 'Do you provide doorstep bike and scooty repair near Moti Bagh Metro Station?', a: 'Yes, we provide complete doorstep bike and scooty repair across Moti Bagh, North Moti Bagh, South Moti Bagh, and around Sir Vishweshwaraiah Moti Bagh Metro Station. Our certified mechanics arrive with all tools, oils, and parts — no garage visit needed.' },
    { q: 'Which areas near Moti Bagh are covered for bike, scooty and car service?', a: 'We cover Moti Bagh, North Moti Bagh, South Moti Bagh, Moti Bagh I and II, New Moti Bagh, Nanakpura, Moti Bagh Market, Rao Tula Ram Marg, Ring Road, Shanti Niketan, Anand Niketan, Satya Niketan, R.K. Puram, Vasant Vihar, West End, Chanakyapuri, Dhaula Kuan, Delhi Cantt, Naraina, Safdarjung Enclave, Bhikaji Cama Place, Netaji Nagar, Sarojini Nagar, South Campus, Shankar Vihar, Munirka and Ber Sarai.' },
    { q: 'Do you service Royal Enfield bikes near Moti Bagh?', a: 'Yes. We specialise in Royal Enfield servicing across Moti Bagh and nearby Nanakpura and R.K. Puram — Classic 350, Bullet 350, Meteor 350, Himalayan, and Thunderbird — all serviced at your doorstep.' },
    { q: 'How quickly can a mechanic reach me in Moti Bagh?', a: 'Our mechanics typically reach your location in Moti Bagh or nearby Nanakpura, R.K. Puram and Shanti Niketan within 2–4 hours of booking, for bikes, scooties and cars alike. For urgent requests, call us and we will prioritise your slot.' },
    { q: 'Is your bike, scooty and car service pricing transparent in Moti Bagh?', a: 'Absolutely. We provide a full itemised cost estimate before starting any work, whether it\'s a bike, scooty or car. No surprise bills — what you see is exactly what you pay.' },
    { q: 'Do you service scooties near Shanti Niketan and R.K. Puram?', a: 'Yes. We repair and service all scooties near Shanti Niketan, R.K. Puram and Vasant Vihar — Honda Activa, TVS Jupiter, Suzuki Access 125, Honda Dio, Hero Maestro — all at your doorstep.' },
    { q: 'Do you offer a warranty on bike, scooty and car service in Moti Bagh?', a: 'Every service by Garage Fix Care in Moti Bagh includes a 10-day hassle-free service guarantee, whether it\'s a bike, scooty or car. If any issue arises post-service, we address it at no extra cost.' },
    { q: 'How do I book a bike, scooty or car mechanic near me in Moti Bagh?', a: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Let us know whether it\'s a bike, scooty or car, share your area near Moti Bagh and preferred time slot — we handle the rest.' },
    { q: 'What payment methods are accepted in Moti Bagh?', a: 'We accept cash, UPI (Google Pay, PhonePe, Paytm), and all major mobile wallets. Payment is collected only after the service is complete.' },
    { q: 'Do I need to arrange any tools or oils?', a: 'No. Our Moti Bagh mechanics arrive fully equipped — tools, genuine Motul/Wurth engine oils, and all required spare parts are brought to your doorstep, for bikes, scooties and cars.' },
    { q: 'Do you handle emergency bike, scooty or car breakdown near Moti Bagh or Dhaula Kuan?', a: 'Yes. If your bike, scooty or car breaks down anywhere near Moti Bagh Metro Station, Nanakpura or Dhaula Kuan, call us immediately and we dispatch a mechanic to your location.' },
    { q: 'What makes Garage Fix Care better than a local Moti Bagh workshop?', a: 'We come to you for bikes, scooties and cars, save your travel time, offer transparent itemised billing, use genuine parts, and provide a 10-day warranty — something most local Moti Bagh workshops cannot match.' },
  ];

  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in Moti Bagh | Doorstep Service Just ₹299"
        description="Garage Fix Care offers doorstep bike, scooty and car service in Moti Bagh, Delhi, North Moti Bagh, South Moti Bagh, Nanakpura, R.K. Puram and nearby areas, starting at just ₹299. Certified mechanics, same-day service at your home."
        canonical="https://www.garagefixcare.in/best-bike-service-moti-bagh"
        robots="index, follow"
        og={{
          url: 'https://www.garagefixcare.in/best-bike-service-moti-bagh',
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Best bike, scooty and car service in Moti Bagh at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in Moti Bagh, Nanakpura and R.K. Puram',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Moti Bagh, Delhi. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299.',
            url: 'https://www.garagefixcare.in/best-bike-service-moti-bagh',
            ...
            address: {
              '@type': 'PostalAddress',
              addressLocality: 'Moti Bagh, New Delhi',
              addressRegion: 'Delhi',
              addressCountry: 'IN',
            },
            geo: { '@type': 'GeoCoordinates', latitude: '28.5797', longitude: '77.1771' },
            areaServed: [
              { '@type': 'Place', name: 'Moti Bagh' },
              { '@type': 'Place', name: 'North Moti Bagh' },
              { '@type': 'Place', name: 'South Moti Bagh' },
              { '@type': 'Place', name: 'Moti Bagh I' },
              { '@type': 'Place', name: 'Moti Bagh II' },
              { '@type': 'Place', name: 'New Moti Bagh' },
              { '@type': 'Place', name: 'Nanakpura' },
              { '@type': 'Place', name: 'Nanakpura Market' },
              { '@type': 'Place', name: 'Moti Bagh Market' },
              { '@type': 'Place', name: 'Sir Vishweshwaraiah Moti Bagh Metro Station' },
              { '@type': 'Place', name: 'Rao Tula Ram Marg' },
              { '@type': 'Place', name: 'Shanti Niketan' },
              { '@type': 'Place', name: 'Anand Niketan' },
              { '@type': 'Place', name: 'Satya Niketan' },
              ...
              { '@type': 'Place', name: 'Delhi Cantt' },
              { '@type': 'Place', name: 'Naraina' },
              { '@type': 'Place', name: 'Safdarjung Enclave' },
              { '@type': 'Place', name: 'Bhikaji Cama Place' },
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Doorstep Bike, Scooty and Car Service in Moti Bagh',
            provider: { '@type': 'LocalBusiness', name: 'Garage Fix Care' },
            areaServed: 'Moti Bagh, New Delhi',
            description: 'At-home bike, scooty and car servicing starting at ₹299 across Moti Bagh, North Moti Bagh, South Moti Bagh, Moti Bagh I and II, New Moti Bagh, Nanakpura, Moti Bagh Market, Rao Tula Ram Marg, Ring Road, Shanti Niketan, Anand Niketan, Satya Niketan, R.K. Puram, Vasant Vihar, West End, Chanakyapuri, Dhaula Kuan, Delhi Cantt, Naraina, Safdarjung Enclave, Bhikaji Cama Place, Netaji Nagar, Sarojini Nagar, South Campus, Shankar Vihar, Munirka and Ber Sarai. Oil change, engine repair, battery replacement, puncture fix and car maintenance — same-day doorstep service.',
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Moti Bagh', item: 'https://www.garagefixcare.in/best-bike-service-moti-bagh' },
              { '@type': 'ListItem', position: 4, name: 'Best Bike, Scooty and Car Service in Moti Bagh', item: 'https://www.garagefixcare.in/best-bike-service-moti-bagh' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Moti Bagh specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in Moti Bagh
        ...
        {/* Dark premium information strip — Moti Bagh specific copy */}
        <motion.div
          className="w-full"
          style={{
          ...
          <div className="max-w-[1100px] mx-auto px-[14px] py-[10px] sm:px-6 sm:py-3.5 relative overflow-hidden">
            ...
            <span className="relative inline-flex items-center gap-1.5 mb-1">
              ...
              <span className="text-[8px] sm:text-[9px] font-semibold uppercase tracking-wider" style={{ color: '#ff7a00' }}>
                Garage Fix Care — Moti Bagh, Delhi
              </span>
            </span>
            <p className="relative text-[10px] sm:text-sm leading-[1.4] sm:leading-relaxed" style={{ color: '#cbd5e1' }}>
              Skip the garage queue. Our certified mechanics come to your home, office or society across Moti Bagh, North Moti Bagh, South Moti Bagh, Moti Bagh I and II, New Moti Bagh, Nanakpura, Moti Bagh Market, Rao Tula Ram Marg, Ring Road, Shanti Niketan, Anand Niketan, Satya Niketan, R.K. Puram, Vasant Vihar, West End, Chanakyapuri, Dhaula Kuan, Delhi Cantt, Naraina, Safdarjung Enclave, Bhikaji Cama Place, Netaji Nagar, Sarojini Nagar, South Campus, Shankar Vihar, Munirka and Ber Sarai — servicing bikes, scooties and cars, from routine maintenance to engine repairs, starting at ₹299. Fast, transparent, and affordable.
            </p>
          </div>
        </motion.div>

        {/* Marquee: Service Available in Moti Bagh */}
        ...
        {/* Hot Deals This Week — Moti Bagh specific copy, Home-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Limited-time offer for Moti Bagh, Nanakpura and R.K. Puram customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Moti Bagh pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service near Moti Bagh and Nanakpura, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service Areas in <span className="text-red-600">Moti Bagh</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you live in Moti Bagh, North Moti Bagh, South Moti Bagh, Moti Bagh I and II, New Moti Bagh, near Nanakpura, Moti Bagh Market, or around Sir Vishweshwaraiah Moti Bagh Metro Station, or in nearby service areas like Rao Tula Ram Marg, Ring Road, Shanti Niketan, Anand Niketan, Satya Niketan, R.K. Puram, Vasant Vihar, West End, Chanakyapuri, Dhaula Kuan, Delhi Cantt, Naraina, Safdarjung Enclave, Bhikaji Cama Place, Netaji Nagar, Sarojini Nagar, South Campus, Shankar Vihar, Munirka or Ber Sarai — our bike, scooty and car mechanics reach your doorstep within 2-4 hours. Same-day doorstep service available across the Moti Bagh belt and nearby South-West Delhi localities, starting at ₹299.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Bike, Scooty &amp; Car Care, <span className="text-red-600">Right at Your Door in Moti Bagh</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Moti Bagh mechanics handle bikes, scooties and cars at your location, starting at ₹299. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Comprehensive SEO Content (Moti Bagh specific, 1000+ words) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in Moti Bagh</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>Moti Bagh is a quiet, leafy residential pocket in South-West Delhi, split by the railway line into North Moti Bagh and South Moti Bagh, and anchored by the busy Sir Vishweshwaraiah Moti Bagh Metro Station on the Pink Line. Residents here range from long-time government colony families and retired officers to young professionals working in nearby R.K. Puram, Chanakyapuri, and Vasant Vihar. Whether you park your bike outside a house in Moti Bagh I or II, keep your scooty in a Nanakpura society, or drive a car from New Moti Bagh toward Dhaula Kuan every morning, the daily commute through Rao Tula Ram Marg and Ring Road slowly wears down engine oil, tyres, brakes, and filters. Garage Fix Care is Moti Bagh&apos;s most trusted doorstep vehicle service, bringing certified, background-verified mechanics right to your home, office, or society gate — whether you&apos;re based in North Moti Bagh, South Moti Bagh, Nanakpura Market, Begum Zaidi Market, or in nearby service areas like Shanti Niketan, Anand Niketan, Satya Niketan, R.K. Puram, Vasant Vihar, West End, Chanakyapuri, Dhaula Kuan, Delhi Cantt, Naraina, Safdarjung Enclave, Bhikaji Cama Place, Netaji Nagar, Sarojini Nagar, South Campus, Shankar Vihar, Munirka, and Ber Sarai. Our mechanics reach your location within 2–4 hours of booking. Doorstep bike and scooty service in Moti Bagh starts at just ₹299 — covering all essential checks including engine oil change, air filter cleaning, spark plug inspection, brake adjustment, and basic electrical check — with every task completed on the spot without you needing to ride to a workshop. We also handle car servicing and repairs at your doorstep, with pricing quoted based on your car&apos;s model and requirement. We service every major two-wheeler brand seen across Moti Bagh: Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM, and more, handling everything from daily commuters and premium sports bikes to family scooties like the Honda Activa, TVS Jupiter, and Suzuki Access, alongside popular hatchbacks and sedans. What distinguishes us as the best bike, scooty and car service in Moti Bagh is our strict pricing transparency — you receive a full itemised estimate before a single tool is touched, ensuring zero hidden charges at the end. We use only genuine engine oils from Motul and Wurth, paired with manufacturer-approved spare parts, and each service is backed by our 10-day hassle-free service guarantee.</p>
              <p>The daily flow toward Sir Vishweshwaraiah Moti Bagh Metro Station, the traffic merge at Rao Tula Ram Marg, and the constant movement along Ring Road toward Dhaula Kuan accelerate wear on engine oil, air filters, tyres, and brakes — making regular servicing not just a good habit but a safety necessity for bikes, scooties, and cars alike. Our mechanics carry professional diagnostic tools to identify emerging issues before they become expensive failures, significantly extending your vehicle&apos;s lifespan whether you commute daily through Nanakpura or just within the Shanti Niketan belt. We also handle emergency breakdown situations across Moti Bagh — if your bike, scooty, or car stops near Moti Bagh Market or anywhere on the way toward R.K. Puram or Vasant Vihar, call us and we dispatch a mechanic to your exact location immediately. From battery replacement and brake pad changes to clutch cable adjustment and tyre puncture repair, our technicians fix it all on the spot. Garage Fix Care has completed over 1,00,000 services across Delhi NCR, earning a consistent 4.7-star Google rating for professionalism, punctuality, and honest pricing. Book your bike, scooty, or car service in Moti Bagh, North Moti Bagh, South Moti Bagh, Moti Bagh I and II, New Moti Bagh, Nanakpura, Moti Bagh Market, Rao Tula Ram Marg, Ring Road, Shanti Niketan, Anand Niketan, Satya Niketan, R.K. Puram, Vasant Vihar, West End, Chanakyapuri, Dhaula Kuan, Delhi Cantt, Naraina, Safdarjung Enclave, Bhikaji Cama Place, Netaji Nagar, Sarojini Nagar, South Campus, Shankar Vihar, Munirka, or Ber Sarai today via our website, WhatsApp, or direct call — and discover the convenience of professional doorstep vehicle care starting at just ₹299.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Moti Bagh
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Moti Bagh&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM, and more — right at your home or office near Nanakpura and R.K. Puram.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Moti Bagh" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to residents of Moti Bagh, Nanakpura, and R.K. Puram — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced near Moti Bagh is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your vehicle running at its best — starting at ₹299, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Moti Bagh" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Vikram Bisht', img: testimonial1, text: 'Doorstep service near Moti Bagh Metro Station was fast and professional.', time: 'a month ago' },
                { name: 'Pooja Rathi', img: testimonial2, text: 'Transparent billing with video evidence, booked from South Moti Bagh. Very reliable.', time: 'a month ago' },
                { name: 'Ravinder Negi', img: testimonial3, text: 'Great service near Nanakpura, convenient and affordable.', time: 'a month ago' },
                { name: 'Simran Kaur', img: testimonial4, text: 'Quick response near R.K. Puram, professional mechanic. Will recommend.', time: 'a month ago' },
              ].map(t => (
        ...
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in Moti Bagh — <span className="text-red-600">Common Questions</span>
            </motion.h2>
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike, Scooty or Car Service in Moti Bagh Today
            </h2>
...
export default BestBikeServiceMotiBagh;