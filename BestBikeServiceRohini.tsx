// BestBikeServiceRohini.tsx
// Rohini specific SEO/content + Delhi Cantt master design system
...
const BestBikeServiceRohini = () => {
  ...
  // Hot Deals marquee images — Rohini specific copy/alt text
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Rohini, Delhi' },
    { src: hotDealsImage2, alt: 'Doorstep scooty service near Rohini Sector 7' },
    { src: hotDealsImage3, alt: 'Car engine repair near Prashant Vihar' },
    { src: hotDealsImage4, alt: 'Roadside vehicle assistance near Rithala' },
    { src: hotDealsImage5, alt: 'Doorstep vehicle repair deal near Pitampura' },
  ];
  const hotDealsAreaBadges = ['Rohini', 'Prashant Vihar', 'Rithala', 'Pitampura', 'Pooth Kalan', 'Budh Vihar'];
  ...
  const serviceCities = [
    { name: 'Rohini', color: 'text-indigo-700' },
    { name: 'Prashant Vihar', color: 'text-red-700' },
    { name: 'Rithala', color: 'text-teal-700' },
    { name: 'Pitampura', color: 'text-gray-900' },
    { name: 'Pooth Kalan', color: 'text-orange-700' },
    { name: 'Budh Vihar', color: 'text-slate-700' },
  ];

  const coveredAreas = [
    'Rohini Sector 1', 'Rohini Sector 7', 'Rohini Sector 8', 'Rohini Sector 9',
    'Rohini Sector 11', 'Rohini Sector 13', 'Rohini Sector 14', 'Rohini Sector 16',
    'Rohini Sector 17', 'Rohini Sector 18', 'Rohini Sector 22', 'Rohini Sector 24',
    'Prashant Vihar', 'Rithala', 'Vijay Vihar', 'Pooth Kalan',
    'Begumpur', 'Budh Vihar', 'Avantika', 'Naharpur',
    'Deepali', 'Saraswati Vihar', 'Pitampura', 'Mangolpuri',
  ];
  ...
  const faqs = [
    {
      q: 'What is the best bike, scooty and car service in Rohini?',
      a: "Garage Fix Care is Rohini's trusted doorstep service for bikes, scooties and cars, starting at just ₹299 for bike and scooty service, with certified mechanics, transparent pricing, genuine parts and a 10-day service guarantee.",
    },
    {
      q: 'How much does bike or scooty service cost in Rohini?',
      a: 'Bike and scooty service in Rohini starts from ₹299 for 100–125cc vehicles (Regular Service). Classic Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Royal Service (350–450 CC) is ₹599, and Sports Service (above 500 CC) is ₹999. All prices include labour with zero hidden charges.',
    },
    {
      q: 'Do you provide car service in Rohini too?',
      a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing and repairs in Rohini and nearby areas. Car service is quoted transparently based on your car model and the work required — just book online or call us for a quote.',
    },
    {
      q: 'Which Rohini sectors are covered for doorstep service?',
      a: 'We cover Rohini Sector 1, Sector 7, Sector 8, Sector 9, Sector 11, Sector 13, Sector 14, Sector 16, Sector 17, Sector 18, Sector 22 and Sector 24, along with Prashant Vihar, Rithala, Vijay Vihar, Pooth Kalan, Begumpur, Budh Vihar, Avantika, Naharpur, Deepali, Saraswati Vihar, Pitampura and Mangolpuri.',
    },
    {
      q: 'Do you provide doorstep service in Rohini societies and apartments?',
      a: 'Yes. Our mechanics regularly service vehicles inside residential societies and apartment complexes across Rohini. Share your society name, sector and gate number while booking — we come directly to your parking bay.',
    },
    {
      q: 'Do you handle emergency breakdown near Rithala or Rohini East Metro Station?',
      a: 'Yes. If your bike, scooty or car breaks down near Rithala Metro Station, Rohini East Metro Station or anywhere in the Rohini district, call us immediately and we dispatch a mechanic to your location.',
    },
    {
      q: 'Do you provide doorstep vehicle service in Prashant Vihar and Pitampura?',
      a: 'Yes. Prashant Vihar and Pitampura both fall within our doorstep service zone for bikes, scooties and cars. Same-day doorstep service is available subject to location and technician availability.',
    },
    {
      q: 'Do you service Royal Enfield and other major bike brands in Rohini?',
      a: 'Yes. We specialise in Royal Enfield servicing across Rohini — Classic 350, Bullet 350, Meteor 350, Hunter 350 and Himalayan — and we also handle Hero, Honda, Bajaj, TVS, Suzuki, Yamaha and KTM models at your doorstep.',
    },
    {
      q: 'Is your bike, scooty and car service pricing transparent in Rohini?',
    ...
    {
      q: 'Do you offer a warranty on bike, scooty and car service in Rohini?',
      a: 'Every service by Garage Fix Care in Rohini includes a 10-day hassle-free service guarantee, whether it is a bike, scooty or car. If any issue arises post-service, we address it at no extra cost.',
    },
    {
      q: 'Do you provide free pickup and drop for service in Rohini?',
    ...
    {
      q: 'How do I book a bike, scooty or car mechanic near me in Rohini?',
      a: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Let us know whether it is a bike, scooty or car, share your Rohini sector or nearby area, and your preferred time slot — we handle the rest.',
    },
  ];
  ...
  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in Rohini | Doorstep Service Just ₹299"
        description="Garage Fix Care offers doorstep bike, scooty and car service in Rohini, Delhi, covering Rohini Sector 1, Sector 7, Sector 8, Sector 9, Sector 11, Sector 13, Sector 14, Sector 16, Sector 17, Sector 18, Sector 22, Sector 24, Prashant Vihar, Rithala, Pitampura, Pooth Kalan and nearby areas, starting at just ₹299. Certified mechanics, transparent pricing and same-day doorstep service."
        canonical="https://www.garagefixcare.in/best-bike-service-rohini"
        robots="index, follow"
        og={{
          url: 'https://www.garagefixcare.in/best-bike-service-rohini',
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Best bike, scooty and car service in Rohini at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in Rohini, Prashant Vihar and Pitampura',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Rohini, Delhi. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299 for bike and scooty service.',
            url: 'https://www.garagefixcare.in/best-bike-service-rohini',
            ...
            geo: { '@type': 'GeoCoordinates', latitude: '28.7495', longitude: '77.0565' },
            areaServed: [
              { '@type': 'Place', name: 'Rohini Sector 1' },
              { '@type': 'Place', name: 'Rohini Sector 7' },
              { '@type': 'Place', name: 'Rohini Sector 8' },
              { '@type': 'Place', name: 'Rohini Sector 9' },
              { '@type': 'Place', name: 'Rohini Sector 11' },
              { '@type': 'Place', name: 'Rohini Sector 13' },
              { '@type': 'Place', name: 'Rohini Sector 14' },
              { '@type': 'Place', name: 'Rohini Sector 16' },
              { '@type': 'Place', name: 'Rohini Sector 17' },
              { '@type': 'Place', name: 'Rohini Sector 18' },
              { '@type': 'Place', name: 'Rohini Sector 22' },
              { '@type': 'Place', name: 'Rohini Sector 24' },
              { '@type': 'Place', name: 'Prashant Vihar' },
              { '@type': 'Place', name: 'Rithala' },
              { '@type': 'Place', name: 'Vijay Vihar' },
              { '@type': 'Place', name: 'Pooth Kalan' },
              { '@type': 'Place', name: 'Begumpur' },
              { '@type': 'Place', name: 'Budh Vihar' },
              { '@type': 'Place', name: 'Avantika' },
              { '@type': 'Place', name: 'Naharpur' },
              { '@type': 'Place', name: 'Deepali' },
              { '@type': 'Place', name: 'Saraswati Vihar' },
              { '@type': 'Place', name: 'Pitampura' },
              { '@type': 'Place', name: 'Mangolpuri' },
            ],
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Doorstep Bike, Scooty and Car Service in Rohini',
            provider: { '@type': 'LocalBusiness', name: 'Garage Fix Care' },
            areaServed: 'Rohini, New Delhi',
            description: 'At-home bike, scooty and car servicing across Rohini and nearby North-West Delhi areas including Prashant Vihar, Rithala, Vijay Vihar, Pooth Kalan, Begumpur, Budh Vihar, Avantika, Naharpur, Deepali, Saraswati Vihar, Pitampura and Mangolpuri. Bike and scooty service starts at ₹299, covering oil change, engine repair, battery replacement, brake repair, tyre service and puncture fix. Car service is quote-based and depends on the car model and work required — same-day doorstep