// BestBikeServiceLajpatNagar.tsx
// Lajpat Nagar specific SEO/content + Delhi Cantt master design system
...
const BestBikeServiceLajpatNagar = () => {
  ...
  // Hot Deals marquee images — Lajpat Nagar specific copy/alt text
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Lajpat Nagar, Delhi' },
    { src: hotDealsImage2, alt: 'Doorstep scooty service near Central Market Lajpat Nagar' },
    { src: hotDealsImage3, alt: 'Car engine repair near Amar Colony' },
    { src: hotDealsImage4, alt: 'Roadside vehicle assistance near Defence Colony' },
    { src: hotDealsImage5, alt: 'Doorstep vehicle repair deal near Greater Kailash' },
  ];
  const hotDealsAreaBadges = ['Lajpat Nagar', 'Central Market', 'Amar Colony', 'Defence Colony', 'Greater Kailash', 'South Extension'];
  ...
  const serviceCities = [
    { name: 'Lajpat Nagar', color: 'text-indigo-700' },
    { name: 'Central Market', color: 'text-red-700' },
    { name: 'Amar Colony', color: 'text-teal-700' },
    { name: 'Defence Colony', color: 'text-gray-900' },
    { name: 'Greater Kailash', color: 'text-orange-700' },
    { name: 'South Extension', color: 'text-slate-700' },
  ];

  const coveredAreas = [
    'Lajpat Nagar I', 'Lajpat Nagar II', 'Lajpat Nagar III', 'Lajpat Nagar IV',
    'Central Market', 'Amar Colony', 'Dayanand Colony', 'Vikram Vihar',
    'Old Double Storey', 'Krishna Market', 'National Park', 'Defence Colony',
    'East of Kailash', 'Greater Kailash', 'Kalkaji', 'Jangpura',
    'Andrews Ganj', 'South Extension', 'Moolchand', 'Amar Colony Market',
  ];
  ...
  const faqs = [
    {
      q: 'What is the best bike, scooty and car service in Lajpat Nagar?',
      a: "Garage Fix Care is Lajpat Nagar's trusted doorstep service for bikes, scooties and cars, starting at just ₹299 for bike and scooty service, with certified mechanics, transparent pricing, genuine parts and a 10-day service guarantee.",
    },
    {
      q: 'How much does bike or scooty service cost in Lajpat Nagar?',
      a: 'Bike and scooty service in Lajpat Nagar starts from ₹299 for 100–125cc vehicles (Regular Service). Classic Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Royal Service (350–450 CC) is ₹599, and Sports Service (above 500 CC) is ₹999. All prices include labour with zero hidden charges.',
    },
    {
      q: 'Do you provide car service in Lajpat Nagar too?',
      a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing and repairs in Lajpat Nagar and nearby areas. Car service is quoted transparently based on your car model and the work required — just book online or call us for a quote.',
    },
    {
      q: 'Which parts of Lajpat Nagar are covered for doorstep service?',
      a: 'We cover Lajpat Nagar I, II, III and IV, Central Market, Amar Colony, Dayanand Colony, Vikram Vihar, Old Double Storey, Krishna Market, National Park, Defence Colony, East of Kailash, Greater Kailash, Kalkaji, Jangpura, Andrews Ganj, South Extension, Moolchand and Amar Colony Market.',
    },
    {
      q: 'Do you provide doorstep service in Lajpat Nagar societies and apartments?',
      a: 'Yes. Our mechanics regularly service vehicles inside residential societies and apartment complexes across all four Lajpat Nagar blocks. Share your block, society name and gate number while booking — we come directly to your parking bay.',
    },
    {
      q: 'Do you handle emergency breakdown near Central Market or Moolchand?',
      a: 'Yes. If your bike, scooty or car breaks down near Central Market Lajpat Nagar, Moolchand, Amar Colony or anywhere in the Lajpat Nagar district, call us immediately and we dispatch a mechanic to your location.',
    },
    {
      q: 'Do you provide doorstep vehicle service in Defence Colony and Greater Kailash?',
      a: 'Yes. Defence Colony, Greater Kailash, East of Kailash and South Extension all fall within our doorstep service zone for bikes, scooties and cars. Same-day doorstep service is available subject to location and technician availability.',
    },
    {
      q: 'Do you service Royal Enfield and other major bike brands in Lajpat Nagar?',
      a: 'Yes. We specialise in Royal Enfield servicing across Lajpat Nagar — Classic 350, Bullet 350, Meteor 350, Hunter 350 and Himalayan — and we also handle Hero, Honda, Bajaj, TVS, Suzuki, Yamaha and KTM models at your doorstep.',
    },
    {
      q: 'Is your bike, scooty and car service pricing transparent in Lajpat Nagar?',
    ...
    {
      q: 'Do you offer a warranty on bike, scooty and car service in Lajpat Nagar?',
      a: 'Every service by Garage Fix Care in Lajpat Nagar includes a 10-day hassle-free service guarantee, whether it is a bike, scooty or car. If any issue arises post-service, we address it at no extra cost.',
    },
    {
      q: 'Do you provide free pickup and drop for service in Lajpat Nagar?',
    ...
    {
      q: 'How do I book a bike, scooty or car mechanic near me in Lajpat Nagar?',
      a: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Let us know whether it is a bike, scooty or car, share your Lajpat Nagar block or nearby area, and your preferred time slot — we handle the rest.',
    },
  ];
  ...
  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in Lajpat Nagar | Doorstep Service Just ₹299"
        description="Garage Fix Care offers doorstep bike, scooty and car service in Lajpat Nagar, Delhi, covering Lajpat Nagar I, II, III, IV, Central Market, Amar Colony, Dayanand Colony, Vikram Vihar, Defence Colony, Greater Kailash, East of Kailash, South Extension, Kalkaji, Jangpura, Andrews Ganj and Moolchand, starting at just ₹299. Certified mechanics, transparent pricing and same-day doorstep service."
        canonical="https://www.garagefixcare.in/best-bike-service-lajpat-nagar"
        robots="index, follow"
        og={{
          url: 'https://www.garagefixcare.in/best-bike-service-lajpat-nagar',
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Best bike, scooty and car service in Lajpat Nagar at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in Lajpat Nagar, Defence Colony and Greater Kailash',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Lajpat Nagar, Delhi. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299 for bike and scooty service.',
            url: 'https://www.garagefixcare.in/best-bike-service-lajpat-nagar',
            ...
            geo: { '@type': 'GeoCoordinates', latitude: '28.5677', longitude: '77.2433' },
            areaServed: [
              { '@type': 'Place', name: 'Lajpat Nagar I' },
              { '@type': 'Place', name: 'Lajpat Nagar II' },
              { '@type': 'Place', name: 'Lajpat Nagar III' },
              { '@type': 'Place', name: 'Lajpat Nagar IV' },
              { '@type': 'Place', name: 'Central Market Lajpat Nagar' },
              { '@type': 'Place', name: 'Amar Colony' },
              { '@type': 'Place', name: 'Dayanand Colony' },
              { '@type': 'Place', name: 'Vikram Vihar' },
              { '@type': 'Place', name: 'Old Double Storey' },
              { '@type': 'Place', name: 'Krishna Market' },
              { '@type': 'Place', name: 'National Park' },
              ...
              { '@type': 'Place', name: 'Amar Colony Market' },
            ],
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Doorstep Bike, Scooty and Car Service in Lajpat Nagar',
            provider: { '@type': 'LocalBusiness', name: 'Garage Fix Care' },
            areaServed: 'Lajpat Nagar, New Delhi',
            description: 'At-home bike, scooty and car servicing across Lajpat Nagar and nearby South Delhi areas including Central Market, Amar Colony, Dayanand Colony, Vikram Vihar, Defence Colony, Greater Kailash, East of Kailash, South Extension, Kalkaji, Jangpura, Andrews Ganj and Moolchand. Bike and scooty service starts at ₹299, covering oil change, engine repair, battery replacement, brake repair, tyre service and puncture fix. Car service is quote-based and depends on the car model and work required — same-day doorstep service subject to availability.',
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Best Bike, Scooty and Car Service in Lajpat Nagar', item: 'https://www.garagefixcare.in/best-bike-service-lajpat-nagar' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Lajpat Nagar specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in Lajpat Nagar
                ...
                >
                  Trusted by residents across Lajpat Nagar I, II, III, IV, Central Market, Amar Colony, Dayanand Colony, Defence Colony, Greater Kailash, East of Kailash, South Extension and Moolchand — our certified mechanics handle bikes, scooties and cars right at your doorstep.
                </motion.p>
              </motion.div>
        ...
        {/* Dark premium information strip — Lajpat Nagar specific copy */}
        <motion.div
          className="w-full"
          style={{
        ...
        {/* Hot Deals This Week — Lajpat Nagar specific copy, Delhi Cantt-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Limited-time offer for Lajpat Nagar, Central Market and Defence Colony customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-white/70 max-w-xl mx-auto">Service support for leading two-wheeler brands across Lajpat Nagar and Delhi.</p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Lajpat Nagar pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service in Lajpat Nagar and nearby South Delhi areas, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Areas Covered — Lajpat Nagar localities */}
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              We Cover All Major Areas in <span className="text-red-600">Lajpat Nagar</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you live in Lajpat Nagar I, II, III or IV, near Central Market, Amar Colony, Dayanand Colony, Vikram Vihar, Old Double Storey, Krishna Market, National Park, Defence Colony, East of Kailash, Greater Kailash, Kalkaji, Jangpura, Andrews Ganj, South Extension or Moolchand, our bike, scooty and car mechanics reach your doorstep. Same-day doorstep service is available across the Lajpat Nagar belt, subject to location and technician availability, starting at ₹299 for bike and scooty service.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Bike, Scooty &amp; Car Care, <span className="text-red-600">Right at Your Door in Lajpat Nagar</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Lajpat Nagar mechanics handle bikes, scooties and cars at your location, starting at ₹299 for bike and scooty service. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              {bikeServiceCards.map((service, index) => (
                ...
                >
                  <img
                    src={service.img}
                    alt={`${service.name} in Lajpat Nagar`}
        ...
        {/* Comprehensive SEO Content (Lajpat Nagar specific) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in Lajpat Nagar</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>Lajpat Nagar is one of South Delhi&apos;s most vibrant and densely populated neighbourhoods, stretching across four distinct blocks and anchored by the ever-busy Central Market, Amar Colony Market and Krishna Market. Thousands of two-wheeler and car owners here depend on their vehicles for daily office commutes, metro feeder rides to Moolchand and Lajpat Nagar Metro Stations, school drops, and neighbourhood errands. Garage Fix Care is Lajpat Nagar&apos;s trusted doorstep vehicle service, bringing certified and background-verified mechanics directly to your home, society parking or office, whether you live in Lajpat Nagar I, II, III or IV, or are based closer to Amar Colony, Dayanand Colony, Vikram Vihar, Old Double Storey or National Park. Our mechanics typically reach your location within 2–4 hours of booking, subject to availability. Doorstep bike and scooty service starts at just ₹299 — covering all essential checks including engine oil change, air filter cleaning, spark plug inspection, brake adjustment and basic electrical check — with every task completed on the spot. We also handle car servicing and repairs at your doorstep, with pricing quoted based on your car&apos;s model and requirement. We service every major two-wheeler brand seen across Lajpat Nagar: Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM and more, from daily commuters and family scooties like the Honda Activa, TVS Jupiter and Suzuki Access, to premium machines like the Royal Enfield Classic 350 and KTM Duke 390, alongside popular hatchbacks and sedans. What distinguishes us as the best bike, scooty and car service in Lajpat Nagar is our strict pricing transparency — you receive a full itemised estimate before a single tool is touched, ensuring zero hidden charges at the end. We use only genuine engine oils from Motul and Wurth, paired with manufacturer-approved spare parts, and each service is backed by our 10-day hassle-free service guarantee.</p>
              <p>Lajpat Nagar&apos;s dense residential layout, the constant traffic flow around Central Market and Amar Colony Market, and the busy arterial roads connecting to Defence Colony, Greater Kailash, East of Kailash and South Extension all accelerate wear on engine oil, air filters, tyres and brakes — making regular servicing a genuine safety necessity for bikes, scooties and cars alike. Our mechanics carry professional diagnostic tools to identify emerging issues before they become expensive failures, significantly extending your vehicle&apos;s lifespan whether you commute daily towards Moolchand or just ride around your block. We also handle emergency breakdown situations across Lajpat Nagar — if your bike, scooty or car stops near Central Market, Jangpura or anywhere on the way to Kalkaji, call us and we dispatch a mechanic to your exact location as soon as possible. From battery replacement and brake pad changes to clutch cable adjustment and tyre puncture repair, our technicians fix it all on the spot without towing. Garage Fix Care has completed over 1,00,000 services across Delhi NCR, earning a consistent 4.7-star Google rating for professionalism, punctuality and honest pricing. Book your bike, scooty or car service in Lajpat Nagar I, II, III, IV, Central Market, Amar Colony, Dayanand Colony, Vikram Vihar, Old Double Storey, Krishna Market, National Park, Defence Colony, East of Kailash, Greater Kailash, Kalkaji, Jangpura, Andrews Ganj, South Extension or Moolchand today via our website, WhatsApp or direct call — and discover the convenience of professional doorstep vehicle care starting at just ₹299 for bike and scooty service.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Lajpat Nagar
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Lajpat Nagar&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM and more — right at your home or society parking near Central Market and Amar Colony.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Lajpat Nagar" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to residents across Lajpat Nagar, Defence Colony, Greater Kailash, East of Kailash and South Extension — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced in Lajpat Nagar is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your vehicle running at its best — starting at ₹299 for bike and scooty service, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Lajpat Nagar" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Vikram Bisht', img: testimonial1, text: 'Doorstep service near Central Market Lajpat Nagar was fast and professional.', time: 'a month ago' },
                { name: 'Pooja Rathi', img: testimonial2, text: 'Transparent billing with video evidence, booked from Amar Colony. Very reliable.', time: 'a month ago' },
                { name: 'Ravinder Negi', img: testimonial3, text: 'Great service near Defence Colony, convenient and affordable.', time: 'a month ago' },
        ...
        {/* FAQs (Lajpat Nagar specific — matches FAQPage schema exactly) */}
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in Lajpat Nagar — <span className="text-red-600">Common Questions</span>
            </motion.h2>
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike, Scooty or Car Service in Lajpat Nagar Today
            </h2>
            <p className="text-sm sm:text-base text-white mb-3 sm:mb-5 max-w-xl mx-auto">
              Same-day doorstep service across Lajpat Nagar and nearby areas starting at ₹299. Our mechanic comes to you — no travel, no waiting, no hidden charges.
            </p>
            <a
              href="https://www.garagefixcare.in/bookservice"
...
export default BestBikeServiceLajpatNagar;