// BestBikeServiceNSP.tsx
// Netaji Subhash Place (NSP) specific SEO/content + Home.tsx design system (video hero, Framer Motion, marquees)
...
// NSP specific / existing assets — kept from the master page
...
const BestBikeServiceNSP = () => {
  ...
  // Hot Deals marquee images — NSP specific copy/alt text, Home-style assets
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Netaji Subhash Place' },
    { src: hotDealsImage2, alt: 'Doorstep scooty service near NSP Metro Station' },
    { src: hotDealsImage3, alt: 'Car engine repair near Pitampura and NSP District Centre' },
    { src: hotDealsImage4, alt: 'Roadside vehicle assistance near Wazirpur and Shakurpur' },
    { src: hotDealsImage5, alt: 'Doorstep bike repair deal near Keshav Puram and Rani Bagh' },
  ];
  const hotDealsAreaBadges = ['Netaji Subhash Place', 'NSP', 'Pitampura', 'Shakurpur', 'Wazirpur', 'Shalimar Bagh'];
  ...
  // Service Available marquee — NSP specific phrases
  const serviceCities = [
    { name: 'Bike Service in NSP', color: 'text-indigo-700' },
    { name: 'Scooty Service in NSP', color: 'text-red-700' },
    { name: 'Car Service in NSP', color: 'text-teal-700' },
    { name: 'Doorstep Vehicle Service in NSP', color: 'text-gray-900' },
    { name: 'Bike Repair in NSP', color: 'text-orange-700' },
    { name: 'Scooty Repair in NSP', color: 'text-slate-700' },
    { name: 'Car Repair in NSP', color: 'text-blue-800' },
    { name: 'Same-Day Vehicle Service in NSP', color: 'text-emerald-700' },
    { name: 'Bike Service in Netaji Subhash Place', color: 'text-purple-700' },
    { name: 'Scooty Service in Netaji Subhash Place', color: 'text-pink-700' },
    { name: 'Car Service in Netaji Subhash Place', color: 'text-cyan-700' },
  ];

  // Areas Covered — Netaji Subhash Place and nearby service areas
  const coveredAreas = [
    'Netaji Subhash Place', 'NSP', 'NSP Commercial Complex', 'NSP Metro Station', 'NSP District Centre',
    'Pitampura', 'Poorvi Pitampura', 'Lok Vihar', 'Sandesh Vihar', 'Kohat Enclave',
    'Rani Bagh', 'Shakurpur', 'Shakurpur Colony', 'Shakur Basti', 'Wazirpur',
    'Wazirpur Industrial Area', 'Wazirpur Depot', 'Keshav Puram', 'Tri Nagar', 'Ashok Vihar',
    'Shalimar Bagh', 'Azadpur', 'Lawrence Road', 'Lawrence Road Industrial Area', 'Adarsh Nagar',
    'Model Town', 'Netaji Nagar', 'Saraswati Vihar', 'Maurya Enclave', 'Madhuban Chowk',
    'Dilli Haat Pitampura', 'Prashant Vihar', 'Rohini', 'Rithala', 'Punjabi Bagh',
    'Paschim Vihar', 'Inderlok', 'Anand Parbat',
  ];
  ...
  const cityPages = [
    ...
    { name: 'Shalimar Bagh', path: '/best-bike-service-shalimar-bagh' },
    { name: 'Ashok Vihar', path: '/best-bike-service-ashok-vihar' },
    { name: 'Wazirpur', path: '/best-bike-service-wazirpur' },
    { name: 'Keshav Puram', path: '/best-bike-service-keshav-puram' },
  ...
  const faqs = [
    { q: 'What is the best bike, scooty and car service in Netaji Subhash Place (NSP)?', a: 'Garage Fix Care is NSP\'s highest-rated doorstep service for bikes, scooties and cars, starting at ₹299 with certified mechanics, transparent pricing, genuine parts, and a 10-day service guarantee.' },
    { q: 'How much does bike or scooty service cost in NSP, Delhi?', a: 'Bike and scooty service in Netaji Subhash Place at Garage Fix Care starts from ₹299 for 100–125cc vehicles (Regular Service). Classic Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Royal Service (350–450 CC) is ₹599, and Sports Service (above 500 CC) is ₹999. All prices include labour with zero hidden charges.' },
    { q: 'Do you provide car service in Netaji Subhash Place too?', a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing in Netaji Subhash Place and nearby areas like Pitampura, Shakurpur and Wazirpur. Car service pricing is quoted based on your car\'s model and the work required — just book online or call us for a quote.' },
    { q: 'Do you provide doorstep bike and scooty repair in NSP and NSP District Centre?', a: 'Yes, we provide complete doorstep bike and scooty repair across Netaji Subhash Place, the NSP Commercial Complex and NSP District Centre. Our certified mechanics arrive with all tools, oils, and parts — no garage visit needed.' },
    { q: 'Which areas near NSP are covered for bike, scooty and car service?', a: 'We cover Netaji Subhash Place, NSP Commercial Complex, NSP Metro Station, Pitampura, Poorvi Pitampura, Lok Vihar, Kohat Enclave, Rani Bagh, Shakurpur, Shakur Basti, Wazirpur, Keshav Puram, Tri Nagar, Ashok Vihar, Shalimar Bagh, Adarsh Nagar, Model Town, Rohini and many more nearby service areas.' },
    { q: 'Do you service Royal Enfield bikes near Netaji Subhash Place?', a: 'Yes. We specialise in Royal Enfield servicing across NSP and nearby Pitampura and Shalimar Bagh — Classic 350, Bullet 350, Meteor 350, Himalayan, and Thunderbird — all serviced at your doorstep.' },
    { q: 'How quickly can a mechanic reach me in NSP?', a: 'Our mechanics typically reach your location in Netaji Subhash Place or nearby Pitampura, Shakurpur and Wazirpur within 2–4 hours of booking, for bikes, scooties and cars alike. For urgent requests, call us and we will prioritise your slot.' },
    { q: 'Is your bike, scooty and car service pricing transparent in NSP?', a: 'Absolutely. We provide a full itemised cost estimate before starting any work, whether it\'s a bike, scooty or car. No surprise bills — what you see is exactly what you pay.' },
    { q: 'Do you service scooties near Pitampura, Shakurpur and Wazirpur?', a: 'Yes. We repair and service all scooties near Pitampura, Shakurpur and Wazirpur — Honda Activa, TVS Jupiter, Suzuki Access 125, Honda Dio, Hero Maestro — all at your doorstep in and around NSP.' },
    { q: 'Do you offer a warranty on bike, scooty and car service in NSP?', a: 'Every service by Garage Fix Care in Netaji Subhash Place includes a 10-day hassle-free service guarantee, whether it\'s a bike, scooty or car. If any issue arises post-service, we address it at no extra cost.' },
    { q: 'How do I book a bike, scooty or car mechanic near me in Netaji Subhash Place?', a: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Let us know whether it\'s a bike, scooty or car, share your area near NSP and preferred time slot — we handle the rest.' },
    { q: 'What payment methods are accepted in NSP?', a: 'We accept cash, UPI (Google Pay, PhonePe, Paytm), and all major mobile wallets. Payment is collected only after the service is complete.' },
    { q: 'Do I need to arrange any tools or oils?', a: 'No. Our NSP mechanics arrive fully equipped — tools, genuine Motul/Wurth engine oils, and all required spare parts are brought to your doorstep, for bikes, scooties and cars.' },
    { q: 'Do you handle emergency bike, scooty or car breakdown near NSP Metro Station or Wazirpur?', a: 'Yes. If your bike, scooty or car breaks down anywhere near NSP Metro Station, Wazirpur or Keshav Puram, call us immediately and we dispatch a mechanic to your location.' },
    { q: 'What makes Garage Fix Care better than a local NSP workshop?', a: 'We come to you for bikes, scooties and cars, save your travel time, offer transparent itemised billing, use genuine parts, and provide a 10-day warranty — something most local Netaji Subhash Place workshops cannot match.' },
  ];

  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in NSP Delhi | Doorstep Service Just ₹299"
        description="Garage Fix Care offers doorstep bike, scooty and car service in Netaji Subhash Place (NSP), Pitampura, Shakurpur, Wazirpur and nearby North-West Delhi areas, starting at just ₹299. Certified mechanics, same-day service at your home."
        canonical="https://www.garagefixcare.in/best-bike-service-nsp"
        robots="index, follow"
        og={{
          url: 'https://www.garagefixcare.in/best-bike-service-nsp',
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Best bike, scooty and car service in Netaji Subhash Place (NSP) at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in NSP, Pitampura and Shakurpur',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Netaji Subhash Place (NSP), Delhi. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299.',
            url: 'https://www.garagefixcare.in/best-bike-service-nsp',
            ...
            address: {
              '@type': 'PostalAddress',
              addressLocality: 'Netaji Subhash Place, Pitampura, New Delhi',
              addressRegion: 'Delhi',
              addressCountry: 'IN',
            },
            geo: { '@type': 'GeoCoordinates', latitude: '28.6947', longitude: '77.1520' },
            areaServed: [
              { '@type': 'Place', name: 'Netaji Subhash Place' },
              { '@type': 'Place', name: 'NSP Commercial Complex' },
              { '@type': 'Place', name: 'NSP Metro Station' },
              { '@type': 'Place', name: 'NSP District Centre' },
              { '@type': 'Place', name: 'Pitampura' },
              { '@type': 'Place', name: 'Poorvi Pitampura' },
              { '@type': 'Place', name: 'Lok Vihar' },
              { '@type': 'Place', name: 'Kohat Enclave' },
              { '@type': 'Place', name: 'Rani Bagh' },
              { '@type': 'Place', name: 'Shakurpur' },
              { '@type': 'Place', name: 'Shakur Basti' },
              { '@type': 'Place', name: 'Wazirpur' },
              { '@type': 'Place', name: 'Wazirpur Industrial Area' },
              { '@type': 'Place', name: 'Keshav Puram' },
              { '@type': 'Place', name: 'Tri Nagar' },
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Doorstep Bike, Scooty and Car Service in Netaji Subhash Place (NSP)',
            provider: { '@type': 'LocalBusiness', name: 'Garage Fix Care' },
            areaServed: 'Netaji Subhash Place, Pitampura, New Delhi',
            description: 'At-home bike, scooty and car servicing starting at ₹299 across Netaji Subhash Place (NSP), NSP Commercial Complex, NSP Metro Station, NSP District Centre, Pitampura, Lok Vihar, Kohat Enclave, Rani Bagh, Shakurpur, Shakur Basti, Wazirpur, Keshav Puram, Tri Nagar, Ashok Vihar, Shalimar Bagh, Adarsh Nagar and Model Town. Oil change, engine repair, battery replacement, puncture fix and car maintenance — same-day doorstep service.',
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Netaji Subhash Place', item: 'https://www.garagefixcare.in/best-bike-service-nsp' },
              { '@type': 'ListItem', position: 4, name: 'Best Bike, Scooty and Car Service in NSP', item: 'https://www.garagefixcare.in/best-bike-service-nsp' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (NSP specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in NSP
        ...
        {/* Dark premium information strip — NSP specific copy */}
        <motion.div
          className="w-full"
          style={{
        ...
        {/* Hot Deals This Week — NSP specific copy, Home-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Limited-time offer for Netaji Subhash Place, Pitampura and Shakurpur customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — NSP pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service near Netaji Subhash Place (NSP) and Pitampura, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service Areas in <span className="text-red-600">Netaji Subhash Place</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you live or work in Netaji Subhash Place, the NSP Commercial Complex, near NSP Metro Station or the NSP District Centre, or in nearby service areas like Pitampura, Lok Vihar, Kohat Enclave, Rani Bagh, Shakurpur, Shakur Basti, Wazirpur, Keshav Puram, Tri Nagar, Ashok Vihar, Shalimar Bagh, Adarsh Nagar, Model Town or Rohini — our bike, scooty and car mechanics reach your doorstep within 2-4 hours. Same-day doorstep service available across the NSP belt and nearby North-West Delhi localities, starting at ₹299.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Bike, Scooty &amp; Car Care, <span className="text-red-600">Right at Your Door in NSP</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Netaji Subhash Place mechanics handle bikes, scooties and cars at your location, starting at ₹299. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              {bikeServiceCards.map((service, index) => (
                ...
                >
                  <img
                    src={service.img}
                    alt={`${service.name} in Netaji Subhash Place`}
        ...
        {/* Comprehensive SEO Content (NSP specific, 1000+ words) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in Netaji Subhash Place (NSP)</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>Netaji Subhash Place (NSP) is the commercial heart of North-West Delhi — a bustling district centre in Pitampura that houses some of the busiest corporate towers, shopping complexes, and residential pockets in the region. Thousands of riders and drivers commute daily into NSP&apos;s commercial complex and around the NSP Metro Station for work, often parking their bikes, scooties, and cars in open lots where exposure to dust, heat, and stop-and-go traffic slowly wears the engine, brakes, and tyres. Garage Fix Care is NSP&apos;s most trusted doorstep vehicle service, bringing certified, background-verified mechanics directly to your home, office, or society — whether you&apos;re based right inside Netaji Subhash Place, in nearby Pitampura, or in surrounding localities like Kohat Enclave, Rani Bagh, Shakurpur, Wazirpur, Keshav Puram, Ashok Vihar, or Shalimar Bagh. Our mechanics reach your location within 2–4 hours of booking. Doorstep bike and scooty service in NSP starts at just ₹299 — covering all essential checks including engine oil change, air filter cleaning, spark plug inspection, brake adjustment, and basic electrical check — with every task completed on the spot without you needing to ride to a workshop. We also handle car servicing and repairs at your doorstep, with pricing quoted based on your car&apos;s model and requirement. We service every major two-wheeler brand seen across NSP: Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM, and more, handling everything from daily commuters and premium sports bikes to family scooties like the Honda Activa, TVS Jupiter, and Suzuki Access, alongside popular hatchbacks and sedans. What distinguishes us as the best bike, scooty and car service in Netaji Subhash Place is our strict pricing transparency — you receive a full itemised estimate before a single tool is touched, ensuring zero hidden charges at the end. We use only genuine engine oils from Motul and Wurth, paired with manufacturer-approved spare parts, and each service is backed by our 10-day hassle-free service guarantee.</p>
              <p>The dense commercial traffic around NSP District Centre, the narrow internal lanes of Pitampura and Shakurpur, and the constant stop-start along Wazirpur and Lawrence Road accelerate wear on engine oil, air filters, tyres, and brakes — making regular servicing not just a good habit but a safety necessity for bikes, scooties, and cars alike. Our mechanics carry professional diagnostic tools to identify emerging issues before they become expensive failures, significantly extending your vehicle&apos;s lifespan whether you commute daily through the NSP Metro Station area or just within the Pitampura belt. We also handle emergency breakdown situations across NSP — if your bike, scooty, or car stops near Keshav Puram or anywhere on the way toward Rohini or Rani Bagh, call us and we dispatch a mechanic to your exact location immediately. From battery replacement and brake pad changes to clutch cable adjustment and tyre puncture repair, our technicians fix it all on the spot. Garage Fix Care has completed over 1,00,000 services across Delhi NCR, earning a consistent 4.7-star Google rating for professionalism, punctuality, and honest pricing. Book your bike, scooty, or car service in Netaji Subhash Place, NSP Commercial Complex, NSP Metro Station, NSP District Centre, Pitampura, Poorvi Pitampura, Lok Vihar, Kohat Enclave, Rani Bagh, Shakurpur, Shakur Basti, Wazirpur, Keshav Puram, Tri Nagar, Ashok Vihar, Shalimar Bagh, Adarsh Nagar, or Model Town today via our website, WhatsApp, or direct call — and discover the convenience of professional doorstep vehicle care starting at just ₹299.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in NSP
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                NSP&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM, and more — right at your home or office near Pitampura and Shakurpur.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in NSP" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to residents and professionals in Netaji Subhash Place, Pitampura, and Shakurpur — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced near Netaji Subhash Place is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your vehicle running at its best — starting at ₹299, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in NSP" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Vikram Bisht', img: testimonial1, text: 'Doorstep service near NSP District Centre was fast and professional.', time: 'a month ago' },
                { name: 'Pooja Rathi', img: testimonial2, text: 'Transparent billing with video evidence, booked from Pitampura. Very reliable.', time: 'a month ago' },
                { name: 'Ravinder Negi', img: testimonial3, text: 'Great service near Shakurpur, convenient and affordable.', time: 'a month ago' },
                { name: 'Simran Kaur', img: testimonial4, text: 'Quick response near Wazirpur, professional mechanic. Will recommend.', time: 'a month ago' },
              ].map(t => (
        ...
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in Netaji Subhash Place — <span className="text-red-600">Common Questions</span>
            </motion.h2>
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike, Scooty or Car Service in NSP Today
            </h2>
...
export default BestBikeServiceNSP;