// BestBikeServiceMahipalpur.tsx
// Mahipalpur specific SEO/content + Home.tsx design system (video hero, Framer Motion, marquees)
...
// Mahipalpur specific / existing assets
...
const BestBikeServiceMahipalpur = () => {
  ...
  // Hot Deals marquee images — Mahipalpur specific copy/alt text
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Mahipalpur' },
    { src: hotDealsImage2, alt: 'Doorstep scooty service near Mahipalpur Extension' },
    { src: hotDealsImage3, alt: 'Car engine repair near Rangpuri' },
    { src: hotDealsImage4, alt: 'Roadside vehicle assistance near Vasant Kunj' },
    { src: hotDealsImage5, alt: 'Doorstep vehicle repair deal near Delhi Aerocity' },
  ];
  const hotDealsAreaBadges = ['Mahipalpur', 'Mahipalpur Extension', 'Rangpuri', 'Vasant Kunj', 'Shankar Vihar', 'Delhi Aerocity'];
  ...
  const serviceCities = [
    { name: 'Mahipalpur', color: 'text-indigo-700' },
    { name: 'Rangpuri', color: 'text-red-700' },
    { name: 'Vasant Kunj', color: 'text-teal-700' },
    { name: 'Shankar Vihar', color: 'text-gray-900' },
    { name: 'Delhi Aerocity', color: 'text-orange-700' },
    { name: 'IGI Airport', color: 'text-slate-700' },
  ];

  const coveredAreas = [
    'Mahipalpur', 'Mahipalpur Village', 'Mahipalpur Extension', 'Arjun Camp',
    'Rangpuri', 'Rangpuri Pahari', 'Defence Enclave', 'Shankar Vihar',
    'Vasant Kunj', 'Kishangarh', 'Masoodpur', 'Delhi Aerocity',
  ];
  ...
  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in Mahipalpur | Doorstep Service Just ₹299"
        description="Garage Fix Care offers doorstep bike, scooty and car service in Mahipalpur, Mahipalpur Extension, Rangpuri, Vasant Kunj, Shankar Vihar, Defence Enclave, Delhi Aerocity and the IGI Airport area, starting at just ₹299. Certified mechanics, same-day vehicle repair at your home."
        canonical="https://www.garagefixcare.in/best-bike-service-mahipalpur"
        robots="index, follow"
        og={{
          url: 'https://www.garagefixcare.in/best-bike-service-mahipalpur',
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Best bike, scooty and car service in Mahipalpur at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in Mahipalpur, Rangpuri and Vasant Kunj',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Mahipalpur. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299.',
            url: 'https://www.garagefixcare.in/best-bike-service-mahipalpur',
            ...
            geo: { '@type': 'GeoCoordinates', latitude: '28.5429', longitude: '77.1249' },
            areaServed: [
              { '@type': 'Place', name: 'Mahipalpur' },
              { '@type': 'Place', name: 'Mahipalpur Village' },
              { '@type': 'Place', name: 'Mahipalpur Extension' },
              { '@type': 'Place', name: 'Arjun Camp' },
              { '@type': 'Place', name: 'Rangpuri' },
              { '@type': 'Place', name: 'Rangpuri Pahari' },
              { '@type': 'Place', name: 'Defence Enclave' },
              { '@type': 'Place', name: 'Shankar Vihar' },
              { '@type': 'Place', name: 'Vasant Kunj' },
              { '@type': 'Place', name: 'Kishangarh' },
              { '@type': 'Place', name: 'Masoodpur' },
              { '@type': 'Place', name: 'Nangal Dewat' },
              { '@type': 'Place', name: 'Delhi Aerocity' },
              { '@type': 'Place', name: 'Rajokri' },
              { '@type': 'Place', name: 'Ghitorni' },
            ],
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Doorstep Bike, Scooty and Car Service in Mahipalpur',
            provider: { '@type': 'LocalBusiness', name: 'Garage Fix Care' },
            areaServed: 'Mahipalpur, New Delhi',
            description: 'At-home bike, scooty and car servicing starting at ₹299 across Mahipalpur, Mahipalpur Village, Mahipalpur Extension, Arjun Camp, Rangpuri, Rangpuri Pahari, Defence Enclave, Shankar Vihar, Vasant Kunj, Kishangarh, Masoodpur, Nangal Dewat, Delhi Aerocity, Rajokri and Ghitorni. Oil change, engine repair, battery replacement, puncture fix and car maintenance — same-day doorstep service.',
          ...
          },
          {
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Is bike service available in Mahipalpur?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Garage Fix Care provides doorstep bike service in Mahipalpur starting at just ₹299, with certified mechanics arriving at your home or hotel within 2–4 hours of booking.' } },
              { '@type': 'Question', name: 'Do you provide scooty repair in Mahipalpur?', acceptedAnswer: { '@type': 'Answer', text: 'Yes, we repair and service all scooties in Mahipalpur — Honda Activa, TVS Jupiter, Suzuki Access 125, Honda Dio and Hero Maestro — at your doorstep with genuine parts and transparent pricing.' } },
              { '@type': 'Question', name: 'Do you provide car service at home in Mahipalpur?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing in Mahipalpur and nearby areas. Car service pricing is quoted based on your car model and the work required — book online or call us for a quote.' } },
              { '@type': 'Question', name: 'What is the starting service price in Mahipalpur?', acceptedAnswer: { '@type': 'Answer', text: 'Bike and scooty service in Mahipalpur starts from ₹299 for 100–125cc vehicles (Basic Service). Standard Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Complete Care (350–450 CC) is ₹599, and Luxury Care (above 500 CC) is ₹999. All prices include labour with no hidden charges.' } },
              { '@type': 'Question', name: 'Is doorstep vehicle service available in Mahipalpur?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Garage Fix Care is a doorstep-first service. Our certified mechanics arrive at your home, hotel, apartment or office in Mahipalpur fully equipped with tools, oils and parts — no garage visit needed.' } },
              { '@type': 'Question', name: 'Is same-day service available in Mahipalpur?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Same-day bike, scooty and car service is available across Mahipalpur and surrounding areas. Book before noon and our mechanic typically reaches you the same day.' } },
              { '@type': 'Question', name: 'Do you provide pickup and drop for vehicles in Mahipalpur?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Free pickup and drop is available for bikes, scooties and cars in Mahipalpur whenever the service requires taking the vehicle to our workshop for specialised work.' } },
              { '@type': 'Question', name: 'Which areas around Mahipalpur are covered?', acceptedAnswer: { '@type': 'Answer', text: 'We cover Mahipalpur, Mahipalpur Village, Mahipalpur Extension, Arjun Camp, Mahipalpur Bypass, Rangpuri, Rangpuri Pahari, Defence Enclave, Shankar Vihar, Vasant Kunj, Kishangarh, Masoodpur, Nangal Dewat, Delhi Aerocity, the IGI Airport area, Rajokri and Ghitorni.' } },
              { '@type': 'Question', name: 'Do you cover Mahipalpur Extension and Rangpuri?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Mahipalpur Extension, Rangpuri, Rangpuri Pahari and Arjun Camp are all well within our regular doorstep service zone. Mechanics reach these areas within 2–4 hours for bikes, scooties and cars.' } },
              { '@type': 'Question', name: 'Do you cover Vasant Kunj and Vasant Kunj Enclave?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Vasant Kunj, Vasant Kunj Enclave and Vasant Kunj Sectors B, C and D are all covered for doorstep bike, scooty and car service with the same ₹299 starting price.' } },
              { '@type': 'Question', name: 'Do you cover Shankar Vihar and Defence Enclave?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Shankar Vihar, Defence Enclave, Masoodpur and Nangal Dewat are all covered for doorstep bike, scooty and car service, including oil change, brake repair and battery replacement.' } },
              { '@type': 'Question', name: 'Do you cover Aerocity and the IGI Airport area?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We provide doorstep bike, scooty and car service across Delhi Aerocity, the IGI Airport area, Airport Authority Colony and Rajokri with transparent pricing and certified mechanics.' } },
              { '@type': 'Question', name: 'Can you replace vehicle batteries at home in Mahipalpur?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We replace two-wheeler and car batteries at your doorstep in Mahipalpur using genuine, warranty-backed batteries, with installation included.' } },
              { '@type': 'Question', name: 'Do you repair brakes at your doorstep in Mahipalpur?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Brake pad replacement, brake shoe change and brake adjustment for bikes, scooties and cars are all done at your doorstep in Mahipalpur with genuine parts.' } },
              { '@type': 'Question', name: 'Do you handle engine repairs for bikes, scooties and cars in Mahipalpur?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. From basic engine tuning to full engine overhaul, our certified mechanics handle engine repair for bikes, scooties and cars. Complex jobs are picked up and returned via our free pickup and drop service.' } },
              { '@type': 'Question', name: 'How can I book a vehicle service in Mahipalpur?', acceptedAnswer: { '@type': 'Answer', text: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Share whether it is a bike, scooty or car, your location in Mahipalpur and your preferred time slot — we handle the rest.' } },
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Bike Service', item: 'https://www.garagefixcare.in/best-bike-service-delhi' },
              { '@type': 'ListItem', position: 3, name: 'Mahipalpur', item: 'https://www.garagefixcare.in/best-bike-service-mahipalpur' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Mahipalpur specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in Mahipalpur
        ...
        {/* Dark premium information strip — Mahipalpur specific copy */}
        <motion.div
          className="w-full"
          style={{
          ...
          <div className="max-w-[1100px] mx-auto px-[14px] py-[10px] sm:px-6 sm:py-3.5 relative overflow-hidden">
            ...
            <span className="relative inline-flex items-center gap-1.5 mb-1">
              ...
              <span className="text-[8px] sm:text-[9px] font-semibold uppercase tracking-wider" style={{ color: '#ff7a00' }}>
                Garage Fix Care — Mahipalpur
              </span>
            </span>
            <p className="relative text-[10px] sm:text-sm leading-[1.4] sm:leading-relaxed" style={{ color: '#cbd5e1' }}>
              Skip the garage queue. Our certified mechanics come to your home, hotel or office across Mahipalpur, Mahipalpur Village, Mahipalpur Extension, Arjun Camp, Rangpuri, Rangpuri Pahari, Defence Enclave, Shankar Vihar, Vasant Kunj, Kishangarh, Masoodpur and Delhi Aerocity — servicing bikes, scooties and cars, from routine maintenance to engine repairs, starting at ₹299. Fast, transparent and affordable.
            </p>
          </div>
        </motion.div>
        ...
        {/* Hot Deals This Week — Mahipalpur specific copy */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Limited-time offer for Mahipalpur, Rangpuri and Vasant Kunj customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Mahipalpur pricing */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service near Mahipalpur and Vasant Kunj, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Areas Covered — Mahipalpur localities */}
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service Areas in <span className="text-red-600">Mahipalpur</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you live in Mahipalpur Village, Mahipalpur Extension, Arjun Camp, near Rangpuri, Rangpuri Pahari, Defence Enclave, Shankar Vihar, Vasant Kunj, Kishangarh, Masoodpur, or close to Delhi Aerocity, our bike, scooty and car mechanics reach your doorstep within 2-4 hours. Same-day doorstep service available across the Mahipalpur belt, starting at ₹299.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Bike, Scooty &amp; Car Care, <span className="text-red-600">Right at Your Door in Mahipalpur</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Mahipalpur mechanics handle bikes, scooties and cars at your location, starting at ₹299. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              {bikeServiceCards.map((service, index) => (
                ...
                >
                  <img
                    src={service.img}
                    alt={`${service.name} in Mahipalpur`}
        ...
        {/* Comprehensive SEO Content (Mahipalpur specific) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in Mahipalpur</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>Mahipalpur sits at the gateway to Delhi from the airport side, where NH-48 meets the Aerocity corridor and the Vasant Kunj–Rangpuri belt. It is a neighbourhood of contrasts — long-standing village lanes around Mahipalpur Village and Rangpuri, dense residential blocks in Mahipalpur Extension and Arjun Camp, the hotel and business district of Delhi Aerocity, and premium enclaves such as Vasant Kunj, Defence Enclave and Shankar Vihar nearby. Vehicle owners here — from residents and hotel staff to airport and hospitality workers — depend on their bikes, scooties and cars for daily commutes and long airport runs, and they need a vehicle service that works around their schedule. Garage Fix Care is Mahipalpur&apos;s trusted doorstep service for bikes, scooties and cars, with certified and background-verified mechanics arriving at your home, hotel or office within 2–4 hours of booking. Doorstep bike and scooty service in Mahipalpur starts at just ₹299 and covers all essential checks — engine oil change, air filter cleaning, spark plug inspection, brake adjustment and basic electrical check — completed on the spot without you needing to ride to a workshop. Car servicing is also available at your doorstep, with pricing quoted transparently based on your car&apos;s model and requirement. We service every major two-wheeler and four-wheeler brand seen across Mahipalpur, Rangpuri and Vasant Kunj — Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM, plus popular hatchbacks and sedans. What makes us the best bike, scooty and car service in Mahipalpur is our strict pricing transparency: you receive a full itemised estimate before any work begins, genuine Motul and Wurth engine oils, manufacturer-approved spare parts and a 10-day hassle-free service guarantee.</p>
              <p>The constant stop-and-go traffic on NH-48 near Mahipalpur Bypass, the dusty stretches around Rangpuri Pahari and the airport approach roads, and the long airport runs from Vasant Kunj and Kishangarh accelerate wear on engine oil, air filters, tyres and brakes — making regular servicing a safety necessity rather than a luxury, for bikes, scooties and cars alike. Our mechanics carry professional diagnostic tools to identify emerging issues before they turn into expensive failures, extending your vehicle&apos;s lifespan whether you commute daily to Delhi Aerocity and Shankar Vihar or simply drive within the colony. We also handle emergency breakdowns across Mahipalpur and nearby areas — if your bike, scooty or car stops near the IGI Airport area, Rangpuri or on the Mahipalpur Bypass, call us and we dispatch a mechanic to your exact location immediately. From battery replacement and brake pad changes to clutch cable adjustment, tyre puncture repair and engine diagnostics, our technicians fix it all on the spot. Garage Fix Care has completed over 1,00,000 services across Delhi NCR and earned a consistent 4.7-star Google rating for professionalism, punctuality and honest pricing. Book your bike, scooty or car service in Mahipalpur, Mahipalpur Village, Mahipalpur Extension, Mahipalpur Block K, Mahipalpur Block L, Arjun Camp Mahipalpur, Mahipalpur Bypass, Mahipalpur Main Road, Rangpuri, Rangpuri Village, Rangpuri Extension, Rangpuri Pahari, Milakpur Kohi Rangpuri, Defence Enclave, Shankar Vihar, Vasant Kunj, Vasant Kunj Enclave, Vasant Kunj Sector B, C and D, Kishangarh, Masoodpur, Nangal Dewat, the IGI Airport area, Delhi Aerocity, Airport Authority Colony, Rajokri, Ghitorni, Vasant Vihar, Munirka, Dhaula Kuan or Delhi Cantt — via our website, WhatsApp, or a direct call, and discover professional doorstep vehicle care starting at just ₹299.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Mahipalpur
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Mahipalpur&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM, and more — right at your home or office near Rangpuri and Vasant Kunj.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Mahipalpur" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to residents of Mahipalpur, Rangpuri and Vasant Kunj — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced near Mahipalpur is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your vehicle running at its best — starting at ₹299, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Mahipalpur" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Vikram Bisht', img: testimonial1, text: 'Doorstep service in Mahipalpur was fast and professional.', time: 'a month ago' },
                { name: 'Pooja Rathi', img: testimonial2, text: 'Transparent billing with video evidence, booked from Rangpuri. Very reliable.', time: 'a month ago' },
                { name: 'Ravinder Negi', img: testimonial3, text: 'Great service near Vasant Kunj, convenient and affordable.', time: 'a month ago' },
                { name: 'Simran Kaur', img: testimonial4, text: 'Quick response near Delhi Aerocity, professional mechanic. Will recommend.', time: 'a month ago' },
              ].map(t => (
        ...
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in Mahipalpur — <span className="text-red-600">Common Questions</span>
            </motion.h2>
            <motion.div className="space-y-3" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              {[
                { q: 'Is bike service available in Mahipalpur?', a: 'Yes. Garage Fix Care provides doorstep bike service in Mahipalpur starting at just ₹299, with certified mechanics arriving at your home or hotel within 2–4 hours of booking.' },
                { q: 'Do you provide scooty repair in Mahipalpur?', a: 'Yes, we repair and service all scooties in Mahipalpur — Honda Activa, TVS Jupiter, Suzuki Access 125, Honda Dio and Hero Maestro — at your doorstep with genuine parts and transparent pricing.' },
                { q: 'Do you provide car service at home in Mahipalpur?', a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing in Mahipalpur and nearby areas. Car service pricing is quoted based on your car model and the work required — book online or call us for a quote.' },
                { q: 'What is the starting service price in Mahipalpur?', a: 'Bike and scooty service in Mahipalpur starts from ₹299 for 100–125cc vehicles (Basic Service). Standard Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Complete Care (350–450 CC) is ₹599, and Luxury Care (above 500 CC) is ₹999. All prices include labour with no hidden charges.' },
                { q: 'Is doorstep vehicle service available in Mahipalpur?', a: 'Yes. Garage Fix Care is a doorstep-first service. Our certified mechanics arrive at your home, hotel, apartment or office in Mahipalpur fully equipped with tools, oils and parts — no garage visit needed.' },
                { q: 'Is same-day service available in Mahipalpur?', a: 'Yes. Same-day bike, scooty and car service is available across Mahipalpur and surrounding areas. Book before noon and our mechanic typically reaches you the same day.' },
                { q: 'Do you provide pickup and drop for vehicles in Mahipalpur?', a: 'Yes. Free pickup and drop is available for bikes, scooties and cars in Mahipalpur whenever the service requires taking the vehicle to our workshop for specialised work.' },
                { q: 'Which areas around Mahipalpur are covered?', a: 'We cover Mahipalpur, Mahipalpur Village, Mahipalpur Extension, Arjun Camp, Mahipalpur Bypass, Rangpuri, Rangpuri Pahari, Defence Enclave, Shankar Vihar, Vasant Kunj, Kishangarh, Masoodpur, Nangal Dewat, Delhi Aerocity, the IGI Airport area, Rajokri and Ghitorni.' },
                { q: 'Do you cover Mahipalpur Extension and Rangpuri?', a: 'Yes. Mahipalpur Extension, Rangpuri, Rangpuri Pahari and Arjun Camp are all well within our regular doorstep service zone. Mechanics reach these areas within 2–4 hours for bikes, scooties and cars.' },
                { q: 'Do you cover Vasant Kunj and Vasant Kunj Enclave?', a: 'Yes. Vasant Kunj, Vasant Kunj Enclave and Vasant Kunj Sectors B, C and D are all covered for doorstep bike, scooty and car service with the same ₹299 starting price.' },
                { q: 'Do you cover Shankar Vihar and Defence Enclave?', a: 'Yes. Shankar Vihar, Defence Enclave, Masoodpur and Nangal Dewat are all covered for doorstep bike, scooty and car service, including oil change, brake repair and battery replacement.' },
                { q: 'Do you cover Aerocity and the IGI Airport area?', a: 'Yes. We provide doorstep bike, scooty and car service across Delhi Aerocity, the IGI Airport area, Airport Authority Colony and Rajokri with transparent pricing and certified mechanics.' },
                { q: 'Can you replace vehicle batteries at home in Mahipalpur?', a: 'Yes. We replace two-wheeler and car batteries at your doorstep in Mahipalpur using genuine, warranty-backed batteries, with installation included.' },
                { q: 'Do you repair brakes at your doorstep in Mahipalpur?', a: 'Yes. Brake pad replacement, brake shoe change and brake adjustment for bikes, scooties and cars are all done at your doorstep in Mahipalpur with genuine parts.' },
                { q: 'Do you handle engine repairs for bikes, scooties and cars in Mahipalpur?', a: 'Yes. From basic engine tuning to full engine overhaul, our certified mechanics handle engine repair for bikes, scooties and cars. Complex jobs are picked up and returned via our free pickup and drop service.' },
                { q: 'How can I book a vehicle service in Mahipalpur?', a: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Share whether it is a bike, scooty or car, your location in Mahipalpur and your preferred time slot — we handle the rest.' },
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike, Scooty or Car Service in Mahipalpur Today
            </h2>
...
export default BestBikeServiceMahipalpur;