          ...
          <div className="flex justify-between items-center h-10 relative">
            ...
            <div className="flex items-center space-x-3 sm:space-x-6">
              ...
              <Link to="/" className="z-20 -mt-8 flex-shrink-0">
                <div className="w-28 sm:w-24 h-12 sm:h-16 bg-sky-100 rounded-b-2xl shadow-md flex items-center justify-center overflow-hidden">
                  <img 
                    src={garageIcon} 
                    alt="GARAGEFIX CARE Logo" 
                    className="w-24 sm:w-28 h-12 sm:h-16 bg-sky-100 rounded-b-2xl"
                  />
                </div>
              </Link>
