// BestBikeServiceSector56Gurugram.tsx
// Gurugram specific SEO/content + Home.tsx design system (video hero, Framer Motion, marquees)
...
const BestBikeServiceSector56Gurugram = () => {
  ...
  // Hot Deals marquee images — Gurugram specific copy/alt text, Home-style assets
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Gurugram' },
    { src: hotDealsImage2, alt: 'Doorstep bike service near Golf Course Road' },
    { src: hotDealsImage3, alt: 'Bike engine repair near MG Road' },
    { src: hotDealsImage4, alt: 'Roadside bike assistance near Sushant Lok' },
    { src: hotDealsImage5, alt: 'Doorstep bike repair deal near DLF' },
  ];
  const hotDealsAreaBadges = ['Gurugram', 'Golf Course Road', 'MG Road', 'DLF', 'Sushant Lok', 'Cyber City'];
  ...
  const serviceCities = [
    ...
    { name: 'Golf Course Road', color: 'text-red-700' },
    { name: 'MG Road', color: 'text-teal-700' },
    { name: 'DLF', color: 'text-gray-900' },
    { name: 'Sushant Lok', color: 'text-orange-700' },
    { name: 'Sohna Road', color: 'text-slate-700' },
  ];
  ...
  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in Gurugram | Doorstep Service Just ₹299 | Garage Fix Care"
        description="Garage Fix Care offers doorstep bike, scooty and car service across Gurugram, including Golf Course Road, MG Road, DLF, Sushant Lok, Sohna Road, Cyber City and nearby areas, starting at just ₹299. Certified mechanics, same-day service at your doorstep."
        canonical="https://www.garagefixcare.in/best-bike-service-gurugram"
        robots="index, follow"
        og={{
          url: 'https://www.garagefixcare.in/best-bike-service-gurugram',
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Best bike, scooty and car service in Gurugram at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in Gurugram, Golf Course Road and MG Road',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Gurugram. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299.',
            url: 'https://www.garagefixcare.in/best-bike-service-gurugram',
            ...
            areaServed: [
              ...
              { '@type': 'Place', name: 'DLF' },
              { '@type': 'Place', name: 'Sushant Lok' },
              { '@type': 'Place', name: 'Ardee City' },
              { '@type': 'Place', name: 'Nirvana Country' },
              { '@type': 'Place', name: 'South City' },
              { '@type': 'Place', name: 'Palam Vihar' },
              { '@type': 'Place', name: 'Sohna Road' },
              { '@type': 'Place', name: 'Sector 14' },
              { '@type': 'Place', name: 'Sector 29' },
              { '@type': 'Place', name: 'Sector 40' },
              { '@type': 'Place', name: 'Sector 45' },
              { '@type': 'Place', name: 'Sector 46' },
              { '@type': 'Place', name: 'Sector 49' },
              { '@type': 'Place', name: 'Sector 50' },
              { '@type': 'Place', name: 'Sector 51' },
              { '@type': 'Place', name: 'Sector 52' },
              { '@type': 'Place', name: 'Sector 53' },
              { '@type': 'Place', name: 'Sector 54' },
              { '@type': 'Place', name: 'Sector 55' },
              { '@type': 'Place', name: 'Sector 56' },
              { '@type': 'Place', name: 'Sector 57' },
              { '@type': 'Place', name: 'Udyog Vihar' },
              { '@type': 'Place', name: 'Cyber City' },
              { '@type': 'Place', name: 'Manesar' },
            ],
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Doorstep Bike, Scooty and Car Service in Gurugram',
            provider: { '@type': 'LocalBusiness', name: 'Garage Fix Care' },
            areaServed: 'Gurugram, Haryana',
            description: 'At-home bike, scooty and car servicing starting at ₹299 across Gurugram, Golf Course Road, MG Road, DLF, Sushant Lok, Sohna Road, Cyber City, Udyog Vihar and Manesar. Oil change, engine repair, battery replacement, puncture fix and car maintenance — same-day doorstep service.',
          ...
          },
          {
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'What is the best bike, scooty and car service in Gurugram?', acceptedAnswer: { '@type': 'Answer', text: 'Garage Fix Care is Gurugram\'s trusted doorstep service for bikes, scooties and cars, starting at just ₹299, with certified mechanics and transparent pricing.' } },
              { '@type': 'Question', name: 'How much does bike, scooty or car service cost in Gurugram?', acceptedAnswer: { '@type': 'Answer', text: 'Bike and scooty service in Gurugram starts from ₹299 for 100–125cc vehicles. Classic Service is ₹399, Premium ₹499, Royal ₹599, and Sports ₹999. Car service pricing is quoted based on your car model and requirement. All prices include labour with no hidden charges.' } },
              { '@type': 'Question', name: 'Do you provide doorstep bike, scooty and car repair across Gurugram?', acceptedAnswer: { '@type': 'Answer', text: 'Yes, we provide complete doorstep repair for bikes, scooties and cars across Gurugram, including Golf Course Road, MG Road, DLF, Sushant Lok, Ardee City, Nirvana Country, South City, Palam Vihar, Sohna Road, Sector 14, Sector 29, Sector 40, Sector 45, Sector 46, Sector 49, Sector 50, Sector 51, Sector 52, Sector 53, Sector 54, Sector 55, Sector 56, Sector 57, Udyog Vihar, Cyber City and Manesar.' } },
              { '@type': 'Question', name: 'Do you provide car service pricing and quotes in Gurugram?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing in Gurugram and nearby areas. Car service pricing is quoted based on your car\'s model and the work required — just book online or call us for a quote.' } },
              { '@type': 'Question', name: 'Which areas of Gurugram are covered?', acceptedAnswer: { '@type': 'Answer', text: 'We cover all major areas of Gurugram including Golf Course Road, MG Road, DLF Phases 1–5, Sushant Lok, Ardee City, Nirvana Country, South City, Palam Vihar, Sohna Road, Sectors 14, 29, 40, 45, 46, 49, 50, 51, 52, 53, 54, 55, 56, 57, Udyog Vihar, Cyber City and Manesar.' } },
              { '@type': 'Question', name: 'Do you provide same-day doorstep vehicle service in Gurugram?', acceptedAnswer: { '@type': 'Answer', text: 'Yes, we offer same-day doorstep bike, scooty and car service across Gurugram. Our mechanics reach your location within 2–4 hours of booking for most areas, including Golf Course Road, MG Road, DLF, Sushant Lok, Sohna Road and Cyber City.' } },
              { '@type': 'Question', name: 'Do you handle emergency bike, scooty or car breakdowns in Gurugram?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. If your bike, scooty or car breaks down anywhere in Gurugram — whether near MG Road, Golf Course Road, DLF, Sushant Lok, or Cyber City — call us immediately and we dispatch a mechanic to your location for on-spot repair or recovery.' } },
              { '@type': 'Question', name: 'Do you provide bike and scooty service near Golf Course Road and MG Road?', acceptedAnswer: { '@type': 'Answer', text: 'Absolutely. We frequently service bikes and scooties near Golf Course Road and MG Road, including areas like DLF, Sushant Lok, and Ardee City. Our mechanics are just a call away for same-day doorstep service.' } },
              { '@type': 'Question', name: 'Can you repair car batteries, brakes and common vehicle issues at my doorstep in Gurugram?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Our certified mechanics handle car battery replacement, brake repairs, tyre punctures, engine diagnostics, and other common vehicle issues at your doorstep across Gurugram. We bring all necessary tools and parts.' } },
              { '@type': 'Question', name: 'Do you provide doorstep vehicle service near DLF, Sushant Lok, Sohna Road and Cyber City?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We cover all these areas and more. Whether you are in DLF Phase 1–5, Sushant Lok, Sohna Road, or Cyber City, our mechanics come to your home, society or office with full equipment. Book online or call us for a slot.' } },
              { '@type': 'Question', name: 'What makes Garage Fix Care better than a local Gurugram workshop?', acceptedAnswer: { '@type': 'Answer', text: 'We come to you for bikes, scooties and cars, save your travel time, offer transparent itemised billing, use genuine parts, and provide a 10-day warranty — something most local Gurugram workshops cannot match.' } },
            ],
          },
          {
            '@context': 'https://schema.org',
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Best Bike, Scooty and Car Service in Gurugram', item: 'https://www.garagefixcare.in/best-bike-service-gurugram' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Gurugram specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in Gurugram
        ...
        {/* Dark premium information strip — Gurugram specific copy */}
        <motion.div
          className="w-full"
          style={{
          ...
          <div className="max-w-[1100px] mx-auto px-[14px] py-[10px] sm:px-6 sm:py-3.5 relative overflow-hidden">
            ...
            <span className="relative inline-flex items-center gap-1.5 mb-1">
              ...
              <span className="text-[8px] sm:text-[9px] font-semibold uppercase tracking-wider" style={{ color: '#ff7a00' }}>
                Garage Fix Care — Gurugram
              </span>
            </span>
            <p className="relative text-[10px] sm:text-sm leading-[1.4] sm:leading-relaxed" style={{ color: '#cbd5e1' }}>
              Skip the garage queue. Our certified mechanics come to your home, society or office across Gurugram — from Golf Course Road and MG Road to DLF, Sushant Lok, Ardee City, Nirvana Country, South City, Palam Vihar, Sohna Road, Sectors 14–57, Udyog Vihar, Cyber City and Manesar — servicing bikes, scooties and cars, from routine maintenance to engine repairs, starting at ₹299. Fast, transparent, and affordable.
            </p>
          </div>
        </motion.div>
        ...
        {/* Hot Deals This Week — Gurugram specific copy, Home-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Exclusive savings for Gurugram customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Gurugram pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service across Gurugram, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Areas Covered — Gurugram localities */}
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              We Cover All Major Areas in <span className="text-red-600">Gurugram</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you live near Golf Course Road, MG Road, in DLF Phases 1–5, Sushant Lok, Ardee City, Nirvana Country, South City, Palam Vihar, Sohna Road, Sectors 14–57, Udyog Vihar, Cyber City, or Manesar, our bike, scooty and car mechanics reach your doorstep within 2-4 hours. Same-day doorstep service available across the entire Gurugram belt, starting at ₹299.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Vehicle Care, <span className="text-red-600">Right at Your Address</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Gurugram mechanics handle bikes, scooties and cars at your location, starting at ₹299. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Comprehensive Vehicle Service Content (Gurugram specific, 1000+ words) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in Gurugram</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>Gurugram — the Millennium City — is home to millions of professionals, families, and businesses spread across its vast network of sectors, residential colonies, and commercial hubs. From the upscale Golf Course Road and MG Road corridors to the bustling markets of DLF, Sushant Lok, Ardee City, Nirvana Country, South City, Palam Vihar, Sohna Road, and the sprawling industrial zones of Udyog Vihar, Cyber City and Manesar, the city pulsates with activity. Thousands of residents rely on their bikes, scooties, and cars for daily commutes to office parks, school runs, and weekend outings. Yet, finding a punctual, honest, and technically skilled vehicle mechanic in this fast-paced city has remained a challenge. Garage Fix Care fills that gap entirely. We send certified, background-verified mechanics directly to your home, society parking, or office block across every corner of Gurugram — from the tree-lined avenues of DLF Phase 1 to the high-rise apartments of Sushant Lok and the vibrant marketplaces of MG Road. Doorstep bike and scooty service in Gurugram starts at just ₹299 — covering all essential checks including engine oil change, air filter cleaning, spark plug inspection, brake adjustment, and basic electrical check — with every task completed on the spot without you needing to ride to a workshop. We also handle car servicing and repairs at your doorstep, with pricing quoted based on your car&apos;s model and the required work. We service every major vehicle brand seen across Gurugram: Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM, and more, handling everything from daily commuters and premium sports bikes to family scooties like the Honda Activa, TVS Jupiter, and Suzuki Access, alongside popular hatchbacks and sedans. What distinguishes us as the best bike, scooty and car service in Gurugram is our strict pricing transparency — you receive a full itemised estimate before a single tool is touched, ensuring zero hidden charges at the end. We use only genuine engine oils from Motul and Wurth, paired with manufacturer-approved spare parts, and each service is backed by our 10-day hassle-free service guarantee.</p>
              <p>The constant stop-and-go traffic on Golf Course Road and MG Road, the dust from ongoing construction across Sectors, and the extreme weather conditions — from scorching summers to chilly winters — accelerate wear on engine oil, air filters, tyres, and brakes. Regular servicing is not just a good habit but a safety necessity for bikes, scooties and cars alike. Our mechanics carry professional diagnostic tools to identify emerging issues before they become expensive failures, significantly extending your vehicle&apos;s lifespan whether you commute daily through Cyber City or just within your sector. We also handle emergency breakdown situations across Gurugram — if your bike, scooty or car stops near DLF, Sushant Lok, Sohna Road, or anywhere else in the city, call us and we dispatch a mechanic to your exact location immediately. From battery replacement and brake pad changes to clutch cable adjustment and tyre puncture repair, our technicians fix it all on the spot. Garage Fix Care has completed over 1,00,000 services across Delhi NCR, earning a consistent 4.7-star Google rating for professionalism, punctuality, and honest pricing. Book your bike, scooty or car service in Gurugram — whether you are at Golf Course Road, MG Road, DLF, Sushant Lok, Ardee City, Nirvana Country, South City, Palam Vihar, Sohna Road, Sectors 14–57, Udyog Vihar, Cyber City, or Manesar — via our website, WhatsApp, or direct call — and discover the convenience of professional doorstep vehicle care starting at just ₹299.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Gurugram
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Gurugram&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM, and more — right at your home or office near Golf Course Road, MG Road, DLF, Sushant Lok, Cyber City, and across all sectors.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Gurugram" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to residents of Gurugram — from Golf Course Road, MG Road and DLF to Sushant Lok, Ardee City, Nirvana Country, Sohna Road, Cyber City and all sectors — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced in Gurugram is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your vehicle running at its best — starting at ₹299, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Gurugram" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Vikram Bisht', img: testimonial1, text: 'Doorstep service near Golf Course Road was fast and professional.', time: 'a month ago' },
                { name: 'Pooja Rathi', img: testimonial2, text: 'Transparent billing with video evidence, booked from Sushant Lok. Very reliable.', time: 'a month ago' },
                { name: 'Ravinder Negi', img: testimonial3, text: 'Great service near MG Road, convenient and affordable.', time: 'a month ago' },
                { name: 'Simran Kaur', img: testimonial4, text: 'Quick response near DLF, professional mechanic. Will recommend.', time: 'a month ago' },
              ].map(t => (
        ...
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in Gurugram — <span className="text-red-600">Common Questions</span>
            </motion.h2>
            <motion.div className="space-y-3" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              {[
                { q: 'What is the best bike, scooty and car service in Gurugram?', a: 'Garage Fix Care is Gurugram\'s highest-rated doorstep service for bikes, scooties and cars, starting at ₹299 with certified mechanics, transparent pricing, genuine parts, and a 10-day service guarantee.' },
                { q: 'How much does bike or scooty service cost in Gurugram?', a: 'Bike and scooty service in Gurugram at Garage Fix Care starts from ₹299 for 100–125cc vehicles (Regular Service). Classic Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Royal Service (350–450 CC) is ₹599, and Sports Service (above 500 CC) is ₹999. All prices include labour with zero hidden charges.' },
                { q: 'Do you provide car service in Gurugram too?', a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing in Gurugram and nearby areas. Car service pricing is quoted based on your car\'s model and the work required — just book online or call us for a quote.' },
                { q: 'Do you provide doorstep bike and scooty repair across Gurugram?', a: 'Yes, we provide complete doorstep bike and scooty repair across Gurugram, including Golf Course Road, MG Road, DLF, Sushant Lok, Ardee City, Nirvana Country, South City, Palam Vihar, Sohna Road, Sectors 14–57, Udyog Vihar, Cyber City and Manesar.' },
                { q: 'Which areas of Gurugram are covered for bike, scooty and car service?', a: 'We cover all major areas of Gurugram including Golf Course Road, MG Road, DLF Phases 1–5, Sushant Lok, Ardee City, Nirvana Country, South City, Palam Vihar, Sohna Road, Sectors 14, 29, 40, 45, 46, 49, 50, 51, 52, 53, 54, 55, 56, 57, Udyog Vihar, Cyber City and Manesar.' },
                { q: 'Do you service Royal Enfield bikes in Gurugram?', a: 'Yes. We specialise in Royal Enfield servicing across Gurugram — Classic 350, Bullet 350, Meteor 350, Himalayan, and Thunderbird — all serviced at your doorstep.' },
                { q: 'How quickly can a mechanic reach me in Gurugram?', a: 'Our mechanics typically reach your location in Gurugram within 2–4 hours of booking, for bikes, scooties and cars alike. For urgent requests, call us and we will prioritise your slot.' },
                { q: 'Is your bike, scooty and car service pricing transparent in Gurugram?', a: 'Absolutely. We provide a full itemised cost estimate before starting any work, whether it\'s a bike, scooty or car. No surprise bills — what you see is exactly what you pay.' },
                { q: 'Do you service scooties near Golf Course Road and MG Road?', a: 'Yes. We repair and service all scooties near Golf Course Road and MG Road — Honda Activa, TVS Jupiter, Suzuki Access 125, Honda Dio, Hero Maestro — all at your doorstep.' },
                { q: 'Do you offer a warranty on bike, scooty and car service in Gurugram?', a: 'Every service by Garage Fix Care in Gurugram includes a 10-day hassle-free service guarantee, whether it\'s a bike, scooty or car. If any issue arises post-service, we address it at no extra cost.' },
                { q: 'How do I book a bike, scooty or car mechanic near me in Gurugram?', a: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Let us know whether it\'s a bike, scooty or car, share your area in Gurugram and preferred time slot — we handle the rest.' },
                { q: 'What payment methods are accepted in Gurugram?', a: 'We accept cash, UPI (Google Pay, PhonePe, Paytm), and all major mobile wallets. Payment is collected only after the service is complete.' },
                { q: 'Do I need to arrange any tools or oils?', a: 'No. Our Gurugram mechanics arrive fully equipped — tools, genuine Motul/Wurth engine oils, and all required spare parts are brought to your doorstep, for bikes, scooties and cars.' },
                { q: 'Can I book service for multiple bikes or vehicles in DLF or Sushant Lok?', a: 'Yes, simply mention the number and type of vehicles while booking and we will arrange the right team for your location in DLF, Sushant Lok or any other Gurugram area.' },
                { q: 'Do you handle emergency bike, scooty or car breakdown near Cyber City or Udyog Vihar?', a: 'Yes. If your bike, scooty or car breaks down anywhere near Cyber City, Udyog Vihar, or any other part of Gurugram, call us immediately and we dispatch a mechanic to your location.' },
                { q: 'What makes Garage Fix Care better than a local Gurugram workshop?', a: 'We come to you for bikes, scooties and cars, save your travel time, offer transparent itemised billing, use genuine parts, and provide a 10-day warranty — something most local Gurugram workshops cannot match.' },
              ].map((faq, idx) => (
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike, Scooty or Car Service in Gurugram Today
            </h2>
...
export default BestBikeServiceSector56Gurugram;