// BestBikeServiceConnaughtPlace.tsx
// Connaught Place specific SEO/content + Delhi Cantt master design system
...
const BestBikeServiceConnaughtPlace = () => {
  ...
  // Hot Deals marquee images — Connaught Place specific copy/alt text
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Connaught Place' },
    { src: hotDealsImage2, alt: 'Doorstep scooty service near Rajiv Chowk' },
    { src: hotDealsImage3, alt: 'Car engine repair near Janpath, Connaught Place' },
    { src: hotDealsImage4, alt: 'Roadside vehicle assistance near Barakhamba Road' },
    { src: hotDealsImage5, alt: 'Doorstep bike and car repair deal near Minto Road' },
  ];
  const hotDealsAreaBadges = ['Connaught Place', 'Rajiv Chowk', 'Janpath', 'Barakhamba Road', 'Minto Road', 'Palika Bazaar'];
  ...
  const servicePrices = [
    ...
    { title: 'At-Home Royal Service', subtitle: '350 CC - 450 CC', originalPrice: 'Rs. 1,599', discountedPrice: 'Rs. 500', features: ['Engine Oil Change', 'Oil Filter Clean', 'Air Filter Clean', 'Spark Plug Clean'] },
  ...
  const serviceCities = [
    ...
    { name: 'Rajiv Chowk', color: 'text-red-700' },
    { name: 'Janpath', color: 'text-teal-700' },
    { name: 'Barakhamba Road', color: 'text-gray-900' },
    { name: 'Minto Road', color: 'text-orange-700' },
    { name: 'Shivaji Stadium', color: 'text-slate-700' },
  ];

  const coveredAreas = [
    'Connaught Place', 'Rajiv Chowk', 'Janpath', 'Barakhamba Road',
    'Kasturba Gandhi Marg', 'Minto Road', 'Shivaji Stadium', 'Palika Bazaar',
    'Outer Circle', 'Inner Circle', 'Bangla Sahib',
  ];
  ...
  const faqs = [
    {
      q: 'What is the best bike, scooty and car service in Connaught Place?',
      a: "Garage Fix Care is Connaught Place's trusted doorstep service for bikes, scooties and cars, starting at just ₹299 for bike and scooty service, with certified mechanics, transparent pricing and a 10-day service guarantee.",
    },
    {
      q: 'How much does bike, scooty or car service cost in Connaught Place?',
      a: 'Bike and scooty service in Connaught Place starts from ₹299 for 100–125cc vehicles (Regular Service). Classic Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Royal Service (350–450 CC) is ₹599, and Sports Service (above 500 CC) is ₹999, all with labour included and no hidden charges. Car service is quote-based and depends on your car model and the work required.',
    },
    {
      q: 'Do you provide car service in Connaught Place too?',
      a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing and repairs in Connaught Place and nearby Central Delhi areas. Car service is quoted transparently based on your car model and the specific work needed — just book online or call us for a quote.',
    },
    {
      q: 'Do you provide doorstep bike and scooty repair near Rajiv Chowk and Janpath?',
      a: 'Yes, we provide complete doorstep bike and scooty repair around Rajiv Chowk, Janpath and the wider Connaught Place circle. Our certified mechanics arrive with tools, oils and common spare parts — no garage visit needed.',
    },
    {
      q: 'Which areas around Connaught Place are covered for bike, scooty and car service?',
      a: 'We cover Connaught Place, Rajiv Chowk, Janpath, Barakhamba Road, Kasturba Gandhi Marg, Minto Road, Shivaji Stadium, Palika Bazaar, Outer Circle, Inner Circle and the Bangla Sahib stretch for bikes, scooties and cars.',
    },
    {
      q: 'Do you service Royal Enfield and other major bike brands near Connaught Place?',
      a: 'Yes. We specialise in Royal Enfield servicing across Connaught Place and Central Delhi — Classic 350, Bullet 350, Meteor 350, Himalayan and Thunderbird — and we also handle Hero, Honda, Bajaj, TVS, Suzuki, Yamaha and KTM models at your doorstep.',
    },
    {
      q: 'How quickly can a mechanic reach me in Connaught Place?',
      a: 'Our mechanics typically reach locations around Connaught Place within 2–4 hours of booking, subject to availability and traffic conditions. For urgent breakdowns, call us and we will prioritise your slot.',
    },
    {
      q: 'Do you provide scooty service near Janpath, Palika Bazaar and Shivaji Stadium?',
      a: 'Yes. We repair and service all scooties near Janpath, Palika Bazaar and Shivaji Stadium — Honda Activa, TVS Jupiter, Suzuki Access 125, Honda Dio, Hero Maestro — all at your doorstep.',
    },
    {
      q: 'Can you repair car batteries, brakes and common vehicle issues at my doorstep in Connaught Place?',
      a: 'Yes. Our mechanics handle car battery replacement, brake inspection and repair, tyre and puncture service, and common maintenance issues at your doorstep in Connaught Place — alongside bike and scooty repairs.',
    },
    {
      q: 'Do you handle emergency bike, scooty or car breakdowns near Connaught Place?',
      a: 'Yes. If your bike, scooty or car breaks down anywhere around Connaught Place — near Rajiv Chowk, Janpath, Barakhamba Road or Bangla Sahib — call us immediately and we dispatch a mechanic to your location for on-spot repair or recovery.',
    },
  ];
  ...
  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in Connaught Place | Doorstep Service Just ₹299 | Garage Fix Care"
        description="Garage Fix Care offers doorstep bike, scooty and car service in Connaught Place, Rajiv Chowk, Janpath, Barakhamba Road, Kasturba Gandhi Marg, Minto Road, Shivaji Stadium, Palika Bazaar and nearby Central Delhi areas starting at just ₹299. Certified mechanics, transparent pricing and same-day doorstep service."
        ...
        og={{
          ...
          imageAlt: 'Best bike, scooty and car service in Connaught Place at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in Connaught Place, Rajiv Chowk and Janpath',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Connaught Place, New Delhi. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299 for bike and scooty service.',
            url: 'https://www.garagefixcare.in/best-bike-service-connaught-place',
            ...
            areaServed: [
              ...
              { '@type': 'Place', name: 'Outer Circle' },
              { '@type': 'Place', name: 'Inner Circle' },
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Doorstep Bike, Scooty and Car Service in Connaught Place',
            provider: { '@type': 'LocalBusiness', name: 'Garage Fix Care' },
            areaServed: 'Connaught Place, New Delhi',
            description: 'At-home bike, scooty and car servicing across Connaught Place and nearby Central Delhi areas including Rajiv Chowk, Janpath, Barakhamba Road, Kasturba Gandhi Marg, Minto Road, Shivaji Stadium, Palika Bazaar and Bangla Sahib. Bike and scooty service starts at ₹299, covering oil change, engine repair, battery replacement, brake repair, tyre service and puncture fix. Car service is quote-based and depends on the car model and work required — same-day doorstep service.',
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Best Bike, Scooty and Car Service in Connaught Place', item: 'https://www.garagefixcare.in/best-bike-service-connaught-place' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Connaught Place specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in Connaught Place
                ...
                >
                  Trusted by residents, office-goers and businesses around Connaught Place, Rajiv Chowk, Janpath, Barakhamba Road, Kasturba Gandhi Marg, Minto Road and nearby areas — our certified mechanics handle bikes, scooties and cars right at your doorstep.
                </motion.p>
              </motion.div>
        ...
        {/* Dark premium information strip — Connaught Place specific copy */}
        <motion.div
          className="w-full"
          style={{
        ...
        {/* Hot Deals This Week — Connaught Place specific copy, Delhi Cantt-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Limited-time offer for Connaught Place, Rajiv Chowk and Janpath customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-white/70 max-w-xl mx-auto">Service support for leading two-wheeler brands across Connaught Place and Central Delhi.</p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Connaught Place pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service in Connaught Place and nearby Central Delhi areas, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Areas Covered — Connaught Place localities */}
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              We Cover All Major Areas in <span className="text-red-600">Connaught Place &amp; Central Delhi</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you are parked near Rajiv Chowk, Janpath, Barakhamba Road, Kasturba Gandhi Marg, Minto Road, Shivaji Stadium, Palika Bazaar, the Outer or Inner Circle, or close to Bangla Sahib, our bike, scooty and car mechanics typically reach you within 2–4 hours, subject to availability and traffic conditions. Same-day doorstep service is available across the Connaught Place belt, starting at ₹299 for bike and scooty service.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Vehicle Care, <span className="text-red-600">Right at Your Door in Connaught Place</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Connaught Place mechanics handle bikes, scooties and cars at your location, starting at ₹299 for bike and scooty service. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              {bikeServiceCards.map((service, index) => (
                ...
                >
                  <img
                    src={service.img}
                    alt={`${service.name} in Connaught Place`}
        ...
        {/* Comprehensive SEO Content (Connaught Place specific) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in Connaught Place</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>Connaught Place sits at the very heart of Delhi, with its colonnaded Inner and Outer Circles, the busy Rajiv Chowk intersection, and the surrounding commercial stretches of Janpath, Barakhamba Road and Kasturba Gandhi Marg. Thousands of two-wheelers and cars move through this area every day, and their owners deserve a bike, scooty and car service that matches the pace of Central Delhi — quick, reliable and completely transparent. Garage Fix Care is Connaught Place&apos;s most trusted doorstep vehicle service, bringing certified and background-verified mechanics directly to your office, home or parking spot, whether you are based near Minto Road, close to Shivaji Stadium, or right beside Palika Bazaar. Our mechanics typically reach your location within 2–4 hours of booking, subject to availability. Doorstep bike and scooty service in Connaught Place starts at just ₹299, covering all essential checks including engine oil change, air filter cleaning, spark plug inspection, brake adjustment and a basic electrical check — with every task completed on the spot. We also handle car servicing and repairs at your doorstep, with pricing quoted transparently based on your car&apos;s model and requirement. We service every major two-wheeler brand seen across the CP area: Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM and more — from daily commuters and family scooties like the Honda Activa and TVS Jupiter, to premium machines like the Royal Enfield Classic 350 and KTM Duke 390, alongside popular hatchbacks and sedans. What distinguishes us as the best bike, scooty and car service in Connaught Place is our strict pricing transparency — you receive a full itemised estimate before a single tool is touched, ensuring zero hidden charges at the end. We use only genuine engine oils from Motul and Wurth, paired with manufacturer-approved spare parts, and each service is backed by our 10-day hassle-free service guarantee.</p>
              <p>The stop-start traffic around Rajiv Chowk and Inner Circle, combined with Delhi&apos;s dust and seasonal heat, wears down engine oil, air filters, tyres and brakes far faster than the service manual suggests — making regular servicing a genuine safety necessity for bikes, scooties and cars alike. Our mechanics carry professional diagnostic tools to identify emerging issues before they become expensive failures, significantly extending your vehicle&apos;s lifespan whether you commute daily through Janpath or just occasionally visit the CP area. We also handle emergency breakdown situations across Connaught Place — if your bike, scooty or car stops near Bangla Sahib or anywhere along the Outer Circle, call us and we dispatch a mechanic to your exact location as soon as possible. From battery replacement and brake pad changes to clutch cable adjustment and tyre puncture repair, our technicians fix it all on the spot without towing. Garage Fix Care has completed over 1,00,000 services across Delhi NCR, earning a consistent 4.7-star Google rating for professionalism, punctuality and honest pricing. Book your bike, scooty or car service in Connaught Place, Rajiv Chowk, Janpath, Barakhamba Road, Kasturba Gandhi Marg, Minto Road, Shivaji Stadium, Palika Bazaar or the Bangla Sahib stretch today via our website, WhatsApp or direct call — and discover the convenience of professional doorstep vehicle care starting at just ₹299 for bike and scooty service.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Connaught Place
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Connaught Place&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM and more — right at your home, office or parking spot near Rajiv Chowk and Janpath.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Connaught Place" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to residents, office-goers and businesses across Connaught Place, Rajiv Chowk and Janpath — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced in Connaught Place is simple. Book online or call us, and a skilled mechanic arrives at your doorstep or office parking with everything needed to get your vehicle running at its best — starting at ₹299 for bike and scooty service, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Connaught Place" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Anikait Verma', img: testimonial1, text: 'Mechanic reached my office near Barakhamba Road on time. Honest pricing throughout.', time: 'two weeks ago' },
                { name: 'Falguni Rao', img: testimonial2, text: 'Loved the upfront estimate before any work started. No last-minute surprises near Janpath.', time: 'three weeks ago' },
                { name: 'Devraj Mehta', img: testimonial3, text: 'Came straight to Janpath, fixed my bike in under an hour. Smooth experience.', time: 'a month ago' },
                { name: 'Ishaani Kapoor', img: testimonial4, text: 'Quick booking, polite mechanic, fair price. Would book again near Connaught Place.', time: 'a month ago' },
              ].map(t => (
        ...
        {/* FAQs (Connaught Place specific — matches FAQPage schema exactly) */}
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in Connaught Place — <span className="text-red-600">Common Questions</span>
            </motion.h2>
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike, Scooty or Car Service in Connaught Place Today
            </h2>
            <p className="text-sm sm:text-base text-white mb-3 sm:mb-5 max-w-xl mx-auto">
              Same-day doorstep service across Connaught Place and Central Delhi starting at ₹299. Our mechanic comes to you — no travel, no waiting, no hidden charges.
            </p>
            <a
              href="https://www.garagefixcare.in/bookservice"
