// BestBikeServiceDwarka.tsx
// Dwarka specific SEO/content + Delhi Cantt master design system
...
const BestBikeServiceDwarka = () => {
  ...
  // Hot Deals marquee images — Dwarka specific copy/alt text
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Dwarka, Delhi' },
    { src: hotDealsImage2, alt: 'Doorstep bike service near Dwarka Sector 10' },
    { src: hotDealsImage3, alt: 'Car engine repair near Dwarka Sector 12' },
    { src: hotDealsImage4, alt: 'Roadside vehicle assistance near Dwarka Mor' },
    { src: hotDealsImage5, alt: 'Doorstep vehicle repair near Dwarka Expressway' },
  ];
  const hotDealsAreaBadges = ['Dwarka', 'Dwarka Sector 10', 'Dwarka Sector 12', 'Dwarka Sector 21', 'Dwarka Mor', 'Dwarka Expressway'];
  ...
  const serviceCities = [
    ...
    { name: 'Palam', color: 'text-red-700' },
    { name: 'Janakpuri', color: 'text-teal-700' },
    { name: 'Uttam Nagar', color: 'text-gray-900' },
    { name: 'Najafgarh', color: 'text-orange-700' },
    { name: 'Vikaspuri', color: 'text-slate-700' },
  ];

  const coveredAreas = [
    'Dwarka Sector 1', 'Dwarka Sector 6', 'Dwarka Sector 7', 'Dwarka Sector 10',
    'Dwarka Sector 12', 'Dwarka Sector 13', 'Dwarka Sector 21', 'Dwarka Sector 22',
    'Dwarka Sector 23', 'Dwarka Mor', 'Dwarka Expressway', 'Palam',
  ];
  ...
  const faqs = [
    {
      q: 'What is the best bike, scooty and car service in Dwarka?',
      a: "Garage Fix Care is Dwarka's trusted doorstep service for bikes, scooties and cars, starting at just ₹299 for bike and scooty service, with certified mechanics, transparent pricing, genuine parts and a 10-day service guarantee.",
    },
    {
      q: 'How much does bike or scooty service cost in Dwarka?',
      a: 'Bike and scooty service in Dwarka starts from ₹299 for 100–125cc vehicles (Regular Service). Classic Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Royal Service (350–450 CC) is ₹599, and Sports Service (above 500 CC) is ₹999. All prices include labour with zero hidden charges.',
    },
    {
      q: 'Do you provide car service in Dwarka too?',
      a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing and repairs in Dwarka and nearby areas. Car service is quoted transparently based on your car model and the work required — just book online or call us for a quote.',
    },
    {
      q: 'Which Dwarka sectors are covered for bike, scooty and car service?',
      a: 'We cover Dwarka Sector 1, Sector 6, Sector 7, Sector 10, Sector 12, Sector 13, Sector 21, Sector 22, Sector 23, Dwarka Mor, Dwarka Expressway and Palam for bikes, scooties and cars.',
    },
    {
      q: 'Do you provide doorstep service in Dwarka societies and apartments?',
      a: 'Yes. Our mechanics regularly service bikes, scooties and cars inside residential societies and apartment complexes across Dwarka. Share your society name, sector and gate number while booking — we come directly to your parking bay.',
    },
    {
      q: 'Do you handle emergency breakdown near Dwarka Mor or Dwarka Metro Station?',
      a: 'Yes. If your bike, scooty or car breaks down near Dwarka Mor, Dwarka Metro Station, Vegas Mall, ISKCON Dwarka or anywhere in the Dwarka sub-city, call us immediately and we dispatch a mechanic to your location.',
    },
    {
      q: 'Do you provide doorstep vehicle service along Dwarka Expressway?',
      a: 'Yes. Dwarka Expressway and its adjoining residential pockets fall within our doorstep service zone for bikes, scooties and cars. Same-day doorstep service is available subject to location and technician availability.',
    },
    {
      q: 'Do you service Royal Enfield and other major bike brands in Dwarka?',
      a: 'Yes. We specialise in Royal Enfield servicing across Dwarka — Classic 350, Bullet 350, Meteor 350, Hunter 350 and Himalayan — and we also handle Hero, Honda, Bajaj, TVS, Suzuki, Yamaha and KTM models at your doorstep.',
    },
    {
      q: 'Is your bike, scooty and car service pricing transparent in Dwarka?',
    ...
    {
      q: 'Do you offer a warranty on bike, scooty and car service in Dwarka?',
      a: 'Every service by Garage Fix Care in Dwarka includes a 10-day hassle-free service guarantee, whether it is a bike, scooty or car. If any issue arises post-service, we address it at no extra cost.',
    },
    {
      q: 'Do you provide free pickup and drop for service in Dwarka?',
    ...
    {
      q: 'How do I book a bike, scooty or car mechanic near me in Dwarka?',
      a: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Let us know whether it is a bike, scooty or car, share your Dwarka sector or nearby area, and your preferred time slot — we handle the rest.',
    },
  ];
  ...
  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in Dwarka | Doorstep Service Just ₹299"
        description="Garage Fix Care offers doorstep bike, scooty and car service in Dwarka, Delhi, covering Dwarka Sector 1, Sector 6, Sector 7, Sector 10, Sector 12, Sector 13, Sector 21, Sector 22, Sector 23, Dwarka Mor, Dwarka Expressway and Palam, starting at just ₹299. Certified mechanics, transparent pricing and same-day doorstep service."
        ...
        og={{
          ...
          imageAlt: 'Best bike, scooty and car service in Dwarka at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in Dwarka, Delhi',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Dwarka, Delhi. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299 for bike and scooty service.',
            url: 'https://www.garagefixcare.in/best-bike-service-dwarka',
            ...
            areaServed: [
              { '@type': 'Place', name: 'Dwarka Sector 1' },
              { '@type': 'Place', name: 'Dwarka Sector 6' },
              { '@type': 'Place', name: 'Dwarka Sector 7' },
              { '@type': 'Place', name: 'Dwarka Sector 10' },
              { '@type': 'Place', name: 'Dwarka Sector 12' },
              { '@type': 'Place', name: 'Dwarka Sector 13' },
              { '@type': 'Place', name: 'Dwarka Sector 21' },
              { '@type': 'Place', name: 'Dwarka Sector 22' },
              { '@type': 'Place', name: 'Dwarka Sector 23' },
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Best Bike, Scooty and Car Service in Dwarka', item: 'https://www.garagefixcare.in/best-bike-service-dwarka' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Dwarka specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in Dwarka
                ...
                >
                  Trusted by residents across Dwarka Sector 1, Sector 6, Sector 7, Sector 10, Sector 12, Sector 13, Sector 21, Sector 22, Sector 23, Dwarka Mor and Dwarka Expressway — our certified mechanics handle bikes, scooties and cars right at your doorstep.
                </motion.p>
              </motion.div>
        ...
        {/* Dark premium information strip — Dwarka specific copy */}
        <motion.div
          className="w-full"
          style={{
        ...
        {/* Hot Deals This Week — Dwarka specific copy, Delhi Cantt-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Limited-time offer for Dwarka, Dwarka Mor and Dwarka Expressway customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-white/70 max-w-xl mx-auto">Service support for leading two-wheeler brands across Dwarka and Delhi.</p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Dwarka pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service in Dwarka and nearby areas, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Areas Covered — Dwarka localities */}
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Sectors &amp; Areas We Serve in <span className="text-red-600">Dwarka</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you live in Dwarka Sector 1, Sector 6, Sector 7, Sector 10, Sector 12, Sector 13, Sector 21, Sector 22 or Sector 23, close to Dwarka Mor, along Dwarka Expressway or near Palam, our bike, scooty and car mechanics reach your doorstep. Same-day doorstep service is available across the Dwarka sub-city, subject to location and technician availability, starting at ₹299 for bike and scooty service.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Bike, Scooty &amp; Car Care, <span className="text-red-600">Right at Your Door in Dwarka</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Dwarka mechanics handle bikes, scooties and cars at your location, starting at ₹299 for bike and scooty service. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Comprehensive SEO Content (Dwarka specific) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in Dwarka</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>Dwarka is one of Delhi&apos;s most well-planned residential sub-cities, with high-rise apartment societies, tree-lined sectors, and the growing commercial belt along Dwarka Expressway. Thousands of two-wheeler and car owners here depend on their vehicles for daily office commutes, metro feeder rides to Dwarka Metro Station, school drops, and neighbourhood errands around Vegas Mall and ISKCON Dwarka. Garage Fix Care is Dwarka&apos;s trusted doorstep vehicle service, bringing certified and background-verified mechanics directly to your society parking, home or office, whether you live in Sector 1, Sector 6, Sector 7, Sector 10, Sector 12, Sector 13, Sector 21, Sector 22 or Sector 23, or are based closer to Dwarka Mor or Palam. Our mechanics typically reach your location within 2–4 hours of booking, subject to availability. Doorstep bike and scooty service starts at just ₹299 — covering all essential checks including engine oil change, air filter cleaning, spark plug inspection, brake adjustment and basic electrical check — with every task completed on the spot. We also handle car servicing and repairs at your doorstep, with pricing quoted based on your car&apos;s model and requirement. We service every major two-wheeler brand seen across Dwarka: Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM and more, from daily commuters and family scooties like the Honda Activa, TVS Jupiter and Suzuki Access, to premium machines like the Royal Enfield Classic 350 and KTM Duke 390, alongside popular hatchbacks and sedans. What distinguishes us as the best bike, scooty and car service in Dwarka is our strict pricing transparency — you receive a full itemised estimate before a single tool is touched, ensuring zero hidden charges at the end. We use only genuine engine oils from Motul and Wurth, paired with manufacturer-approved spare parts, and each service is backed by our 10-day hassle-free service guarantee.</p>
              <p>Dwarka&apos;s dense residential layout, the morning rush near Dwarka Metro Station, and the ongoing construction along Dwarka Expressway all accelerate wear on engine oil, air filters, tyres and brakes — making regular servicing a genuine safety necessity for bikes, scooties and cars alike. Our mechanics carry professional diagnostic tools to identify emerging issues before they become expensive failures, significantly extending your vehicle&apos;s lifespan whether you commute daily towards Palam or just ride around your sector. We also handle emergency breakdown situations across Dwarka — if your bike, scooty or car stops near Dwarka Mor, Bharat Vandana Park or anywhere on the way to Najafgarh Road, call us and we dispatch a mechanic to your exact location as soon as possible. From battery replacement and brake pad changes to clutch cable adjustment and tyre puncture repair, our technicians fix it all on the spot without towing. Garage Fix Care has completed over 1,00,000 services across Delhi NCR, earning a consistent 4.7-star Google rating for professionalism, punctuality and honest pricing. Book your bike, scooty or car service in Dwarka Sector 1, Sector 6, Sector 7, Sector 10, Sector 12, Sector 13, Sector 21, Sector 22, Sector 23, Dwarka Mor, Dwarka Expressway or Palam today via our website, WhatsApp or direct call — and discover the convenience of professional doorstep vehicle care starting at just ₹299 for bike and scooty service.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Dwarka
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Dwarka&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM and more — right at your home or society parking in Dwarka.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Dwarka" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to residents of Dwarka, Dwarka Mor, Dwarka Expressway and Palam — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced in Dwarka is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your vehicle running at its best — starting at ₹299 for bike and scooty service, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Dwarka" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Surendra Singh', img: testimonial1, text: 'Excellent doorstep service in Dwarka Sector 12. Professional and knowledgeable mechanic.', time: 'a month ago' },
                { name: 'Dharmendra Gupta', img: testimonial2, text: 'Transparent billing with video evidence, booked from Dwarka Sector 10. Very reliable.', time: 'a month ago' },
                { name: 'Rohit Prasad', img: testimonial3, text: 'Great service near Dwarka Expressway, convenient and affordable.', time: 'a month ago' },
                { name: 'Prabhjeet Sharma', img: testimonial4, text: 'Quick response near Dwarka Mor, professional mechanic. Will recommend.', time: 'a month ago' },
              ].map(t => (
        ...
        {/* FAQs (Dwarka specific — matches FAQPage schema exactly) */}
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in Dwarka — <span className="text-red-600">Common Questions</span>
            </motion.h2>
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike, Scooty or Car Service in Dwarka Today
            </h2>
            <p className="text-sm sm:text-base text-white mb-3 sm:mb-5 max-w-xl mx-auto">
              Same-day doorstep service across Dwarka and nearby areas starting at ₹299. Our mechanic comes to you — no travel, no waiting, no hidden charges.
            </p>
            <a
              href="https://www.garagefixcare.in/bookservice"
