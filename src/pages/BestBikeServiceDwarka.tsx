...
const BestBikeServiceDwarka = () => {
  ...
  const heroAlts = [
    "Best bike service in Dwarka at your doorstep",
    "Doorstep bike repair in Dwarka Delhi",
    "Expert motorcycle mechanic Dwarka",
    "Certified bike technician near me Dwarka"
  ];
  useEffect(() => {
  ...
  const carouselImages = [
    { src: bikeServiceOfferImage, alt: "Bike service offer Dwarka Delhi" },
    { src: doorstepImage, alt: "Doorstep bike service Dwarka" },
    { src: engineImage, alt: "Bike engine repair Dwarka" },
    { src: roadsideImage, alt: "Roadside bike assistance Dwarka" },
  ];
  ...
  const serviceCities = [
    { name: "Dwarka", color: "text-indigo-700" },
  ...
  const coveredAreas = [
    "Sector 1", "Sector 6", "Sector 7", "Sector 10",
    "Sector 12", "Sector 13", "Sector 21", "Sector 22",
    "Sector 23", "Dwarka Mor", "Dwarka Expressway"
  ];
  ...
  return (
    <>
      <SEOHelmet
        title="Bike Service in Dwarka Delhi | At-Home Repair ₹299 | Garage Fix Care"
        description="Get reliable at-home bike servicing in Dwarka, Delhi starting at ₹299. Expert mechanics reach Sector 1, 6, 10, 21, 23, Dwarka Mor and nearby areas. Same-day booking available."
        canonical="https://www.garagefixcare.in/best-bike-service-dwarka"
        robots="index, follow"
        og={{
          url: "https://www.garagefixcare.in/best-bike-service-dwarka",
          image: "https://www.garagefixcare.in/og-banner.png",
          imageAlt: "Doorstep bike mechanic in Dwarka Delhi by Garage Fix Care",
          type: "website",
        }}
        twitter={{
          image: "https://www.garagefixcare.in/og-banner.png",
          imageAlt: "Two-wheeler repair and servicing at home in Dwarka Delhi",
        }}
        structuredData={[
          {
            ...
            "description": "Garage Fix Care provides at-home two-wheeler servicing across Dwarka, Delhi. Certified mechanics reach your apartment or society with all tools and genuine oils — starting at ₹299.",
            "url": "https://www.garagefixcare.in/best-bike-service-dwarka",
            ...
            "geo": { "@type": "GeoCoordinates", "latitude": "28.5921", "longitude": "77.0460" },
            "areaServed": [
              { "@type": "City", "name": "Dwarka", "sameAs": "https://en.wikipedia.org/wiki/Dwarka,_Delhi" },
          ...
          },
          {
            "@context": "https://schema.org",
            "@type": "Service",
            "name": "At-Home Bike Servicing in Dwarka Delhi",
            "provider": { "@type": "LocalBusiness", "name": "Garage Fix Care" },
            "areaServed": "Dwarka, Delhi",
            "description": "Garage Fix Care sends background-verified bike mechanics to your apartment or society in Dwarka. Services include oil change, brake adjustment, engine diagnostics, battery swap, tyre repair, and more — all starting at ₹299 with no hidden fees.",
          ...
          },
          {
            ...
            "@type": "FAQPage",
            "mainEntity": [
              { "@type": "Question", "name": "How much does bike servicing cost in Dwarka?", "acceptedAnswer": { "@type": "Answer", "text": "At-home bike servicing in Dwarka starts at ₹299 for 100–125cc bikes. Pricing goes up to ₹999 for high-displacement sports bikes. All rates cover labour with zero hidden charges." } },
              { "@type": "Question", "name": "Which sectors in Dwarka are covered by Garage Fix Care?", "acceptedAnswer": { "@type": "Answer", "text": "We cover Sector 1, Sector 6, Sector 7, Sector 10, Sector 12, Sector 13, Sector 21, Sector 22, Sector 23, Dwarka Mor, and areas along Dwarka Expressway." } },
              { "@type": "Question", "name": "Can a mechanic come to my society in Dwarka?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Our mechanics regularly service bikes inside apartment complexes and residential societies across Dwarka. Just share your society name and sector when booking." } },
              { "@type": "Question", "name": "Do you handle emergency bike breakdown near Dwarka Metro Station?", "acceptedAnswer": { "@type": "Answer", "text": "Absolutely. If your bike breaks down near Dwarka Metro Station, Dwarka Mor, or anywhere in the Dwarka sub-city, call us and we dispatch a mechanic to your exact location." } }
            ]
          },
          {
            "@context": "https://schema.org",
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 2, "name": "Bike Service in Dwarka", "item": "https://www.garagefixcare.in/best-bike-service-dwarka" }
            ]
          }
        ]}
      />
      ...
      <div className="min-h-screen">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 items-center">
                ...
                <div>
                  <h1 className="text-brandRed text-xl sm:text-3xl md:text-4xl font-bold mb-2 sm:mb-3 leading-tight">
                    Bike Servicing in Dwarka, Delhi
                    <span className="text-orange-500"> — At Your Doorstep from ₹299</span>
                  </h1>
                  <p className="font-poppins text-xs sm:text-sm font-semibold text-orange-300 mb-2">
                    From ₹299 Only • Same-Day Availability • Verified Mechanics Near You
                  </p>
                  <p className="font-poppins text-xs sm:text-sm leading-relaxed text-white/90 mb-3 sm:mb-4">
                    Dwarka residents no longer need to wheel their bikes to a distant workshop. Garage Fix Care sends trained, background-verified mechanics directly to your apartment, society gate, or office parking — in Sector 6, Sector 12, Sector 21, or anywhere across the Dwarka sub-city. Whether you ride to the metro every morning or need your scooty for school runs and market trips, we keep your two-wheeler running perfectly — all at transparent, flat rates.
                  </p>
                  <div className="flex flex-wrap gap-x-3 gap-y-1 mb-4 sm:mb-5 text-xs text-white/80">
                    {["✔ From ₹299", "✔ Same-Day Slots", "✔ Mechanics at Your Gate", "✔ Verified Technicians", "✔ Zero Hidden Charges"].map((point, i) => (
        ...
        <section className="py-8 bg-slate-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-center mb-8"><div className="flex items-center"><h2 className="text-2xl sm:text-4xl font-bold mr-4"><span className="text-white">Hot Deals</span> <span className="text-red-600">This Week</span></h2><Flame className="h-8 w-8 text-orange-500" /></div><p className="text-lg text-white text-center">Special savings for Dwarka riders! Grab up to 10% off on two-wheeler repairs and servicing delivered straight to your door. Limited slots — book today!</p></div>
          </div>
        ...
        <section className="py-12 bg-slate-900">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-white mb-6">Clear, upfront labour rates for at-home bike servicing in Dwarka — charged by engine size, no last-minute surprises.</p>
        ...
        <section className="py-8 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">Sectors &amp; Areas We Serve in <span className="text-red-600">Dwarka</span></h2>
            ...
            <p className="text-white text-base max-w-3xl mx-auto">From the high-rise apartments of Sector 10 and Sector 22 to the busy lanes near Vegas Mall, ISKCON Dwarka, Bharat Vandana Park, and Dwarka Metro Station — our mechanics reach every corner of the Dwarka sub-city within 2–4 hours. Same-day slots are available for most areas.</p>
          </div>
        </section>
        ...
        <section className="py-12 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">Everything Your Bike Needs, <span className="text-red-600">Delivered in Dwarka</span></h2>
            <p className="text-white mb-6">Routine tune-ups to complex engine work — our Dwarka mechanics are equipped to handle it all at your location.</p>
        ...
        <section className="py-10 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">Garage Fix Care — <span className="text-red-600">Dwarka's Favourite At-Home Bike Service</span></h2>
            <div className="space-y-4 text-gray-200 text-base leading-relaxed">
              <p>Dwarka is one of Delhi's most well-planned residential sub-cities, home to thousands of two-wheeler owners who depend on their bikes for daily office commutes, school runs, metro connectivity, and neighbourhood errands. Yet finding a reliable, honest mechanic in Dwarka — someone who won't overcharge or replace parts unnecessarily — has always been a challenge. Garage Fix Care changes that completely. We send certified, background-verified mechanics directly to your society parking, apartment gate, or office lobby across every sector in Dwarka. Whether you live in Sector 1 near the main market, in the dense residential pockets of Sector 7 and Sector 13, or in the newer apartment complexes of Sector 21 and Sector 23, our team reaches you within 2–4 hours of placing a booking. At-home bike servicing in Dwarka starts at just ₹299 — covering routine work like engine oil change, air filter cleaning, spark plug inspection, chain lubrication, brake adjustment, and a basic electrical check — all completed on the spot without you leaving your building.</p>
              <p>Dwarka's roads, the daily metro feeder traffic around Dwarka Metro Station, and the fast-growing commercial activity near Vegas Mall and Bharat Vandana Park mean bikes accumulate wear faster than owners realise. Dust, stop-and-go traffic, and Delhi's temperature swings degrade engine oil, wear out brake pads, and strain tyres far sooner than the factory service interval suggests. Our Dwarka mechanics carry professional diagnostic tools to catch hidden issues — loose bolts, cracked air filters, early battery drain, worn chain sprockets — before they leave you stranded mid-commute. We service every major brand popular in Dwarka: Honda Activa, TVS Jupiter, Hero Splendor, Bajaj Pulsar, Yamaha FZ, Royal Enfield Classic 350, Suzuki Access 125, and more. Every job uses genuine engine oils from Motul and Wurth, and each service is backed by our 10-day hassle-free service guarantee. If any issue resurfaces within 10 days of our visit, we return and fix it free of charge. With over 1,00,000 services completed across Delhi NCR and a consistent 4.7-star Google rating, Garage Fix Care is the at-home bike service Dwarka residents trust — save time, skip the workshop queue, and get your bike serviced right where it's parked.</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-8 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-6 items-center">
            <div><p className="text-xs">Get Rs.10 Off On Your First Service in Dwarka</p><h2 className="text-3xl font-bold">GarageFixCare <span className="text-red-600">Service Warranty</span></h2><p className="mb-4">Dwarka's trusted at-home bike service. We maintain all motorcycle and scooter brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM, and more — right at your society or office parking.</p><div className="flex gap-2"><img src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg" alt="Google Play" className="h-10" /><img src="https://developer.apple.com/assets/elements/badges/download-on-the-app-store.svg" alt="App Store" className="h-10" /></div></div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[{ img: warrantyImg, title: "10-Day Free Service Guarantee", desc: "We fix post-service issues at no cost" }, { img: pickupImg, title: "Free Pickup and Drop", desc: "Available when your bike can't be ridden" }, { img: transparentImg, title: "Upfront Transparent Pricing", desc: "Full estimate before work begins" }, { img: trainedImg, title: "Verified Expert Mechanics", desc: "Background-checked and certified" }].map((item, idx) => (
        ...
        <section className="py-12 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-6 items-center">
            <div className="order-2 lg:order-1"><img src={handshakeImg} alt="Trust and reliability" className="rounded-lg shadow-lg w-full max-w-sm" /></div>
            <div className="order-1">
              <h2 className="text-3xl font-bold mb-2">Why Dwarka Riders <span className="text-red-600">Choose GarageFixCare?</span></h2>
              <p>We understand the daily rhythm of Dwarka — morning metro commutes, kids' school drops, weekend market runs. Your bike is essential, and we make sure it never lets you down.</p>
              <ul className="space-y-2 mt-4">
                {[
                  "Mechanics arrive at your society or gate",
                  "No waiting room, no travel time wasted",
                  "Itemised billing with nothing hidden",
                  "Only genuine Motul and Wurth products used",
                  "10-day post-service guarantee included",
                  "On-spot diagnosis and repair"
        ...
        <section className="bg-slate-800 py-10">
          <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-6 items-center">
            <div>
              <h2 className="text-3xl font-bold text-white mb-2">How <span className="text-red-600">GarageFixCare</span> Works in Dwarka?</h2>
              <p className="text-white mb-4">Getting your bike serviced in Dwarka is straightforward. Choose a time, share your location, and let our mechanic handle the rest — right at your building.</p>
              <ul className="space-y-2">
                {["Pick a Time Slot Online or Call Us", "Mechanic Dispatched to Your Address", "Full Service Completed On-Site", "Itemised Bill Shared Before Payment", "10-Day Guarantee Activated", "Rate Us and Share Feedback"].map(s => <li key={s} className="flex items-center text-white"><span className="text-red-500 mr-1">◆</span> {s}</li>)}
              </ul>
            </div>
            <div className="flex justify-center"><img src={howWorksImage} alt="How GarageFixCare works in Dwarka" className="rounded-lg shadow-lg max-w-sm" /></div>
          </div>
        </section>
        ...
        {/* Testimonials */}
        <section className="bg-slate-800 py-10">
          <div className="text-center"><h2 className="text-3xl font-bold text-white">Real Feedback from <span className="text-red-600">Our Customers</span></h2><p className="text-white">Verified reviews on Google</p><div className="flex justify-center gap-1 my-2">{[...Array(5)].map((_, i) => <Star key={i} className="h-5 w-5 text-yellow-400 fill-current" />)}<span className="text-white ml-2 font-semibold">4.7 Rating on Google</span></div><a href="https://www.google.com" target="_blank" className="bg-red-600 px-5 py-2 rounded-md text-white inline-block">Leave a Google Review</a></div>
        ...
        {/* FAQs — Dwarka-specific */}
        <section className="bg-slate-900 py-10">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-3xl font-bold text-white text-center mb-6">Dwarka Riders Ask — <span className="text-red-600">We Answer</span></h2>
            <div className="space-y-3">
              {[
                {
                  q: "How much does at-home bike servicing cost in Dwarka?",
                  a: "At-home bike servicing in Dwarka starts at ₹299 for 100–125cc bikes (Regular Service). Classic Service for 135–200cc costs ₹399, Premium for 220–300cc is ₹499, Royal for 350–450cc is ₹599, and Sports for above 500cc is ₹999. Labour is included in all rates with no hidden add-ons."
                },
                {
                  q: "Which sectors in Dwarka does Garage Fix Care cover?",
                  a: "We cover Sector 1, Sector 6, Sector 7, Sector 10, Sector 12, Sector 13, Sector 21, Sector 22, Sector 23, Dwarka Mor, and areas along Dwarka Expressway. If you're unsure whether your area is included, call us and we'll confirm."
                },
                {
                  q: "Can your mechanic come to my apartment society in Dwarka?",
                  a: "Yes, absolutely. We regularly service bikes inside residential societies and apartment complexes across Dwarka. Share your society name, sector, and gate number while booking — our mechanic will come directly to your parking bay."
                },
                {
                  q: "How long does it take for a mechanic to arrive in Dwarka?",
                  a: "In most parts of Dwarka, our mechanics arrive within 2–4 hours of booking. For urgent situations — a bike that won't start before your morning commute, for example — call us directly and we'll prioritise your slot."
                },
                {
                  q: "Do you service bikes near Dwarka Metro Station and Dwarka Mor?",
                  a: "Yes. We frequently service bikes in areas near Dwarka Metro Station, Dwarka Mor, ISKCON Dwarka, Vegas Mall, and Bharat Vandana Park. If your bike breaks down near any of these landmarks, call us for immediate roadside dispatch."
                },
                {
                  q: "Do you service scooties in Dwarka for daily school and market use?",
                  a: "Yes. We service and repair all popular scooties in Dwarka including Honda Activa, TVS Jupiter, Suzuki Access 125, Hero Maestro, and Honda Dio — ideal for school drop-offs, market trips, and metro feeder rides. All repairs are done at your location."
                },
                {
                  q: "Is there a warranty on the bike service done in Dwarka?",
                  a: "Every service completed by Garage Fix Care in Dwarka comes with a 10-day hassle-free guarantee. If any issue arises related to our service within those 10 days, we send a mechanic back at zero additional cost."
                },
                {
                  q: "How do I book a bike mechanic in Dwarka?",
                  a: "You can book through our website at garagefixcare.in, WhatsApp us on 9540553759, or call us directly. Mention your Dwarka sector and a preferred time window — we'll confirm your slot and send the mechanic."
                }
              ].map((faq, idx) => (
        ...
        <section className="py-8 bg-slate-800 text-center">
          <h2 className="text-3xl font-bold text-white mb-2">Schedule Your Bike Service in Dwarka Today</h2>
          <p className="text-white mb-4">At-home service from ₹299. No commute, no waiting, no surprises — just reliable two-wheeler care at your gate.</p>
...
export default BestBikeServiceDwarka;