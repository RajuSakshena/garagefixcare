...
// Delhi specific / existing assets — kept from the original page
...
const BestBikeServiceDelhi = () => {
  ...
  const carouselImages = [
    ...
    { src: hotDealsImage3, alt: 'Bike engine repair in North Delhi' },
    { src: hotDealsImage4, alt: 'Roadside bike assistance in Dwarka' },
    { src: hotDealsImage5, alt: 'Doorstep bike repair deal in Rohini' },
  ];
  const hotDealsAreaBadges = ['South Delhi', 'North Delhi', 'East Delhi', 'West Delhi', 'Dwarka', 'Rohini', 'Laxmi Nagar', 'Saket'];
  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Delhi specific) */}
              <motion.div
        ...
        {/* Dark premium information strip — Delhi specific copy */}
        <motion.div
          className="w-full"
          style={{
        ...
        {/* Hot Deals This Week — Delhi specific copy, Home-style marquee */}
        ...
        {/* At-Home Service Price List — Delhi pricing (premium vertical service-plan cards) */}
        ...
        {/* Areas Covered — Delhi localities */}
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              We Cover All Major Areas in <span className="text-red-600">Delhi NCR</span>
            </motion.h2>
            <motion.div
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Delhi
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Delhi" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Delhi" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <Link
                to="/"
                className="bg-slate-700 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-xl font-semibold text-sm sm:text-base shadow-lg hover:bg-slate-600 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200 inline-block"
              >
                Home
              </Link>
              <Link
