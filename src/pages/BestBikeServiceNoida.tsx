...
const BestBikeServiceNoida = () => {
  ...
  const heroAlts = [
    "Best bike service in Noida at doorstep",
    "Doorstep bike repair in Noida",
    "Professional motorcycle repair Noida",
    "Certified bike mechanic near me"
  ];
  useEffect(() => {
  ...
  const carouselImages = [
    { src: bikeServiceOfferImage, alt: "Bike service offer Noida" },
    { src: doorstepImage, alt: "Doorstep bike service Noida" },
    { src: engineImage, alt: "Bike engine repair Noida" },
    { src: roadsideImage, alt: "Roadside bike assistance Noida" },
  ];
  ...
  const coveredAreas = ["Sector 18", "Sector 62", "Sector 63", "Sector 75", "Sector 76", "Sector 78", "Sector 137", "Greater Noida"];
  ...
  return (
    <>
      <SEOHelmet
        ...
        twitter={{
          image: "https://www.garagefixcare.in/og-banner.png",
          imageAlt: "Doorstep bike service and repair in Noida",
        }}
        structuredData={[
          {
          ...
          },
          {
            "@context": "https://schema.org",
            "@type": "Service",
            "name": "Doorstep Bike Service in Noida",
            "provider": { "@type": "LocalBusiness", "name": "Garage Fix Care" },
            "areaServed": "Noida",
            "description": "At-home bike servicing starting at ₹299. Oil change, engine repair, battery replacement, puncture fix — same-day doorstep service.",
      ...
      <div className="min-h-screen">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 items-center">
                ...
                <div>
                  ...
                  <p className="font-poppins text-xs sm:text-sm leading-relaxed text-white/90 mb-3 sm:mb-4">
                    Get the most trusted bike service in Noida right at your doorstep. Whether you own a commuter bike, sports bike, or scooty, our expert mechanics handle everything from oil change to engine overhaul. No garage queues, no hidden costs — just honest, affordable, and professional service.
                  </p>
        ...
        <section className="py-8 bg-slate-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-center mb-8"><div className="flex items-center"><h2 className="text-2xl sm:text-4xl font-bold mr-4"><span className="text-white">Hot Deals</span> <span className="text-red-600">This Week</span></h2><Flame className="h-8 w-8 text-orange-500" /></div><p className="text-lg text-white text-center">Limited-time offer for Noida customers! Get up to 10% off on bike repairs and servicing at your doorstep. Hurry—these deals won’t last long!</p></div>
          </div>
        ...
        <section className="py-12 bg-slate-900">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-white mb-6">Transparent pricing for doorstep bike service in Noida. Labour charges based on engine size — no hidden fees.</p>
        ...
        <section className="py-8 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-white text-base max-w-3xl mx-auto">Whether you live in Sector 18, 62, 63, 75, 76, 78, 137 or anywhere in Greater Noida, our bike mechanics reach your doorstep within 2-4 hours. Same-day bike service available across Noida.</p>
          </div>
        </section>
        ...
        <section className="py-12 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">Complete Bike Care, <span className="text-red-600">Right at Your Door in Noida</span></h2>
            <p className="text-white mb-6">From routine oil changes to full engine repair — our Noida mechanics handle it all.</p>
        ...
        <section className="py-10 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="space-y-4 text-gray-200 text-base leading-relaxed">
              ...
              <p>Don’t wait in garage queues. Book online or call us. A bike mechanic near you will reach your Noida address within hours. Same-day service guaranteed for bookings before noon. Experience the best doorstep bike service in Noida with Garage Fix Care.</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-6 items-center">
            ...
            <div className="order-1"><h2 className="text-3xl font-bold mb-2">Why Choose <span className="text-red-600">GarageFixCare?</span></h2><p>We bring certified mechanics directly to Noida residents — honest pricing, genuine parts, zero hassle.</p><ul className="space-y-2 mt-4">{["Hassle-Free Doorstep Service", "Certified and Skilled Technicians", "Honest Pricing", "Certified Genuine Parts", "Your Satisfaction Guaranteed", "Fast and Professional Service"].map(item => <li key={item} className="flex items-center"><span className="text-red-500 mr-1">◆</span> {item}</li>)}</ul></div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="space-y-3">
              {[
                ...
                { q: "How do I book a bike mechanic near me in Noida?", a: "Call us, WhatsApp, or use the booking form on this page. Share your location and preferred time." },
                ...
                { q: "Do you service scooties like Activa or Jupiter?", a: "Yes, we provide complete scooty repair and service for Honda Activa, TVS Jupiter, Suzuki Access, and more." },
                ...
                { q: "What makes GarageFix Care better than a regular workshop?", a: "We come to you, offer transparent pricing, trained mechanics, genuine parts, and a 10-day warranty." }
              ].map((faq, idx) => (
...
export default BestBikeServiceNoida;