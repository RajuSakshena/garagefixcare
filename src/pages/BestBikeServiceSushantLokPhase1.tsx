...
const BestBikeServiceSushantLokPhase1 = () => {
  ...
  const heroAlts = [
    "Best bike service in Sushant Lok Phase 1 at doorstep",
    "Doorstep bike repair in Sushant Lok Phase 1",
    "Professional motorcycle repair near HUDA City Centre",
    "Certified bike mechanic near Galleria Market Gurgaon"
  ];
  useEffect(() => {
  ...
  const carouselImages = [
    { src: bikeServiceOfferImage, alt: "Bike service offer Sushant Lok Phase 1" },
    { src: doorstepImage, alt: "Doorstep bike service near Golf Course Road" },
    { src: engineImage, alt: "Bike engine repair Sushant Lok Phase 1" },
    { src: roadsideImage, alt: "Roadside bike assistance near MG Road Gurgaon" },
  ];
  ...
  const serviceCities = [
    { name: "Sushant Lok Phase 1", color: "text-indigo-700" },
    { name: "HUDA City Centre", color: "text-red-700" },
    { name: "Golf Course Road", color: "text-teal-700" },
    { name: "MG Road", color: "text-gray-900" },
    { name: "DLF Phase 4", color: "text-orange-700" },
    { name: "IFFCO Chowk", color: "text-slate-700" },
  ];

  const coveredAreas = [
    "Sushant Lok Phase 1", "HUDA City Centre", "Galleria Market",
    "Golf Course Road", "Sector 27", "Sector 28",
    "MG Road", "Vyapar Kendra", "DLF Phase 4", "IFFCO Chowk"
  ];
  ...
  return (
    <>
      <SEOHelmet
        title="Best Bike Service in Sushant Lok Phase 1 | Doorstep Bike Repair ₹299 | Garage Fix Care"
        description="Trusted doorstep bike service in Sushant Lok Phase 1 starting at ₹299. Same-day bike repair near HUDA City Centre, Galleria Market, Golf Course Road and MG Road."
        canonical="https://www.garagefixcare.in/best-bike-service-sushant-lok-phase-1"
        robots="index, follow"
        og={{
          url: "https://www.garagefixcare.in/best-bike-service-sushant-lok-phase-1",
          image: "https://www.garagefixcare.in/og-banner.png",
          imageAlt: "Best bike service in Sushant Lok Phase 1 at doorstep by Garage Fix Care",
          type: "website",
        }}
        twitter={{
          image: "https://www.garagefixcare.in/og-banner.png",
          imageAlt: "Doorstep bike service and repair in Sushant Lok Phase 1",
        }}
        structuredData={[
          {
            ...
            "description": "Best bike service in Sushant Lok Phase 1. Doorstep bike repair, servicing, oil change, battery replacement starting at ₹299.",
            "url": "https://www.garagefixcare.in/best-bike-service-sushant-lok-phase-1",
            ...
            "address": {
              "@type": "PostalAddress",
              "addressLocality": "Sushant Lok Phase 1",
              "addressRegion": "Haryana",
              "addressCountry": "IN"
            },
            "geo": { "@type": "GeoCoordinates", "latitude": "28.4700", "longitude": "77.0780" },
            "areaServed": [
              { "@type": "Place", "name": "Sushant Lok Phase 1" },
              { "@type": "Place", "name": "HUDA City Centre" },
              { "@type": "Place", "name": "Galleria Market" },
              { "@type": "Place", "name": "Golf Course Road" },
              { "@type": "Place", "name": "Sector 27" },
              { "@type": "Place", "name": "Sector 28" },
              { "@type": "Place", "name": "MG Road" },
              { "@type": "Place", "name": "Vyapar Kendra" },
              { "@type": "Place", "name": "DLF Phase 4" },
          ...
          },
          {
            "@context": "https://schema.org",
            "@type": "Service",
            "name": "Doorstep Bike Service in Sushant Lok Phase 1",
            "provider": { "@type": "LocalBusiness", "name": "Garage Fix Care" },
            "areaServed": "Sushant Lok Phase 1, Gurgaon",
            "description": "At-home bike servicing starting at ₹299. Oil change, engine repair, battery replacement, puncture fix — same-day doorstep service across Sushant Lok Phase 1 and nearby areas.",
          ...
          },
          {
            ...
            "@type": "FAQPage",
            "mainEntity": [
              { "@type": "Question", "name": "How much does bike service cost in Sushant Lok Phase 1?", "acceptedAnswer": { "@type": "Answer", "text": "Bike service in Sushant Lok Phase 1 starts from ₹299 for 100–125cc bikes. Classic Service is ₹399, Premium ₹499, Royal ₹599, and Sports ₹999. All prices include labour with no hidden charges." } },
              { "@type": "Question", "name": "Do you provide doorstep bike repair in Sushant Lok Phase 1?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, we provide complete doorstep bike repair across Sushant Lok Phase 1 and nearby areas including HUDA City Centre, Galleria Market, and Golf Course Road." } },
              { "@type": "Question", "name": "Which areas near Sushant Lok Phase 1 are covered?", "acceptedAnswer": { "@type": "Answer", "text": "We cover Sushant Lok Phase 1, HUDA City Centre, Galleria Market, Golf Course Road, Sector 27, Sector 28, MG Road, Vyapar Kendra, DLF Phase 4, IFFCO Chowk, and all surrounding localities." } },
              { "@type": "Question", "name": "Do you handle emergency bike breakdown near HUDA City Centre?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. If your bike breaks down anywhere near Sushant Lok Phase 1, HUDA City Centre, or Golf Course Road, call us immediately and we dispatch a mechanic to your location for on-spot repair." } }
            ]
          },
          {
            "@context": "https://schema.org",
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 2, "name": "Best Bike Service in Sushant Lok Phase 1", "item": "https://www.garagefixcare.in/best-bike-service-sushant-lok-phase-1" }
            ]
          }
        ]}
      />
      ...
      <div className="min-h-screen">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 items-center">
                ...
                <div>
                  <h1 className="text-brandRed text-xl sm:text-3xl md:text-4xl font-bold mb-2 sm:mb-3 leading-tight">
                    Best Bike Service in Sushant Lok Phase 1
                  ...
                  <p className="font-poppins text-xs sm:text-sm leading-relaxed text-white/90 mb-3 sm:mb-4">
                    Garage Fix Care brings Sushant Lok Phase 1's most trusted doorstep bike service straight to your home, society parking, or office. Whether you live near Galleria Market, HUDA City Centre, or Golf Course Road, our certified mechanics are just a call away — no garage visit needed, no hidden charges, and service starting at just ₹299.
                  </p>
        ...
        <section className="py-8 bg-slate-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-center mb-8"><div className="flex items-center"><h2 className="text-2xl sm:text-4xl font-bold mr-4"><span className="text-white">Hot Deals</span> <span className="text-red-600">This Week</span></h2><Flame className="h-8 w-8 text-orange-500" /></div><p className="text-lg text-white text-center">Limited-time offer for Sushant Lok Phase 1 customers! Get up to 10% off on bike repairs and servicing at your doorstep. Hurry — these deals won't last long!</p></div>
          </div>
        ...
        <section className="py-12 bg-slate-900">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-white mb-6">Transparent pricing for doorstep bike service in Sushant Lok Phase 1. Labour charges based on engine size — no hidden fees.</p>
        ...
        <section className="py-8 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">We Cover All Major Areas in <span className="text-red-600">Sushant Lok Phase 1 &amp; Nearby</span></h2>
            ...
            <p className="text-white text-base max-w-3xl mx-auto">Whether you live in Sushant Lok Phase 1, near HUDA City Centre, around Galleria Market, or along Golf Course Road, our bike mechanics reach your doorstep within 2–4 hours. We also cover Sector 27, Sector 28, MG Road, Vyapar Kendra, DLF Phase 4, and IFFCO Chowk — same-day bike service guaranteed.</p>
          </div>
        </section>
        ...
        <section className="py-12 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">Complete Bike Care, <span className="text-red-600">Right at Your Door in Sushant Lok Phase 1</span></h2>
            <p className="text-white mb-6">From routine oil changes to full engine repair — our mechanics handle it all near HUDA City Centre, Golf Course Road, and beyond.</p>
        ...
        <section className="py-10 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">Why Garage Fix Care is the <span className="text-red-600">Best Bike Service in Sushant Lok Phase 1</span></h2>
            <div className="space-y-4 text-gray-200 text-base leading-relaxed">
              <p>Sushant Lok Phase 1 is one of Gurgaon's most vibrant residential and commercial hubs — a neighbourhood where daily life moves fast, and two-wheeler owners can't afford downtime waiting at a workshop. Garage Fix Care is the answer: Gurgaon's most trusted doorstep bike service, bringing fully equipped and background-verified mechanics directly to your home, society parking, or office within 2–4 hours of booking. Whether you're based in the heart of Sushant Lok Phase 1, near the busy Galleria Market, close to HUDA City Centre Metro Station, or along Golf Course Road, our expert mechanics come to you — no travel, no workshop queues, and no hidden fees. Doorstep bike service here starts at just ₹299, covering all essential maintenance: engine oil change, air filter cleaning, spark plug inspection, brake adjustment, and a comprehensive electrical check — everything done on the spot, in your parking space.</p>
              <p>Riders commuting daily through MG Road, IFFCO Chowk, and Vyapar Kendra know how Gurgaon's traffic, heat, and dust wear down engine oil, clog air filters, and stress brakes far faster than the service manual suggests. Our mechanics carry professional diagnostic equipment to catch problems early — saving you from costly repairs down the line. We service every major brand you'll find across Sector 27, Sector 28, and DLF Phase 4: Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM, and Kawasaki, from everyday commuters and Honda Activa scooties to Royal Enfield Classic 350s and KTM Duke 390s. What makes us the best bike service near Sushant Lok Phase 1 is straightforward: full pricing transparency (itemised estimates before we touch your bike), genuine Motul and Wurth engine oils, manufacturer-approved spare parts, and a 10-day hassle-free service guarantee — every single time.</p>
              <p>Emergencies happen too. If your bike breaks down on Golf Course Road, stalls near IFFCO Chowk, or sputters out close to HUDA City Centre, a single call gets a Garage Fix Care mechanic dispatched to your GPS location immediately. We also handle battery replacements, tyre punctures, clutch cable adjustments, and brake pad changes on the spot — no towing required. With over 1,00,000 services completed across Gurgaon and Delhi NCR and a consistent 4.7-star Google rating built on punctuality, honest pricing, and professional workmanship, Garage Fix Care is the doorstep bike service that Sushant Lok Phase 1 residents trust most. Book your service today via our website, WhatsApp, or phone — and experience professional two-wheeler care that arrives at your convenience.</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-8 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-6 items-center">
            <div><p className="text-xs">Get Rs.10 Off On First Service in Sushant Lok Phase 1</p><h2 className="text-3xl font-bold">GarageFixCare <span className="text-red-600">Service Warranty</span></h2><p className="mb-4">Sushant Lok Phase 1's trusted doorstep bike service. We service all motorcycle and scooter brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM, and more — right at your home or office near Galleria Market, HUDA City Centre, or Golf Course Road.</p><div className="flex gap-2"><img src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg" alt="Google Play" className="h-10" /><img src="https://developer.apple.com/assets/elements/badges/download-on-the-app-store.svg" alt="App Store" className="h-10" /></div></div>
        ...
        <section className="py-12 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-6 items-center">
            ...
            <div className="order-1"><h2 className="text-3xl font-bold mb-2">Why Choose <span className="text-red-600">GarageFixCare?</span></h2><p>We bring certified mechanics directly to Sushant Lok Phase 1 residents — honest pricing, genuine parts, zero hassle near HUDA City Centre, MG Road, and DLF Phase 4.</p><ul className="space-y-2 mt-4">{["Hassle-Free Doorstep Service", "Certified and Skilled Technicians", "Honest Pricing", "Certified Genuine Parts", "Your Satisfaction Guaranteed", "Fast and Professional Service"].map(item => <li key={item} className="flex items-center"><span className="text-red-500 mr-1">◆</span> {item}</li>)}</ul></div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10">
          ...
          <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-4 gap-4 mt-6">
            {[{ name: "Surendra Singh", img: testimonial1, text: "Excellent service at my home in Sushant Lok Phase 1. Professional and knowledgeable mechanic.", time: "a month ago" }, { name: "Dharmendra Gupta", img: testimonial2, text: "Transparent pricing, video evidence of work done near HUDA City Centre. Highly reliable.", time: "a month ago" }, { name: "Rohit Prasad", img: testimonial3, text: "Great doorstep service near Golf Course Road. Convenient and affordable.", time: "a month ago" }, { name: "Prabhjeet Sharma", img: testimonial4, text: "Quick response near Galleria Market. Professional mechanic. Will recommend.", time: "a month ago" }].map(t => (
        ...
        <section className="bg-slate-900 py-10">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-3xl font-bold text-white text-center mb-6">Bike Service in Sushant Lok Phase 1 — <span className="text-red-600">Common Questions</span></h2>
            <div className="space-y-3">
              {[
                { q: "How much does bike service cost in Sushant Lok Phase 1?", a: "Bike service in Sushant Lok Phase 1 at Garage Fix Care starts from ₹299 for 100–125cc bikes (Regular Service). Classic Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Royal Service (350–450 CC) is ₹599, and Sports Service (above 500 CC) is ₹999. All prices include labour with zero hidden charges." },
                { q: "Do you provide doorstep bike repair in Sushant Lok Phase 1?", a: "Yes, we provide complete doorstep bike repair across Sushant Lok Phase 1 and nearby areas. Our certified mechanics arrive fully equipped — no garage visit needed." },
                { q: "Which areas near Sushant Lok Phase 1 are covered for bike service?", a: "We cover Sushant Lok Phase 1, HUDA City Centre, Galleria Market, Golf Course Road, Sector 27, Sector 28, MG Road, Vyapar Kendra, DLF Phase 4, IFFCO Chowk, and all surrounding localities in Gurgaon." },
                { q: "What is the best bike service near HUDA City Centre?", a: "Garage Fix Care is the highest-rated doorstep bike service near HUDA City Centre and Sushant Lok Phase 1 — starting at ₹299 with certified mechanics, transparent pricing, genuine parts, and a 10-day service guarantee." },
                { q: "Do you service Royal Enfield bikes in Sushant Lok Phase 1?", a: "Yes. We specialise in Royal Enfield servicing across Sushant Lok Phase 1 — Classic 350, Bullet 350, Meteor 350, Himalayan, and Thunderbird — all serviced at your doorstep." },
                { q: "How quickly can a mechanic reach me near Galleria Market?", a: "Our mechanics typically reach your location in Sushant Lok Phase 1 and near Galleria Market within 2–4 hours of booking. For urgent requests, call us and we will prioritise your slot." },
                { q: "Is your bike service pricing transparent in Sushant Lok Phase 1?", a: "Absolutely. We provide a full itemised cost estimate before starting any work. No surprise bills — what you see is exactly what you pay." },
                { q: "Do you service scooties in Sushant Lok Phase 1?", a: "Yes. We repair and service all scooties — Honda Activa, TVS Jupiter, Suzuki Access 125, Honda Dio, Hero Maestro — all at your doorstep in Sushant Lok Phase 1, near DLF Phase 4 or IFFCO Chowk." },
                { q: "Do you offer a warranty on bike service near Golf Course Road?", a: "Every service by Garage Fix Care includes a 10-day hassle-free service guarantee. If any issue arises post-service, we address it at no extra cost, whether you are near Golf Course Road or Sector 27." },
                { q: "How do I book a bike mechanic near me in Sushant Lok Phase 1?", a: "You can book via our website, WhatsApp us on 9540553759, or call directly. Share your location in or around Sushant Lok Phase 1 and your preferred time slot — we handle the rest." },
                { q: "What payment methods are accepted?", a: "We accept cash, UPI (Google Pay, PhonePe, Paytm), and all major mobile wallets. Payment is collected only after the service is complete." },
                { q: "Do I need to arrange any tools or oils?", a: "No. Our mechanics arrive fully equipped — tools, genuine Motul/Wurth engine oils, and all required spare parts are brought to your doorstep in Sushant Lok Phase 1." },
                { q: "Do you handle emergency bike breakdown near MG Road or IFFCO Chowk?", a: "Yes. If your bike breaks down near MG Road, IFFCO Chowk, Vyapar Kendra, or anywhere in the Sushant Lok Phase 1 area, call us immediately and we dispatch a mechanic to your location." },
                { q: "Can I book service for multiple bikes in Sushant Lok Phase 1?", a: "Yes, simply mention the number of bikes while booking and we will arrange the right team for your location." },
                { q: "What makes Garage Fix Care better than a local Sushant Lok workshop?", a: "We come to you in Sushant Lok Phase 1, saving your travel time, offer transparent itemised billing, use genuine parts, and provide a 10-day warranty — something most local workshops near Galleria Market or Sector 28 cannot match." }
              ].map((faq, idx) => (
        ...
        <section className="py-8 bg-slate-800 text-center">
          <h2 className="text-3xl font-bold text-white mb-2">Book Bike Service in Sushant Lok Phase 1 Today</h2>
          <p className="text-white mb-4">Same-day doorstep service starting at ₹299. Covering Sushant Lok Phase 1, HUDA City Centre, Galleria Market, Golf Course Road, Sector 27, Sector 28, MG Road, Vyapar Kendra, DLF Phase 4, and IFFCO Chowk. No travel, no waiting, no hidden charges.</p>
...
export default BestBikeServiceSushantLokPhase1;