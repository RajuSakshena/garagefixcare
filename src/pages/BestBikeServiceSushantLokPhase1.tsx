// BestBikeServiceSushantLokPhase1.tsx
// Sushant Lok Phase 1 specific SEO/content + Delhi Cantt master design system
// (video hero, Framer Motion, marquees, premium pricing cards, checklist modal)
...
const BestBikeServiceSushantLokPhase1 = () => {
  ...
  // Hot Deals marquee images — Sushant Lok Phase 1 specific copy/alt text
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Sushant Lok Phase 1' },
    { src: hotDealsImage2, alt: 'Doorstep scooty service near HUDA City Centre' },
    { src: hotDealsImage3, alt: 'Car engine repair near Galleria Market Gurugram' },
    { src: hotDealsImage4, alt: 'Roadside vehicle assistance near Golf Course Road' },
    { src: hotDealsImage5, alt: 'Doorstep bike and car repair deal near MG Road Gurgaon' },
  ];
  const hotDealsAreaBadges = ['Sushant Lok', 'HUDA City Centre', 'Galleria Market', 'Golf Course Road', 'MG Road', 'DLF Phase 4'];
  ...
  const serviceCities = [
    ...
    { name: 'Galleria Market', color: 'text-teal-700' },
    { name: 'Golf Course Road', color: 'text-gray-900' },
    { name: 'MG Road', color: 'text-orange-700' },
    { name: 'DLF Phase 4', color: 'text-slate-700' },
  ];

  const coveredAreas = [
    'Sushant Lok Phase 1', 'HUDA City Centre', 'Galleria Market', 'Golf Course Road',
    'Sector 27', 'Sector 28', 'MG Road', 'Vyapar Kendra',
    'DLF Phase 4', 'IFFCO Chowk',
  ];
  ...
  const faqs = [
    {
      q: 'What is the best bike, scooty and car service in Sushant Lok Phase 1?',
      a: "Garage Fix Care is Sushant Lok Phase 1's trusted doorstep service for bikes, scooties and cars, starting at just ₹299 for bike and scooty service. We use certified mechanics, transparent itemised pricing, genuine parts and back every job with a 10-day service guarantee.",
    },
    {
      q: 'How much does bike, scooty or car service cost in Sushant Lok Phase 1?',
      a: 'Bike and scooty service in Sushant Lok Phase 1 starts from ₹299 for 100–125cc vehicles (Regular Service). Classic Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Royal Service (350–450 CC) is ₹599, and Sports Service (above 500 CC) is ₹999. All prices include labour with zero hidden charges. Car service is quote-based and depends on your car model and the work required.',
    },
    {
      q: 'Do you provide doorstep bike, scooty and car repair in Sushant Lok Phase 1?',
      a: 'Yes. Our certified mechanics come to your home, society parking or office anywhere in Sushant Lok Phase 1 and nearby Gurugram with all tools, engine oils and spare parts — no garage visit needed for bikes, scooties or cars.',
    },
    {
      q: 'Do you provide car service pricing and quotes in Sushant Lok Phase 1?',
      a: 'Yes. Car service is quote-based — share your car make, model and the issue, and we give you a transparent itemised estimate before any work begins. There are no fixed car packages and no hidden charges.',
    },
    {
      q: 'Which areas near Sushant Lok Phase 1 are covered?',
      a: 'We cover Sushant Lok Phase 1, HUDA City Centre, Galleria Market, Golf Course Road, Sector 27, Sector 28, MG Road, Vyapar Kendra, DLF Phase 4, IFFCO Chowk and surrounding Gurugram localities.',
    },
    {
      q: 'Do you provide same-day doorstep vehicle service in Sushant Lok Phase 1?',
      a: 'Yes, same-day doorstep service is available for bikes, scooties and cars across Sushant Lok Phase 1. Our mechanics typically reach your location within 2–4 hours of booking.',
    },
    {
      q: 'Do you handle emergency bike, scooty or car breakdowns near HUDA City Centre and Golf Course Road?',
      a: 'Yes. If your bike, scooty or car breaks down near HUDA City Centre, Golf Course Road or anywhere in the Sushant Lok Phase 1 belt, call us and we dispatch a mechanic to your location for on-spot repair or recovery.',
    },
    {
      q: 'Do you provide bike and scooty service near Galleria Market, Sector 27 and Sector 28?',
      a: 'Yes, we provide doorstep bike and scooty service across Galleria Market, Sector 27, Sector 28 and nearby blocks — including Honda Activa, TVS Jupiter, Suzuki Access, Hero Splendor and Royal Enfield models.',
    },
    {
      q: 'Can you repair car batteries, brakes and common vehicle issues at my doorstep in Sushant Lok Phase 1?',
      a: 'Yes. Our mechanics handle car battery replacement, brake inspection and repair, tyre and puncture service, and common maintenance issues at your doorstep in Sushant Lok Phase 1 — alongside bike and scooty repairs.',
    },
    {
      q: 'Do you provide doorstep vehicle service near MG Road, DLF Phase 4 and IFFCO Chowk?',
      a: 'Yes. MG Road, DLF Phase 4 and IFFCO Chowk all fall within our doorstep service zone for bikes, scooties and cars, with mechanics reaching you within 2–4 hours of booking.',
    },
  ];
  ...
  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in Sushant Lok Phase 1 | Doorstep Service Just ₹299 | Garage Fix Care"
        description="Garage Fix Care offers doorstep bike, scooty and car service in Sushant Lok Phase 1, Gurugram, and nearby areas including HUDA City Centre, Galleria Market, Golf Course Road, MG Road, Sector 27, Sector 28, DLF Phase 4 and IFFCO Chowk, starting at just ₹299. Certified mechanics and same-day service at your doorstep."
        ...
        og={{
          ...
          imageAlt: 'Best bike, scooty and car service in Sushant Lok Phase 1 at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in Sushant Lok Phase 1, HUDA City Centre and Golf Course Road',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Sushant Lok Phase 1, Gurugram. Doorstep repair, servicing, oil change, battery replacement and car maintenance, starting at just ₹299 for bike and scooty service.',
            url: 'https://www.garagefixcare.in/best-bike-service-sushant-lok-phase-1',
            ...
            address: {
              '@type': 'PostalAddress',
              addressLocality: 'Sushant Lok Phase 1, Gurugram',
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Doorstep Bike, Scooty and Car Service in Sushant Lok Phase 1',
            provider: { '@type': 'LocalBusiness', name: 'Garage Fix Care' },
            areaServed: 'Sushant Lok Phase 1, Gurugram',
            description: 'At-home bike, scooty and car servicing across Sushant Lok Phase 1 and nearby Gurugram areas including HUDA City Centre, Galleria Market, Golf Course Road, Sector 27, Sector 28, MG Road, Vyapar Kendra, DLF Phase 4 and IFFCO Chowk. Bike and scooty service starts at ₹299, covering oil change, engine repair, battery replacement, brake repair, tyre service and puncture fix. Car service is quote-based and depends on the car model and work required — same-day doorstep service.',
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Best Bike, Scooty and Car Service in Sushant Lok Phase 1', item: 'https://www.garagefixcare.in/best-bike-service-sushant-lok-phase-1' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Sushant Lok Phase 1 specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in Sushant Lok Phase 1
        ...
        {/* Dark premium information strip — Sushant Lok Phase 1 specific copy */}
        <motion.div
          className="w-full"
          style={{
          ...
          <div className="max-w-[1100px] mx-auto px-[14px] py-[10px] sm:px-6 sm:py-3.5 relative overflow-hidden">
            ...
            <span className="relative inline-flex items-center gap-1.5 mb-1">
              ...
              <span className="text-[8px] sm:text-[9px] font-semibold uppercase tracking-wider" style={{ color: '#ff7a00' }}>
                Garage Fix Care — Sushant Lok Phase 1
              </span>
            </span>
            <p className="relative text-[10px] sm:text-sm leading-[1.4] sm:leading-relaxed" style={{ color: '#cbd5e1' }}>
              Skip the workshop queue. Our certified mechanics come to your home, society parking or office across Sushant Lok Phase 1, HUDA City Centre, Galleria Market, Golf Course Road, Sector 27, Sector 28, MG Road, Vyapar Kendra, DLF Phase 4 and IFFCO Chowk — servicing bikes, scooties and cars, from routine maintenance to engine repairs, starting at ₹299 for bike and scooty service. Fast, transparent, and affordable.
            </p>
          </div>
        </motion.div>
        ...
        {/* Hot Deals This Week — Sushant Lok Phase 1 specific copy, Delhi Cantt-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Limited-time offer for Sushant Lok Phase 1, HUDA City Centre and Golf Course Road customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-white/70 max-w-xl mx-auto">Service support for leading two-wheeler brands across Sushant Lok Phase 1 and Gurugram.</p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Sushant Lok Phase 1 pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service in Sushant Lok Phase 1 and nearby Gurugram, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Areas Covered — Sushant Lok Phase 1 localities */}
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              We Cover All Major Areas in <span className="text-red-600">Sushant Lok Phase 1 &amp; Nearby Gurugram</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you live in Sushant Lok Phase 1, near HUDA City Centre, around Galleria Market, along Golf Course Road, in Sector 27 or Sector 28, close to MG Road, Vyapar Kendra, DLF Phase 4 or IFFCO Chowk, our bike, scooty and car mechanics reach your doorstep within 2-4 hours. Same-day doorstep service available across the Sushant Lok Phase 1 belt, starting at ₹299 for bike and scooty service.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Vehicle Care, <span className="text-red-600">Right at Your Door in Sushant Lok Phase 1</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Sushant Lok Phase 1 mechanics handle bikes, scooties and cars at your location, starting at ₹299 for bike and scooty service. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              {bikeServiceCards.map((service, index) => (
                ...
                >
                  <img
                    src={service.img}
                    alt={`${service.name} in Sushant Lok Phase 1`}
        ...
        {/* Comprehensive SEO Content (Sushant Lok Phase 1 specific) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in Sushant Lok Phase 1</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>Sushant Lok Phase 1 sits at the heart of Gurugram&apos;s busiest residential and commercial belt, with HUDA City Centre, Galleria Market and Golf Course Road all a short ride away. Life here moves fast, and vehicle owners cannot afford to lose a day waiting at a workshop. Garage Fix Care brings a fully equipped, background-verified mechanic directly to your home, society parking or office anywhere in Sushant Lok Phase 1 within 2–4 hours of booking. Whether you are near Galleria Market, close to HUDA City Centre Metro Station, along Golf Course Road, or in the quieter blocks of Sector 27 and Sector 28, our team comes to you — no travel, no queues, and no hidden charges. Doorstep bike and scooty service starts at just ₹299, covering essential maintenance such as engine oil change, air filter cleaning, spark plug inspection, brake adjustment and a basic electrical check, all completed on the spot. Car servicing and repairs are also available at your doorstep, with pricing quoted transparently based on your car&apos;s model and the work required — no fixed packages, no guesswork.</p>
              <p>Riders and drivers commuting daily through MG Road, IFFCO Chowk and Vyapar Kendra know how Gurugram&apos;s traffic, heat and dust wear down engine oil, clog air filters and stress brakes far faster than the service manual suggests. Our mechanics carry professional diagnostic tools to catch problems early, saving you from expensive repairs later. We service every major two-wheeler brand seen across DLF Phase 4, Sector 27 and Sector 28 — Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM and more — from daily commuters and family scooties like the Honda Activa, TVS Jupiter and Suzuki Access, to premium machines like the Royal Enfield Classic 350 and KTM Duke 390. Alongside two-wheelers, we handle common car maintenance and repair jobs at your doorstep. What makes us the best bike, scooty and car service near Sushant Lok Phase 1 is straightforward: full pricing transparency with itemised estimates before any work begins, genuine Motul and Wurth engine oils, manufacturer-approved spare parts, and a 10-day hassle-free service guarantee on every job.</p>
              <p>Emergencies happen too. If your bike, scooty or car breaks down on Golf Course Road, stalls near IFFCO Chowk, or refuses to start close to HUDA City Centre, a single call gets a Garage Fix Care mechanic dispatched to your location for on-spot repair or recovery. We also handle battery replacements, tyre punctures, clutch cable adjustments and brake pad changes without any towing required. With over 1,00,000 services completed across Gurugram and Delhi NCR, and a consistent 4.7-star Google rating built on punctuality, honest pricing and professional workmanship, Garage Fix Care is the doorstep vehicle service that Sushant Lok Phase 1 residents trust most. Book your bike, scooty or car service today via our website, WhatsApp or phone — and experience professional vehicle care that arrives at your convenience, starting at just ₹299.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Sushant Lok Phase 1
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Sushant Lok Phase 1&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM, and more — right at your home or office near Galleria Market, HUDA City Centre, or Golf Course Road.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Sushant Lok Phase 1" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to residents of Sushant Lok Phase 1, HUDA City Centre and Golf Course Road — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced in Sushant Lok Phase 1 is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your vehicle running at its best — starting at ₹299 for bike and scooty service, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Sushant Lok Phase 1" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Surendra Singh', img: testimonial1, text: 'Excellent doorstep service at my home in Sushant Lok Phase 1. Professional and knowledgeable mechanic.', time: 'a month ago' },
                { name: 'Dharmendra Gupta', img: testimonial2, text: 'Transparent pricing with video evidence, booked near HUDA City Centre. Very reliable.', time: 'a month ago' },
                { name: 'Rohit Prasad', img: testimonial3, text: 'Great service near Golf Course Road. Convenient, quick and affordable.', time: 'a month ago' },
                { name: 'Prabhjeet Sharma', img: testimonial4, text: 'Quick response near Galleria Market, professional mechanic. Will recommend.', time: 'a month ago' },
              ].map(t => (
        ...
        {/* FAQs (Sushant Lok Phase 1 specific — matches FAQPage schema exactly) */}
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in Sushant Lok Phase 1 — <span className="text-red-600">Common Questions</span>
            </motion.h2>
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike, Scooty or Car Service in Sushant Lok Phase 1 Today
            </h2>
