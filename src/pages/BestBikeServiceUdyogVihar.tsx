// BestBikeServiceUdyogVihar.tsx
// Udyog Vihar specific SEO/content + Delhi Cantt master design system
...
const BestBikeServiceUdyogVihar = () => {
  ...
  // Hot Deals marquee images — Udyog Vihar specific copy/alt text
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Udyog Vihar, Gurugram' },
    { src: hotDealsImage2, alt: 'Doorstep bike service near Cyber City' },
    { src: hotDealsImage3, alt: 'Engine repair near Ambience Mall, Udyog Vihar' },
    { src: hotDealsImage4, alt: 'Roadside vehicle assistance near Dundahera' },
    { src: hotDealsImage5, alt: 'Doorstep vehicle repair near NH-48 and Kapashera Border' },
  ];
  const hotDealsAreaBadges = ['Udyog Vihar', 'Cyber City', 'NH-48', 'Ambience Mall', 'Kapashera Border', 'Dundahera'];
  ...
  const coveredAreas = [
    'Udyog Vihar Phase 1', 'Udyog Vihar Phase 2', 'Udyog Vihar Phase 3',
    'Udyog Vihar Phase 4', 'Udyog Vihar Phase 5', 'Cyber City',
    'Ambience Mall', 'NH-48', 'Kapashera Border', 'Dundahera',
  ];
  ...
  const faqs = [
    {
      q: 'What is the best bike, scooty and car service in Udyog Vihar?',
      a: "Garage Fix Care is Udyog Vihar's trusted doorstep service for bikes, scooties and cars, starting at just ₹299 for bike and scooty service, with certified mechanics, transparent pricing, genuine parts and a 10-day service guarantee.",
    },
    {
      q: 'How much does bike or scooty service cost in Udyog Vihar?',
      a: 'Bike and scooty service in Udyog Vihar starts from ₹299 for 100–125cc vehicles (Regular Service). Classic Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Royal Service (350–450 CC) is ₹599, and Sports Service (above 500 CC) is ₹999. All prices include labour with zero hidden charges.',
    },
    {
      q: 'Do you provide car service in Udyog Vihar too?',
      a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing and repairs in Udyog Vihar and nearby Gurugram areas. Car service is quoted transparently based on your car model and the work required — just book online or call us for a quote.',
    },
    {
      q: 'Do you provide doorstep bike and scooty repair across Udyog Vihar Phase 1 to Phase 5?',
      a: 'Yes, we provide complete doorstep bike and scooty repair across Udyog Vihar Phase 1, Phase 2, Phase 3, Phase 4 and Phase 5. Our certified mechanics arrive with tools, oils and common spare parts — no garage visit needed.',
    },
    {
      q: 'Which areas near Udyog Vihar are covered for bike, scooty and car service?',
      a: 'We cover Udyog Vihar Phase 1, Phase 2, Phase 3, Phase 4, Phase 5, Cyber City, Ambience Mall, NH-48, Kapashera Border and Dundahera for bikes, scooties and cars.',
    },
    {
      q: 'Do you service Royal Enfield and other major bike brands in Udyog Vihar?',
      a: 'Yes. We specialise in Royal Enfield servicing across Udyog Vihar and Cyber City — Classic 350, Bullet 350, Meteor 350, Hunter 350 and Himalayan — and we also handle Hero, Honda, Bajaj, TVS, Suzuki, Yamaha and KTM models at your doorstep.',
    },
    {
      q: 'Can you service vehicles near Cyber City and Ambience Mall?',
      a: 'Yes. Cyber City and Ambience Mall both fall within our doorstep service zone for bikes, scooties and cars. Same-day doorstep service is available subject to location and technician availability — share your address during booking.',
    },
    {
      q: 'Do you handle emergency bike, scooty or car breakdown near NH-48 or Kapashera Border?',
      a: 'Yes. If your bike, scooty or car breaks down near NH-48, Kapashera Border or anywhere in the Udyog Vihar belt, call us immediately and we dispatch a mechanic to your location for on-spot repair or recovery.',
    },
    {
      q: 'Is your bike, scooty and car service pricing transparent in Udyog Vihar?',
    ...
    {
      q: 'Do you offer a warranty on bike, scooty and car service in Udyog Vihar?',
      a: 'Every service by Garage Fix Care in Udyog Vihar includes a 10-day hassle-free service guarantee, whether it is a bike, scooty or car. If any issue arises post-service, we address it at no extra cost.',
    },
    {
      q: 'Do you provide free pickup and drop for service in Udyog Vihar?',
    ...
    {
      q: 'How do I book a bike, scooty or car mechanic near me in Udyog Vihar?',
      a: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Let us know whether it is a bike, scooty or car, share your Udyog Vihar phase or nearby area, and your preferred time slot — we handle the rest.',
    },
  ];
  ...
  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in Udyog Vihar | Doorstep Service Just ₹299"
        description="Garage Fix Care offers doorstep bike, scooty and car service in Udyog Vihar, Gurugram, covering Udyog Vihar Phase 1 to Phase 5, Cyber City, Ambience Mall, NH-48, Kapashera Border and Dundahera, starting at just ₹299. Certified mechanics, transparent pricing and same-day doorstep service."
        ...
        og={{
          ...
          imageAlt: 'Best bike, scooty and car service in Udyog Vihar at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in Udyog Vihar, Cyber City and NH-48',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Udyog Vihar, Gurugram. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299 for bike and scooty service.',
            url: 'https://www.garagefixcare.in/best-bike-service-udyog-vihar',
            ...
            address: {
              '@type': 'PostalAddress',
              addressLocality: 'Udyog Vihar, Gurugram',
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Best Bike, Scooty and Car Service in Udyog Vihar', item: 'https://www.garagefixcare.in/best-bike-service-udyog-vihar' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Udyog Vihar specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in Udyog Vihar
                ...
                >
                  Trusted by residents and professionals across Udyog Vihar Phase 1 to Phase 5, Cyber City, Ambience Mall, NH-48, Kapashera Border and Dundahera — our certified mechanics handle bikes, scooties and cars right at your doorstep.
                </motion.p>
              </motion.div>
        ...
        {/* Dark premium information strip — Udyog Vihar specific copy */}
        <motion.div
          className="w-full"
          style={{
        ...
        {/* Hot Deals This Week — Udyog Vihar specific copy, Delhi Cantt-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Limited-time offer for Udyog Vihar, Cyber City and NH-48 customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-white/70 max-w-xl mx-auto">Service support for leading two-wheeler brands across Udyog Vihar and Gurugram.</p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Udyog Vihar pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service in Udyog Vihar and nearby Gurugram areas, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Areas Covered — Udyog Vihar localities */}
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              We Cover All Major Areas in <span className="text-red-600">Udyog Vihar</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you are based in Udyog Vihar Phase 1, Phase 2, Phase 3, Phase 4 or Phase 5, working near Cyber City or Ambience Mall, commuting along NH-48 towards Kapashera Border, or staying in Dundahera, our bike, scooty and car mechanics reach your doorstep. Same-day doorstep service is available across the Udyog Vihar belt subject to location and technician availability, starting at ₹299 for bike and scooty service.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Bike, Scooty &amp; Car Care, <span className="text-red-600">Right at Your Door in Udyog Vihar</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Udyog Vihar mechanics handle bikes, scooties and cars at your location, starting at ₹299 for bike and scooty service. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              {bikeServiceCards.map((service, index) => (
                ...
                >
                  <img
                    src={service.img}
                    alt={`${service.name} in Udyog Vihar`}
        ...
        {/* Comprehensive SEO Content (Udyog Vihar specific) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in Udyog Vihar</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>Udyog Vihar is Gurugram&apos;s industrial and corporate heart, spanning Phase 1 through Phase 5 and bordered by the towering office towers of Cyber City, the shopping and hospitality corridor around Ambience Mall, and the NH-48 expressway that feeds traffic towards Kapashera Border and Dundahera. Vehicle owners in this part of the city deserve a bike, scooty and car service that keeps pace with the area&apos;s fast-moving professional rhythm — reliable, transparent and delivered right at the doorstep. Garage Fix Care is Udyog Vihar&apos;s trusted doorstep vehicle service, bringing certified and background-verified mechanics directly to your office, PG or home, whether you work out of a corporate campus in Phase 2, commute daily along NH-48, or live in one of the residential pockets near Dundahera. Our mechanics typically reach your location within 2–4 hours of booking, subject to availability. Doorstep bike and scooty service starts at just ₹299 — covering all essential checks including engine oil change, air filter cleaning, spark plug inspection, brake adjustment and basic electrical check — with every task completed on the spot, without you needing to step out of your workplace. We also handle car servicing and repairs at your doorstep, with pricing quoted based on your car&apos;s model and requirement. We service every major two-wheeler brand seen across the Udyog Vihar belt: Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM and more, from daily commuters and family scooties like the Honda Activa, TVS Jupiter and Suzuki Access, to premium machines like the Royal Enfield Classic 350 and KTM Duke 390, alongside popular hatchbacks and sedans. What distinguishes us as the best bike, scooty and car service in Udyog Vihar is our strict pricing transparency — you receive a full itemised estimate before a single tool is touched, ensuring zero hidden charges at the end. We use only genuine engine oils from Motul and Wurth, paired with manufacturer-approved spare parts, and each service is backed by our 10-day hassle-free service guarantee.</p>
              <p>The stop-start traffic along NH-48, congestion near Kapashera Border and the constant movement inside Udyog Vihar&apos;s industrial lanes accelerate wear on engine oil, air filters, tyres and brakes far faster than the service manual suggests — making regular servicing a genuine safety necessity for bikes, scooties and cars alike. Our mechanics carry professional diagnostic tools to identify emerging issues before they become expensive failures, significantly extending your vehicle&apos;s lifespan whether you commute daily between Udyog Vihar and Cyber City, or just occasionally ride into Ambience Mall. We also handle emergency breakdown situations across Udyog Vihar — if your bike, scooty or car stops near NH-48 or anywhere on the way to Dundahera, call us and we dispatch a mechanic to your exact location as soon as possible. From battery replacement and brake pad changes to clutch cable adjustment and tyre puncture repair, our technicians fix it all on the spot without towing. Garage Fix Care has completed over 1,00,000 services across Gurugram and Delhi NCR, earning a consistent 4.7-star Google rating for professionalism, punctuality and honest pricing. Book your bike, scooty or car service in Udyog Vihar Phase 1 to Phase 5, Cyber City, Ambience Mall, NH-48, Kapashera Border or Dundahera today via our website, WhatsApp or direct call — and discover the convenience of professional doorstep vehicle care starting at just ₹299 for bike and scooty service.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Udyog Vihar
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Udyog Vihar&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM and more — right at your office or home near Cyber City and Ambience Mall.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Udyog Vihar" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to professionals and residents of Udyog Vihar, Cyber City, NH-48 and Dundahera — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced in Udyog Vihar is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your vehicle running at its best — starting at ₹299 for bike and scooty service, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Udyog Vihar" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Karan Mehta', img: testimonial1, text: 'Doorstep service at my Udyog Vihar Phase 2 office was super quick.', time: 'a month ago' },
                { name: 'Neha Bhatia', img: testimonial2, text: 'Transparent billing with video evidence, booked near Cyber City. Very reliable.', time: 'a month ago' },
                { name: 'Sandeep Yadav', img: testimonial3, text: 'Great service near Ambience Mall, convenient and affordable.', time: 'a month ago' },
                { name: 'Ritika Sharma', img: testimonial4, text: 'Fast response near NH-48, professional mechanic. Will recommend.', time: 'a month ago' },
              ].map(t => (
        ...
        {/* FAQs (Udyog Vihar specific — matches FAQPage schema exactly) */}
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in Udyog Vihar — <span className="text-red-600">Common Questions</span>
            </motion.h2>
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike, Scooty or Car Service in Udyog Vihar Today
            </h2>
            <p className="text-sm sm:text-base text-white mb-3 sm:mb-5 max-w-xl mx-auto">
              Same-day doorstep service across Udyog Vihar and nearby Gurugram areas starting at ₹299. Our mechanic comes to you — no travel, no waiting, no hidden charges.
            </p>
            <a
              href="https://www.garagefixcare.in/bookservice"
