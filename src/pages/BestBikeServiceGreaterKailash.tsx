// BestBikeServiceGreaterKailash.tsx
// Greater Kailash specific SEO/content + Home.tsx design system (video hero, Framer Motion, marquees)
...
const BestBikeServiceGreaterKailash = () => {
  ...
  // Hot Deals marquee images — Greater Kailash specific copy/alt text, Home-style assets
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Greater Kailash' },
    { src: hotDealsImage2, alt: 'Doorstep bike service near GK-1' },
    { src: hotDealsImage3, alt: 'Bike engine repair near Kailash Colony' },
    { src: hotDealsImage4, alt: 'Roadside bike assistance near CR Park' },
    { src: hotDealsImage5, alt: 'Doorstep bike repair deal near Nehru Place' },
  ];
  const hotDealsAreaBadges = ['Greater Kailash', 'GK-1', 'GK-2', 'Kailash Colony', 'CR Park', 'Nehru Place'];
  ...
  const servicePrices = [
    ...
    { title: 'At-Home Sports Service', subtitle: 'Above 500 CC', originalPrice: 'Rs. 2,199', discountedPrice: 'Rs. 550', features: ['Engine Oil Change', 'Oil Filter Clean', 'Air Filter Clean', 'Spark Plug Clean'] },
  ];
  ...
  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in Greater Kailash | Doorstep Service Just ₹299 | Garage Fix Care"
        description="Garage Fix Care offers doorstep bike, scooty and car service in Greater Kailash, GK-1, GK-2, Kailash Colony, CR Park and Nehru Place, starting at just ₹299. Certified mechanics, same-day service at your home."
        ...
        og={{
          ...
          imageAlt: 'Best bike, scooty and car service in Greater Kailash at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in Greater Kailash, GK-1, GK-2 and Nehru Place',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Greater Kailash. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299.',
            url: 'https://www.garagefixcare.in/best-bike-service-greater-kailash',
            ...
            address: {
              '@type': 'PostalAddress',
              addressLocality: 'Greater Kailash, New Delhi',
              addressRegion: 'Delhi',
              addressCountry: 'IN',
            },
            geo: { '@type': 'GeoCoordinates', latitude: '28.5487', longitude: '77.2411' },
            areaServed: [
              { '@type': 'Place', name: 'Greater Kailash 1 (GK-1)' },
              { '@type': 'Place', name: 'Greater Kailash 2 (GK-2)' },
              { '@type': 'Place', name: 'M Block Market' },
              { '@type': 'Place', name: 'N Block Market' },
              { '@type': 'Place', name: 'Kailash Colony' },
              { '@type': 'Place', name: 'Nehru Place' },
              { '@type': 'Place', name: 'Chittaranjan Park (CR Park)' },
              { '@type': 'Place', name: 'Alaknanda' },
              { '@type': 'Place', name: 'East of Kailash' },
              { '@type': 'Place', name: 'Kalkaji' },
              { '@type': 'Place', name: 'Lotus Temple' },
            ],
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Doorstep Bike, Scooty and Car Service in Greater Kailash',
            provider: { '@type': 'LocalBusiness', name: 'Garage Fix Care' },
            areaServed: 'Greater Kailash, New Delhi',
            description: 'At-home bike, scooty and car servicing starting at ₹299 across Greater Kailash, GK-1, GK-2, Kailash Colony, CR Park, Nehru Place, Alaknanda, East of Kailash, Kalkaji and Lotus Temple. Oil change, engine repair, battery replacement, puncture fix and car maintenance — same-day doorstep service.',
          ...
          },
          {
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'What is the best bike, scooty and car service in Greater Kailash?', acceptedAnswer: { '@type': 'Answer', text: 'Garage Fix Care is Greater Kailash\'s trusted doorstep service for bikes, scooties and cars, starting at just ₹299, with certified mechanics and transparent pricing.' } },
              { '@type': 'Question', name: 'How much does bike, scooty or car service cost in Greater Kailash?', acceptedAnswer: { '@type': 'Answer', text: 'Bike and scooty service in Greater Kailash starts from ₹299 for 100–125cc vehicles. Classic Service is ₹399, Premium ₹499, Royal ₹599, and Sports ₹999. Car service pricing is quoted based on your car model and requirement. All prices include labour with no hidden charges.' } },
              { '@type': 'Question', name: 'Do you provide doorstep bike, scooty and car repair in GK-1 and GK-2?', acceptedAnswer: { '@type': 'Answer', text: 'Yes, we provide complete doorstep repair for bikes, scooties and cars across GK-1 and GK-2. Certified mechanics come to your home fully equipped — no garage visit needed.' } },
              { '@type': 'Question', name: 'Which areas near Greater Kailash are covered?', acceptedAnswer: { '@type': 'Answer', text: 'We cover Greater Kailash 1 and 2, M Block, N Block, Kailash Colony, Nehru Place, Chittaranjan Park, Alaknanda, East of Kailash, Kalkaji and Lotus Temple for bike, scooty and car service.' } },
              { '@type': 'Question', name: 'Do you handle emergency bike, scooty or car breakdown near Nehru Place or CR Park?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. If your bike, scooty or car breaks down anywhere near Nehru Place or CR Park, call us immediately and we dispatch a mechanic to your location for on-spot repair or recovery.' } },
            ],
          },
          {
            '@context': 'https://schema.org',
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Best Bike, Scooty and Car Service in Greater Kailash', item: 'https://www.garagefixcare.in/best-bike-service-greater-kailash' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Greater Kailash specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in Greater Kailash
                ...
                {/* The extra paragraph has been removed */}
              </motion.div>
        ...
        {/* Dark premium information strip — Greater Kailash specific copy */}
        <motion.div
          className="w-full"
          style={{
        ...
        {/* Hot Deals This Week — Greater Kailash specific copy, Home-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Exclusive savings for Greater Kailash customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Greater Kailash pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service near Greater Kailash, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Areas Covered — Greater Kailash localities */}
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              We Cover All Major Areas in <span className="text-red-600">Greater Kailash</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you live in GK-1, GK-2, M Block, N Block, Kailash Colony, near Nehru Place, in CR Park, Alaknanda, East of Kailash, Kalkaji, or close to Lotus Temple, our bike, scooty and car mechanics reach your doorstep within 2-4 hours. Same-day doorstep service available across the Greater Kailash belt, starting at ₹299.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Greater Kailash mechanics handle bikes, scooties and cars at your location, starting at ₹299. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              {bikeServiceCards.map((service, index) => (
                ...
                >
                  <img
                    src={service.img}
                    alt={`${service.name} in Greater Kailash`}
        ...
        {/* Comprehensive Vehicle Service Content (Greater Kailash specific, 1000+ words) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in Greater Kailash</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>Greater Kailash — one of South Delhi's most sought-after residential and commercial hubs — spans across GK-1, GK-2, and connects seamlessly to Kailash Colony, Nehru Place, Chittaranjan Park, Alaknanda, East of Kailash, and Kalkaji. This vibrant area is home to thousands of professionals, families, and business owners who rely on their bikes, scooties, and cars for daily commutes to Nehru Place's IT hub, school runs around CR Park, shopping trips to M Block and N Block markets, and weekend outings to the Lotus Temple and nearby recreational spots. Despite the area's affluence and connectivity, finding a punctual, honest, and technically skilled vehicle mechanic has remained surprisingly difficult. Garage Fix Care fills that gap entirely. We send certified, background-verified mechanics directly to your home, society parking, or office block across every corner of Greater Kailash — from the tree-lined streets of GK-1 and GK-2 to the busy commercial stretches near Nehru Place and the Bengali community hub of CR Park. Doorstep bike and scooty service in Greater Kailash starts at just ₹299 — covering all essential checks including engine oil change, air filter cleaning, spark plug inspection, brake adjustment, and basic electrical check — with every task completed on the spot without you needing to ride to a workshop. We also handle car servicing and repairs at your doorstep, with pricing quoted based on your car&apos;s model and the required work. We service every major vehicle brand seen across South Delhi: Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM, and more, handling everything from daily commuters and premium sports bikes to family scooties like the Honda Activa, TVS Jupiter, and Suzuki Access, alongside popular hatchbacks and sedans. What distinguishes us as the best bike, scooty and car service in Greater Kailash is our strict pricing transparency — you receive a full itemised estimate before a single tool is touched, ensuring zero hidden charges at the end. We use only genuine engine oils from Motul and Wurth, paired with manufacturer-approved spare parts, and each service is backed by our 10-day hassle-free service guarantee.</p>
              <p>The traffic density around Nehru Place, the constant stop-and-go on Outer Ring Road, and the narrow lanes of GK-1 and GK-2 accelerate wear on engine oil, air filters, tyres, and brakes — making regular servicing not just a good habit but a safety necessity for bikes, scooties and cars alike. Our mechanics carry professional diagnostic tools to identify emerging issues before they become expensive failures, significantly extending your vehicle&apos;s lifespan whether you commute daily through Alaknanda or just within the colony. We also handle emergency breakdown situations across Greater Kailash — if your bike, scooty or car stops near M Block, Nehru Place, or anywhere else in the area, call us and we dispatch a mechanic to your exact location immediately. From battery replacement and brake pad changes to clutch cable adjustment and tyre puncture repair, our technicians fix it all on the spot. Garage Fix Care has completed over 1,00,000 services across Delhi NCR, earning a consistent 4.7-star Google rating for professionalism, punctuality, and honest pricing. Book your bike, scooty or car service in Greater Kailash, GK-1, GK-2, M Block, N Block, Kailash Colony, Nehru Place, CR Park, Alaknanda, East of Kailash, Kalkaji, or Lotus Temple today via our website, WhatsApp, or direct call — and discover the convenience of professional doorstep vehicle care starting at just ₹299.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Greater Kailash
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Greater Kailash&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM, and more — right at your home or office near Nehru Place and CR Park.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Greater Kailash" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to residents of Greater Kailash, GK-1, GK-2, Kailash Colony, and CR Park — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced near Greater Kailash is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your vehicle running at its best — starting at ₹299, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Greater Kailash" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Vikram Bisht', img: testimonial1, text: 'Doorstep service near GK-1 was fast and professional.', time: 'a month ago' },
                { name: 'Pooja Rathi', img: testimonial2, text: 'Transparent billing with video evidence, booked from CR Park. Very reliable.', time: 'a month ago' },
                { name: 'Ravinder Negi', img: testimonial3, text: 'Great service near Nehru Place, convenient and affordable.', time: 'a month ago' },
                { name: 'Pradeep Singh', img: testimonial4, text: 'Quick response near Kailash Colony, professional mechanic. Will recommend.', time: 'a month ago' },
              ].map(t => (
        ...
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in Greater Kailash — <span className="text-red-600">Common Questions</span>
            </motion.h2>
            <motion.div className="space-y-3" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              {[
                { q: 'What is the best bike, scooty and car service in Greater Kailash?', a: 'Garage Fix Care is Greater Kailash\'s highest-rated doorstep service for bikes, scooties and cars, starting at ₹299 with certified mechanics, transparent pricing, genuine parts, and a 10-day service guarantee.' },
                { q: 'How much does bike or scooty service cost in Greater Kailash?', a: 'Bike and scooty service in Greater Kailash at Garage Fix Care starts from ₹299 for 100–125cc vehicles (Regular Service). Classic Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Royal Service (350–450 CC) is ₹599, and Sports Service (above 500 CC) is ₹999. All prices include labour with zero hidden charges.' },
                { q: 'Do you provide car service in Greater Kailash too?', a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing in Greater Kailash and nearby areas. Car service pricing is quoted based on your car\'s model and the work required — just book online or call us for a quote.' },
                { q: 'Do you provide doorstep bike and scooty repair in GK-1 and GK-2?', a: 'Yes, we provide complete doorstep bike and scooty repair across GK-1 and GK-2. Our certified mechanics arrive with all tools, oils, and parts — no garage visit needed.' },
                { q: 'Which areas near Greater Kailash are covered for bike, scooty and car service?', a: 'We cover Greater Kailash 1 and 2, M Block Market, N Block Market, Kailash Colony, Nehru Place, Chittaranjan Park, Alaknanda, East of Kailash, Kalkaji and Lotus Temple.' },
                { q: 'Do you service Royal Enfield bikes near Greater Kailash?', a: 'Yes. We specialise in Royal Enfield servicing across Greater Kailash and surrounding areas — Classic 350, Bullet 350, Meteor 350, Himalayan, and Thunderbird — all serviced at your doorstep.' },
                { q: 'How quickly can a mechanic reach me in Greater Kailash?', a: 'Our mechanics typically reach your location in Greater Kailash, Kailash Colony, or near Nehru Place within 2–4 hours of booking, for bikes, scooties and cars alike. For urgent requests, call us and we will prioritise your slot.' },
                { q: 'Is your bike, scooty and car service pricing transparent in Greater Kailash?', a: 'Absolutely. We provide a full itemised cost estimate before starting any work, whether it\'s a bike, scooty or car. No surprise bills — what you see is exactly what you pay.' },
                { q: 'Do you service scooties near M Block and N Block markets?', a: 'Yes. We repair and service all scooties near M Block and N Block markets — Honda Activa, TVS Jupiter, Suzuki Access 125, Honda Dio, Hero Maestro — all at your doorstep.' },
                { q: 'Do you offer a warranty on bike, scooty and car service in Greater Kailash?', a: 'Every service by Garage Fix Care in Greater Kailash includes a 10-day hassle-free service guarantee, whether it\'s a bike, scooty or car. If any issue arises post-service, we address it at no extra cost.' },
                { q: 'How do I book a bike, scooty or car mechanic near me in Greater Kailash?', a: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Let us know whether it\'s a bike, scooty or car, share your area near Greater Kailash and preferred time slot — we handle the rest.' },
                { q: 'What payment methods are accepted in Greater Kailash?', a: 'We accept cash, UPI (Google Pay, PhonePe, Paytm), and all major mobile wallets. Payment is collected only after the service is complete.' },
                { q: 'Do I need to arrange any tools or oils?', a: 'No. Our Greater Kailash mechanics arrive fully equipped — tools, genuine Motul/Wurth engine oils, and all required spare parts are brought to your doorstep, for bikes, scooties and cars.' },
                { q: 'Can I book service for multiple bikes or vehicles in CR Park or Alaknanda?', a: 'Yes, simply mention the number and type of vehicles while booking and we will arrange the right team for your location in CR Park or Alaknanda.' },
                { q: 'Do you handle emergency bike, scooty or car breakdown near Nehru Place or Kailash Colony?', a: 'Yes. If your bike, scooty or car breaks down anywhere near Nehru Place or Kailash Colony, call us immediately and we dispatch a mechanic to your location.' },
                { q: 'What makes Garage Fix Care better than a local Greater Kailash workshop?', a: 'We come to you for bikes, scooties and cars, save your travel time, offer transparent itemised billing, use genuine parts, and provide a 10-day warranty — something most local Greater Kailash workshops cannot match.' },
              ].map((faq, idx) => (
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike, Scooty or Car Service in Greater Kailash Today
            </h2>
