// BestBikeServiceNewFriendsColony.tsx
// New Friends Colony specific SEO/content + Delhi Cantt master design system
...
const BestBikeServiceNewFriendsColony = () => {
  ...
  // Hot Deals marquee images — New Friends Colony specific copy/alt text
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in New Friends Colony, Delhi' },
    { src: hotDealsImage2, alt: 'Doorstep scooty service near Friends Colony East' },
    { src: hotDealsImage3, alt: 'Car engine repair near Maharani Bagh' },
    { src: hotDealsImage4, alt: 'Roadside vehicle assistance near Ashram Chowk' },
    { src: hotDealsImage5, alt: 'Doorstep vehicle repair deal near Okhla' },
  ];
  const hotDealsAreaBadges = ['New Friends Colony', 'Friends Colony East', 'Maharani Bagh', 'Ashram', 'Okhla', 'Jamia Nagar'];
  ...
  const serviceCities = [
    { name: 'New Friends Colony', color: 'text-indigo-700' },
    { name: 'Friends Colony East', color: 'text-red-700' },
    { name: 'Maharani Bagh', color: 'text-teal-700' },
    { name: 'Ashram', color: 'text-gray-900' },
    { name: 'Okhla', color: 'text-orange-700' },
    { name: 'Jamia Nagar', color: 'text-slate-700' },
  ];

  const coveredAreas = [
    'New Friends Colony', 'Friends Colony East', 'Friends Colony West', 'Bharat Nagar',
    'Maharani Bagh', 'Ishwar Nagar', 'Sukhdev Vihar', 'Okhla',
    'Okhla Vihar', 'Jamia Nagar', 'Jasola', 'Sarita Vihar',
    'Kalindi Colony', 'Ashram', 'Ashram Chowk', 'East of Kailash',
    'Greater Kailash', 'Lajpat Nagar', 'Jangpura', 'Srinivaspuri',
    'Govindpuri', 'Kalkaji',
  ];
  ...
  const faqs = [
    {
      q: 'What is the best bike, scooty and car service in New Friends Colony?',
      a: "Garage Fix Care is New Friends Colony's trusted doorstep service for bikes, scooties and cars, starting at just ₹299 for bike and scooty service, with certified mechanics, transparent pricing, genuine parts and a 10-day service guarantee.",
    },
    {
      q: 'How much does bike or scooty service cost in New Friends Colony?',
      a: 'Bike and scooty service in New Friends Colony starts from ₹299 for 100–125cc vehicles (Regular Service). Classic Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Royal Service (350–450 CC) is ₹599, and Sports Service (above 500 CC) is ₹999. All prices include labour with zero hidden charges.',
    },
    {
      q: 'Do you provide car service in New Friends Colony too?',
      a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing and repairs in New Friends Colony and nearby areas. Car service is quoted transparently based on your car model and the work required — just book online or call us for a quote.',
    },
    {
      q: 'Which areas near New Friends Colony are covered for doorstep service?',
      a: 'We cover New Friends Colony, Friends Colony East, Friends Colony West, Bharat Nagar, Maharani Bagh, Ishwar Nagar, Sukhdev Vihar, Okhla, Okhla Vihar, Jamia Nagar, Jasola, Sarita Vihar, Kalindi Colony, Ashram, Ashram Chowk, East of Kailash, Greater Kailash, Lajpat Nagar, Jangpura, Srinivaspuri, Govindpuri and Kalkaji.',
    },
    {
      q: 'Do you provide doorstep service in New Friends Colony societies and apartments?',
      a: 'Yes. Our mechanics regularly service vehicles inside residential societies and apartment complexes across New Friends Colony, including the areas near Friends Colony East and West. Share your society name and gate number while booking — we come directly to your parking bay.',
    },
    {
      q: 'Do you handle emergency breakdown near Ashram Chowk or Okhla?',
      a: 'Yes. If your bike, scooty or car breaks down near Ashram Chowk, Ashram, Okhla, or anywhere in the New Friends Colony district, call us immediately and we dispatch a mechanic to your location.',
    },
    {
      q: 'Do you provide doorstep vehicle service in Maharani Bagh and Sukhdev Vihar?',
      a: 'Yes. Maharani Bagh and Sukhdev Vihar both fall within our doorstep service zone for bikes, scooties and cars. Same-day doorstep service is available subject to location and technician availability.',
    },
    {
      q: 'Do you service Royal Enfield and other major bike brands in New Friends Colony?',
      a: 'Yes. We specialise in Royal Enfield servicing across New Friends Colony — Classic 350, Bullet 350, Meteor 350, Hunter 350 and Himalayan — and we also handle Hero, Honda, Bajaj, TVS, Suzuki, Yamaha and KTM models at your doorstep.',
    },
    {
      q: 'Is your bike, scooty and car service pricing transparent in New Friends Colony?',
    ...
    {
      q: 'Do you offer a warranty on bike, scooty and car service in New Friends Colony?',
      a: 'Every service by Garage Fix Care in New Friends Colony includes a 10-day hassle-free service guarantee, whether it is a bike, scooty or car. If any issue arises post-service, we address it at no extra cost.',
    },
    {
      q: 'Do you provide free pickup and drop for service in New Friends Colony?',
    ...
    {
      q: 'How do I book a bike, scooty or car mechanic near me in New Friends Colony?',
      a: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Let us know whether it is a bike, scooty or car, share your area near New Friends Colony and your preferred time slot — we handle the rest.',
    },
  ];
  ...
  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in New Friends Colony | Doorstep Service Just ₹299"
        description="Garage Fix Care offers doorstep bike, scooty and car service in New Friends Colony, Delhi, covering Friends Colony East, Friends Colony West, Bharat Nagar, Maharani Bagh, Ishwar Nagar, Sukhdev Vihar, Okhla, Jamia Nagar, Jasola, Sarita Vihar, Ashram, East of Kailash, Greater Kailash, Lajpat Nagar, Jangpura and Kalkaji, starting at just ₹299. Certified mechanics, transparent pricing and same-day doorstep service."
        canonical="https://www.garagefixcare.in/best-bike-service-new-friends-colony"
        robots="index, follow"
        og={{
          url: 'https://www.garagefixcare.in/best-bike-service-new-friends-colony',
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Best bike, scooty and car service in New Friends Colony at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in New Friends Colony, Maharani Bagh and Okhla',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in New Friends Colony, Delhi. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299 for bike and scooty service.',
            url: 'https://www.garagefixcare.in/best-bike-service-new-friends-colony',
            ...
            address: {
              '@type': 'PostalAddress',
              addressLocality: 'New Friends Colony, New Delhi',
              addressRegion: 'Delhi',
              addressCountry: 'IN',
            },
            geo: { '@type': 'GeoCoordinates', latitude: '28.5645', longitude: '77.2650' },
            areaServed: [
              { '@type': 'Place', name: 'New Friends Colony' },
              { '@type': 'Place', name: 'Friends Colony East' },
              { '@type': 'Place', name: 'Friends Colony West' },
              { '@type': 'Place', name: 'Bharat Nagar' },
              { '@type': 'Place', name: 'Maharani Bagh' },
              { '@type': 'Place', name: 'Ishwar Nagar' },
              { '@type': 'Place', name: 'Sukhdev Vihar' },
              { '@type': 'Place', name: 'Okhla' },
              { '@type': 'Place', name: 'Okhla Vihar' },
              { '@type': 'Place', name: 'Jamia Nagar' },
              { '@type': 'Place', name: 'Jasola' },
              { '@type': 'Place', name: 'Sarita Vihar' },
              { '@type': 'Place', name: 'Kalindi Colony' },
              { '@type': 'Place', name: 'Ashram' },
              { '@type': 'Place', name: 'East of Kailash' },
              { '@type': 'Place', name: 'Greater Kailash' },
              { '@type': 'Place', name: 'Lajpat Nagar' },
              { '@type': 'Place', name: 'Jangpura' },
              { '@type': 'Place', name: 'Srinivaspuri' },
              { '@type': 'Place', name: 'Govindpuri' },
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Doorstep Bike, Scooty and Car Service in New Friends Colony',
            provider: { '@type': 'LocalBusiness', name: 'Garage Fix Care' },
            areaServed: 'New Friends Colony, New Delhi',
            description: 'At-home bike, scooty and car servicing across New Friends Colony and nearby South-East Delhi areas including Friends Colony East, Friends Colony West, Bharat Nagar, Maharani Bagh, Ishwar Nagar, Sukhdev Vihar, Okhla, Okhla Vihar, Jamia Nagar, Jasola, Sarita Vihar, Kalindi Colony, Ashram, Ashram Chowk, East of Kailash, Greater Kailash, Lajpat Nagar, Jangpura, Srinivaspuri, Govindpuri and Kalkaji. Bike and scooty service starts at ₹299, covering oil change, engine repair, battery replacement, brake repair, tyre service and puncture fix. Car service is quote-based and depends on the car model and work required — same-day doorstep service subject to availability.',
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Best Bike, Scooty and Car Service in New Friends Colony', item: 'https://www.garagefixcare.in/best-bike-service-new-friends-colony' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (New Friends Colony specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in New Friends Colony
                ...
                >
                  Trusted by residents across New Friends Colony, Friends Colony East, Friends Colony West, Maharani Bagh, Sukhdev Vihar, Okhla, Jamia Nagar, Ashram and East of Kailash — our certified mechanics handle bikes, scooties and cars right at your doorstep.
                </motion.p>
              </motion.div>
        ...
        {/* Dark premium information strip — New Friends Colony specific copy */}
        <motion.div
          className="w-full"
          style={{
          ...
          <div className="max-w-[1100px] mx-auto px-[14px] py-[10px] sm:px-6 sm:py-3.5 relative overflow-hidden">
            ...
            <span className="relative inline-flex items-center gap-1.5 mb-1">
              ...
              <span className="text-[8px] sm:text-[9px] font-semibold uppercase tracking-wider" style={{ color: '#ff7a00' }}>
                Garage Fix Care — New Friends Colony
              </span>
            </span>
            <p className="relative text-[10px] sm:text-sm leading-[1.4] sm:leading-relaxed" style={{ color: '#cbd5e1' }}>
              Skip the garage queue. Our certified mechanics come to your home, society parking or office across New Friends Colony, Friends Colony East, Friends Colony West, Bharat Nagar, Maharani Bagh, Ishwar Nagar, Sukhdev Vihar, Okhla, Okhla Vihar, Jamia Nagar, Jasola, Sarita Vihar, Kalindi Colony, Ashram, East of Kailash, Greater Kailash, Lajpat Nagar, Jangpura, Srinivaspuri, Govindpuri and Kalkaji — servicing bikes, scooties and cars, from routine maintenance to engine repairs, starting at ₹299 for bike and scooty service. Fast, transparent, and affordable.
            </p>
          </div>
        </motion.div>
        ...
        {/* Hot Deals This Week — New Friends Colony specific copy, Delhi Cantt-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Limited-time offer for New Friends Colony, Maharani Bagh and Okhla customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-white/70 max-w-xl mx-auto">Service support for leading two-wheeler brands across New Friends Colony and Delhi.</p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — New Friends Colony pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service in New Friends Colony and nearby South-East Delhi areas, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Areas Covered — New Friends Colony localities */}
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              We Cover All Major Areas in <span className="text-red-600">New Friends Colony</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you live in New Friends Colony, Friends Colony East, Friends Colony West, Bharat Nagar, Maharani Bagh, Ishwar Nagar, Sukhdev Vihar, Okhla, Okhla Vihar, Jamia Nagar, Jasola, Sarita Vihar, Kalindi Colony, Ashram, Ashram Chowk, East of Kailash, Greater Kailash, Lajpat Nagar, Jangpura, Srinivaspuri, Govindpuri or Kalkaji, our bike, scooty and car mechanics reach your doorstep. Same-day doorstep service is available across the New Friends Colony belt, subject to location and technician availability, starting at ₹299 for bike and scooty service.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Bike, Scooty &amp; Car Care, <span className="text-red-600">Right at Your Door in New Friends Colony</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our New Friends Colony mechanics handle bikes, scooties and cars at your location, starting at ₹299 for bike and scooty service. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              {bikeServiceCards.map((service, index) => (
                ...
                >
                  <img
                    src={service.img}
                    alt={`${service.name} in New Friends Colony`}
        ...
        {/* Comprehensive SEO Content (New Friends Colony specific) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in New Friends Colony</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>New Friends Colony is one of South-East Delhi&apos;s most well-established residential neighbourhoods, split into the upscale Friends Colony East and Friends Colony West sections and bordered by Maharani Bagh, Sukhdev Vihar, Okhla and Jamia Nagar, with direct access to the Ashram Chowk and Kalindi Kunj corridors. Thousands of two-wheeler and car owners here depend on their vehicles for daily office commutes, school drops, and trips to the markets around Bharat Nagar and Ishwar Nagar. Garage Fix Care is New Friends Colony&apos;s trusted doorstep vehicle service, bringing certified and background-verified mechanics directly to your home, society parking or office, whether you live near the New Friends Colony Community Centre, close to Kalindi Colony, or in the quieter lanes of Friends Colony West. Our mechanics typically reach your location within 2–4 hours of booking, subject to availability. Doorstep bike and scooty service starts at just ₹299 — covering all essential checks including engine oil change, air filter cleaning, spark plug inspection, brake adjustment and basic electrical check — with every task completed on the spot. We also handle car servicing and repairs at your doorstep, with pricing quoted based on your car&apos;s model and requirement. We service every major two-wheeler brand seen across New Friends Colony: Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM and more, from daily commuters and family scooties like the Honda Activa, TVS Jupiter and Suzuki Access, to premium machines like the Royal Enfield Classic 350 and KTM Duke 390, alongside popular hatchbacks and sedans. What distinguishes us as the best bike, scooty and car service in New Friends Colony is our strict pricing transparency — you receive a full itemised estimate before a single tool is touched, ensuring zero hidden charges at the end. We use only genuine engine oils from Motul and Wurth, paired with manufacturer-approved spare parts, and each service is backed by our 10-day hassle-free service guarantee.</p>
              <p>New Friends Colony&apos;s dense residential layout, the morning rush around Ashram Chowk and the busy flow towards Okhla and Jasola all accelerate wear on engine oil, air filters, tyres and brakes — making regular servicing a genuine safety necessity for bikes, scooties and cars alike. Our mechanics carry professional diagnostic tools to identify emerging issues before they become expensive failures, significantly extending your vehicle&apos;s lifespan whether you commute daily towards Lajpat Nagar or just ride around the neighbourhood. We also handle emergency breakdown situations across New Friends Colony — if your bike, scooty or car stops near Ashram Chowk, Kalindi Colony or anywhere on the way to Sarita Vihar, call us and we dispatch a mechanic to your exact location as soon as possible. From battery replacement and brake pad changes to clutch cable adjustment and tyre puncture repair, our technicians fix it all on the spot without towing. Garage Fix Care has completed over 1,00,000 services across Delhi NCR, earning a consistent 4.7-star Google rating for professionalism, punctuality and honest pricing. Book your bike, scooty or car service in New Friends Colony, Friends Colony East, Friends Colony West, Bharat Nagar, Maharani Bagh, Ishwar Nagar, Sukhdev Vihar, Okhla, Okhla Vihar, Jamia Nagar, Jasola, Sarita Vihar, Kalindi Colony, Ashram, Ashram Chowk, East of Kailash, Greater Kailash, Lajpat Nagar, Jangpura, Srinivaspuri, Govindpuri or Kalkaji today via our website, WhatsApp or direct call — and discover the convenience of professional doorstep vehicle care starting at just ₹299 for bike and scooty service.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in New Friends Colony
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                New Friends Colony&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM and more — right at your home or society parking near Friends Colony East and Maharani Bagh.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in New Friends Colony" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to residents across New Friends Colony, Friends Colony East, Friends Colony West, Maharani Bagh, Sukhdev Vihar and Okhla — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced in New Friends Colony is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your vehicle running at its best — starting at ₹299 for bike and scooty service, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in New Friends Colony" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Vikram Bisht', img: testimonial1, text: 'Doorstep service in Friends Colony East was fast and professional.', time: 'a month ago' },
                { name: 'Pooja Rathi', img: testimonial2, text: 'Transparent billing with video evidence, booked from Maharani Bagh. Very reliable.', time: 'a month ago' },
                { name: 'Ravinder Negi', img: testimonial3, text: 'Great service near Ashram Chowk, convenient and affordable.', time: 'a month ago' },
                { name: 'Simran Kaur', img: testimonial4, text: 'Quick response near Okhla, professional mechanic. Will recommend.', time: 'a month ago' },
              ].map(t => (
        ...
        {/* FAQs (New Friends Colony specific — matches FAQPage schema exactly) */}
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in New Friends Colony — <span className="text-red-600">Common Questions</span>
            </motion.h2>
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike, Scooty or Car Service in New Friends Colony Today
            </h2>
            <p className="text-sm sm:text-base text-white mb-3 sm:mb-5 max-w-xl mx-auto">
              Same-day doorstep service across New Friends Colony and nearby areas starting at ₹299. Our mechanic comes to you — no travel, no waiting, no hidden charges.
            </p>
            <a
              href="https://www.garagefixcare.in/bookservice"
...
export default BestBikeServiceNewFriendsColony;