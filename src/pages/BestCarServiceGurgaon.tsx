...
const BestCarServiceGurgaon = () => {
  ...
  const heroAlts = [
    "Best car service in Gurgaon at doorstep",
    "Professional car service garage Gurgaon",
    "Car repair at home Gurgaon",
    "Doorstep car service in Gurgaon"
  ];
  useEffect(() => {
  ...
  const carouselImages = [
    { src: bikeServiceOfferImage, alt: "Car service offer Gurgaon" },
    { src: doorstepImage, alt: "Doorstep car service Gurgaon" },
    { src: engineImage, alt: "Car engine repair Gurgaon" },
    { src: roadsideImage, alt: "Roadside car assistance Gurgaon" },
  ];
  ...
  return (
    <>
      <SEOHelmet
        ...
        twitter={{
          image: "https://www.garagefixcare.in/og-banner.png",
          imageAlt: "Doorstep car service and repair in Gurgaon",
        }}
        structuredData={[
          {
          ...
          },
          {
            "@context": "https://schema.org",
            "@type": "Service",
            "name": "Doorstep Car Service in Gurgaon",
      ...
      <div className="min-h-screen">
        ...
        <section className="py-12 bg-slate-900">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-white mb-6">Transparent pricing for doorstep car service in Gurgaon. No hidden fees, quality assured.</p>
        ...
        <section className="py-8 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-white text-base max-w-3xl mx-auto">Whether you live in Sector 14, Sector 29, Sector 56, Sector 57, DLF Phases 1-5, Golf Course Road, or Sohna Road, our car mechanics reach your doorstep within 2-4 hours. Same-day car service available across Gurgaon.</p>
          </div>
        </section>
        ...
        <section className="py-12 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">Complete Car Care, <span className="text-red-600">Right at Your Door in Gurgaon</span></h2>
            <p className="text-white mb-6">From routine periodic service to AC repair and engine diagnostics — our Gurgaon mechanics handle it all.</p>
        ...
        <section className="py-8 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-6 items-center">
            <div><p className="text-xs">Get Rs.10 Off On First Car Service in Gurgaon</p><h2 className="text-3xl font-bold">GarageFixCare <span className="text-red-600">Service Warranty</span></h2><p className="mb-4">Gurgaon's trusted doorstep car service. We service all car brands — Maruti, Hyundai, Honda, Tata, Mahindra, Toyota, and more — right at your home or office.</p><div className="flex gap-2"><img src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg" alt="Google Play" className="h-10" /><img src="https://developer.apple.com/assets/elements/badges/download-on-the-app-store.svg" alt="App Store" className="h-10" /></div></div>
        ...
        <section className="py-12 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-6 items-center">
            ...
            <div className="order-1"><h2 className="text-3xl font-bold mb-2">Why Choose <span className="text-red-600">GarageFixCare?</span></h2><p>We bring certified mechanics directly to Gurgaon car owners — honest pricing, genuine parts, zero hassle.</p><ul className="space-y-2 mt-4">{["Hassle-Free Doorstep Service", "Certified and Skilled Technicians", "Honest Pricing", "Certified Genuine Parts", "Your Satisfaction Guaranteed", "Fast and Professional Service"].map(item => <li key={item} className="flex items-center"><span className="text-red-500 mr-1">◆</span> {item}</li>)}</ul></div>
          </div>
        </section>
        ...
        {/* FAQs (15 items - Car specific for Gurgaon) */}
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="space-y-3">
              {[
                ...
                { q: "How do I book a car mechanic near me in Gurgaon?", a: "Call us, WhatsApp, or use the booking form on this page. Share your location in Gurgaon and preferred time." },
...
export default BestCarServiceGurgaon;