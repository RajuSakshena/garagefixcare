// BestBikeServiceMalviyaNagar.tsx
// Malviya Nagar specific SEO/content + Delhi Cantt master design system
...
const BestBikeServiceMalviyaNagar = () => {
  ...
  // Hot Deals marquee images — Malviya Nagar specific copy/alt text
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Malviya Nagar, Delhi' },
    { src: hotDealsImage2, alt: 'Doorstep scooty service near Shivalik Colony' },
    { src: hotDealsImage3, alt: 'Car engine repair near Saket' },
    { src: hotDealsImage4, alt: 'Roadside vehicle assistance near Hauz Khas' },
    { src: hotDealsImage5, alt: 'Doorstep vehicle repair deal near Panchsheel Park' },
  ];
  const hotDealsAreaBadges = ['Malviya Nagar', 'Saket', 'Hauz Khas', 'Shivalik', 'Sheikh Sarai', 'Panchsheel Park'];
  ...
  const serviceCities = [
    { name: 'Malviya Nagar', color: 'text-indigo-700' },
    { name: 'Saket', color: 'text-red-700' },
    { name: 'Hauz Khas', color: 'text-teal-700' },
    { name: 'Shivalik', color: 'text-gray-900' },
    { name: 'Sheikh Sarai', color: 'text-orange-700' },
    { name: 'Panchsheel Park', color: 'text-slate-700' },
  ];

  const coveredAreas = [
    'Malviya Nagar', 'Malviya Nagar Main Market', 'Malviya Nagar Metro', 'Begumpur',
    'Shivalik Colony', 'Geetanjali Enclave', 'Navjeevan Vihar', 'Sarvodaya Enclave',
    'MMTC Colony', 'Bhavishya Nidhi Enclave', 'Hauz Rani', 'Khirki Extension',
    'Sheikh Sarai', 'Sheikh Sarai Phase 1', 'Sheikh Sarai Phase 2', 'Saket',
    'Hauz Khas', 'Gulmohar Park', 'Panchsheel Park', 'Panchsheel Enclave',
    'Pushp Vihar', 'Chirag Delhi', 'Masjid Moth', 'Adhchini',
    'Yusuf Sarai', 'Kalu Sarai', 'Shahpur Jat', 'Humayunpur',
    'Greater Kailash', 'Greater Kailash 1', 'Greater Kailash 2', 'Lado Sarai',
  ...
  const faqs = [
    {
      q: 'What is the best bike, scooty and car service in Malviya Nagar?',
      a: "Garage Fix Care is Malviya Nagar's trusted doorstep service for bikes, scooties and cars, starting at just ₹299 for bike and scooty service, with certified mechanics, transparent pricing, genuine parts and a 10-day service guarantee.",
    },
    {
      q: 'How much does bike or scooty service cost in Malviya Nagar?',
      a: 'Bike and scooty service in Malviya Nagar starts from ₹299 for 100–125cc vehicles (At-Home Basic Service). Standard Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Complete Care (350–450 CC) is ₹599, and Luxury Care (above 500 CC) is ₹999. All prices include labour with zero hidden charges.',
    },
    {
      q: 'Do you provide car service in Malviya Nagar too?',
      a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing and repairs in Malviya Nagar and nearby areas. Car service is quoted transparently based on your car model and the work required — just book online or call us for a quote.',
    },
    {
      q: 'Which areas around Malviya Nagar are covered for doorstep service?',
      a: 'We cover Malviya Nagar, Malviya Nagar Main Market, Malviya Nagar Metro area, Begumpur, Shivalik Colony, Geetanjali Enclave, Navjeevan Vihar, Sarvodaya Enclave, MMTC Colony, Bhavishya Nidhi Enclave, Hauz Rani, Khirki Extension, Sheikh Sarai, Sheikh Sarai Phase 1 and 2, Saket, Hauz Khas, Gulmohar Park, Panchsheel Park, Panchsheel Enclave, Pushp Vihar, Chirag Delhi, Masjid Moth, Adhchini, Yusuf Sarai, Kalu Sarai, Shahpur Jat, Humayunpur, Greater Kailash, Greater Kailash 1 and 2, Lado Sarai, Mehrauli and Vasant Kunj.',
    },
    {
      q: 'Do you provide doorstep service in Malviya Nagar societies and apartments?',
      a: 'Yes. Our mechanics regularly service vehicles inside residential societies, DDA flats and apartment complexes across Malviya Nagar, Shivalik Colony and Geetanjali Enclave. Share your society name and gate number while booking — we come directly to your parking bay.',
    },
    {
      q: 'Do you handle emergency breakdown near Saket or Hauz Khas?',
      a: 'Yes. If your bike, scooty or car breaks down near Saket, Hauz Khas, Shivalik or anywhere in the Malviya Nagar area, call us immediately and we dispatch a mechanic to your location for on-spot repair.',
    },
    {
      q: 'Do you provide doorstep vehicle service in Panchsheel Park and Sheikh Sarai?',
      a: 'Yes. Panchsheel Park, Panchsheel Enclave, Sheikh Sarai Phase 1, Sheikh Sarai Phase 2 and Pushp Vihar all fall within our doorstep service zone for bikes, scooties and cars. Same-day doorstep service is available subject to location and technician availability.',
    },
    {
      q: 'Do you service Royal Enfield and other major bike brands in Malviya Nagar?',
      a: 'Yes. We specialise in Royal Enfield servicing across Malviya Nagar — Classic 350, Bullet 350, Meteor 350, Hunter 350 and Himalayan — and we also handle Hero, Honda, Bajaj, TVS, Suzuki, Yamaha and KTM models at your doorstep.',
    },
    {
      q: 'Is your bike, scooty and car service pricing transparent in Malviya Nagar?',
    ...
    {
      q: 'Do you offer a warranty on bike, scooty and car service in Malviya Nagar?',
      a: 'Every service by Garage Fix Care in Malviya Nagar includes a 10-day hassle-free service guarantee, whether it is a bike, scooty or car. If any issue arises post-service, we address it at no extra cost.',
    },
    {
      q: 'Do you provide free pickup and drop for service in Malviya Nagar?',
    ...
    {
      q: 'How do I book a bike, scooty or car mechanic near me in Malviya Nagar?',
      a: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Let us know whether it is a bike, scooty or car, share your area near Malviya Nagar and your preferred time slot — we handle the rest.',
    },
  ];
  ...
  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in Malviya Nagar | Doorstep Service Just ₹299"
        description="Garage Fix Care offers doorstep bike, scooty and car service in Malviya Nagar, Delhi, covering Saket, Hauz Khas, Shivalik, Begumpur, Sheikh Sarai, Panchsheel Park, Pushp Vihar, Khirki Extension, Greater Kailash and Lado Sarai, starting at just ₹299. Certified mechanics, transparent pricing and same-day doorstep service."
        canonical="https://www.garagefixcare.in/best-bike-service-malviya-nagar"
        robots="index, follow"
        og={{
          url: 'https://www.garagefixcare.in/best-bike-service-malviya-nagar',
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Best bike, scooty and car service in Malviya Nagar at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in Malviya Nagar, Saket and Hauz Khas',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Malviya Nagar, Delhi. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299 for bike and scooty service.',
            url: 'https://www.garagefixcare.in/best-bike-service-malviya-nagar',
            ...
            geo: { '@type': 'GeoCoordinates', latitude: '28.5380', longitude: '77.2100' },
            areaServed: [
              { '@type': 'Place', name: 'Malviya Nagar' },
              { '@type': 'Place', name: 'Malviya Nagar Main Market' },
              { '@type': 'Place', name: 'Malviya Nagar Metro' },
              { '@type': 'Place', name: 'Begumpur' },
              { '@type': 'Place', name: 'Shivalik Colony' },
              { '@type': 'Place', name: 'Geetanjali Enclave' },
              { '@type': 'Place', name: 'Navjeevan Vihar' },
              { '@type': 'Place', name: 'Sarvodaya Enclave' },
              { '@type': 'Place', name: 'MMTC Colony' },
              { '@type': 'Place', name: 'Bhavishya Nidhi Enclave' },
              { '@type': 'Place', name: 'Hauz Rani' },
              { '@type': 'Place', name: 'Khirki Extension' },
              { '@type': 'Place', name: 'Sheikh Sarai' },
              { '@type': 'Place', name: 'Sheikh Sarai Phase 1' },
              { '@type': 'Place', name: 'Sheikh Sarai Phase 2' },
              { '@type': 'Place', name: 'Saket' },
              { '@type': 'Place', name: 'Hauz Khas' },
              { '@type': 'Place', name: 'Gulmohar Park' },
              { '@type': 'Place', name: 'Panchsheel Park' },
              { '@type': 'Place', name: 'Panchsheel Enclave' },
              { '@type': 'Place', name: 'Pushp Vihar' },
              { '@type': 'Place', name: 'Chirag Delhi' },
              { '@type': 'Place', name: 'Masjid Moth' },
              { '@type': 'Place', name: 'Adhchini' },
              { '@type': 'Place', name: 'Yusuf Sarai' },
              { '@type': 'Place', name: 'Kalu Sarai' },
              { '@type': 'Place', name: 'Shahpur Jat' },
              { '@type': 'Place', name: 'Humayunpur' },
              { '@type': 'Place', name: 'Greater Kailash' },
              { '@type': 'Place', name: 'Greater Kailash 1' },
              { '@type': 'Place', name: 'Greater Kailash 2' },
              { '@type': 'Place', name: 'Lado Sarai' },
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Doorstep Bike, Scooty and Car Service in Malviya Nagar',
            provider: { '@type': 'LocalBusiness', name: 'Garage Fix Care' },
            areaServed: 'Malviya Nagar, New Delhi',
            description: 'At-home bike, scooty and car servicing across Malviya Nagar and nearby South Delhi areas including Saket, Hauz Khas, Shivalik Colony, Begumpur, Geetanjali Enclave, Sheikh Sarai, Panchsheel Park, Pushp Vihar, Khirki Extension, Hauz Rani, Chirag Delhi, Greater Kailash, Lado Sarai and Mehrauli. Bike and scooty service starts at ₹299, covering oil change, engine repair, battery replacement, brake repair, tyre service and puncture fix. Car service is quote-based and depends on the car model and work required — same-day doorstep service subject to availability.',
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Malviya Nagar', item: 'https://www.garagefixcare.in/best-bike-service-malviya-nagar' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Malviya Nagar specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in Malviya Nagar
                ...
                >
                  Trusted by residents across Malviya Nagar, Shivalik Colony, Begumpur, Geetanjali Enclave, Sheikh Sarai, Panchsheel Park, Saket and Hauz Khas — our certified mechanics handle bikes, scooties and cars right at your doorstep.
                </motion.p>
              </motion.div>
        ...
        {/* Dark premium information strip — Malviya Nagar specific copy */}
        <motion.div
          className="w-full"
          style={{
        ...
        <div className="bg-sky-100 border-y border-gray-200 py-2 overflow-hidden">
          <div className="flex items-center text-sm sm:text-sm font-semibold max-w-7xl mx-auto">
            <div className="flex-shrink-0 px-2 sm:px-2 pr-2">
              <span className="text-red-600 mr-1 sm:mr-2 font-bold">Doorstep Bike Service in Malviya Nagar </span>
        ...
        {/* Hot Deals This Week — Malviya Nagar specific copy, Delhi Cantt-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Limited-time offer for Malviya Nagar, Saket and Hauz Khas customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-white/70 max-w-xl mx-auto">Service support for leading two-wheeler brands across Malviya Nagar and Delhi.</p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Malviya Nagar pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service in Malviya Nagar and nearby South Delhi areas, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Areas Covered — Malviya Nagar localities */}
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service Areas in <span className="text-red-600">Malviya Nagar</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you live in Malviya Nagar, near the Main Market or Metro, in Shivalik Colony, Begumpur, Geetanjali Enclave, Sarvodaya Enclave, MMTC Colony, Khirki Extension, Hauz Rani, Sheikh Sarai, Saket, Hauz Khas, Panchsheel Park, Pushp Vihar, Chirag Delhi, Greater Kailash, Lado Sarai or Mehrauli, our bike, scooty and car mechanics reach your doorstep. Same-day doorstep service is available across the Malviya Nagar belt, subject to location and technician availability, starting at ₹299 for bike and scooty service.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Bike, Scooty &amp; Car Care, <span className="text-red-600">Right at Your Door in Malviya Nagar</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Malviya Nagar mechanics handle bikes, scooties and cars at your location, starting at ₹299 for bike and scooty service. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              {bikeServiceCards.map((service, index) => (
                ...
                >
                  <img
                    src={service.img}
                    alt={`${service.name} in Malviya Nagar`}
        ...
        {/* Comprehensive SEO Content (Malviya Nagar specific) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in Malviya Nagar</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>Malviya Nagar is one of South Delhi&apos;s most vibrant residential neighbourhoods, sitting between Saket and Hauz Khas and bordered by Shivalik Colony, Begumpur, Geetanjali Enclave, Sheikh Sarai, Panchsheel Park and the sprawling Pushp Vihar complex. Thousands of two-wheeler and car owners here depend on their vehicles for daily office commutes, metro feeder rides to Malviya Nagar Metro Station, school drops, and market trips to the buzzing Malviya Nagar Main Market. Garage Fix Care is Malviya Nagar&apos;s trusted doorstep vehicle service, bringing certified and background-verified mechanics directly to your home, society parking or office — whether you live in Shivalik Colony, closer to Khirki Extension and Hauz Rani, or in the quieter pockets of Sarvodaya Enclave and Geetanjali Enclave. Our mechanics typically reach your location within 2–4 hours of booking, subject to availability. Doorstep bike and scooty service starts at just ₹299 — covering all essential checks including engine oil change, air filter cleaning, spark plug inspection, brake adjustment and basic electrical check — with every task completed on the spot. We also handle car servicing and repairs at your doorstep, with pricing quoted based on your car&apos;s model and requirement. We service every major two-wheeler brand seen across Malviya Nagar: Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM and more, from daily commuters and family scooties like the Honda Activa, TVS Jupiter and Suzuki Access, to premium machines like the Royal Enfield Classic 350 and KTM Duke 390, alongside popular hatchbacks and sedans. What distinguishes us as the best bike, scooty and car service in Malviya Nagar is our strict pricing transparency — you receive a full itemised estimate before a single tool is touched, ensuring zero hidden charges at the end. We use only genuine engine oils from Motul and Wurth, paired with manufacturer-approved spare parts, and each service is backed by our 10-day hassle-free service guarantee.</p>
              <p>Malviya Nagar&apos;s dense residential layout, the constant traffic around its Main Market, and the busy corridors linking Saket, Hauz Khas and Chirag Delhi all accelerate wear on engine oil, air filters, tyres and brakes — making regular servicing a genuine safety necessity for bikes, scooties and cars alike. Our mechanics carry professional diagnostic tools to identify emerging issues before they become expensive failures, significantly extending your vehicle&apos;s lifespan whether you commute daily towards Panchsheel Park or just ride around the neighbourhood. We also handle emergency breakdown situations across Malviya Nagar — if your bike, scooty or car stops near the Metro station, Hauz Khas or anywhere on the way to Greater Kailash, call us and we dispatch a mechanic to your exact location as soon as possible. From battery replacement and brake pad changes to clutch cable adjustment and tyre puncture repair, our technicians fix it all on the spot without towing. Garage Fix Care has completed over 1,00,000 services across Delhi NCR, earning a consistent 4.7-star Google rating for professionalism, punctuality and honest pricing. Book your bike, scooty or car service in Malviya Nagar, Shivalik Colony, Begumpur, Geetanjali Enclave, Navjeevan Vihar, Sarvodaya Enclave, MMTC Colony, Bhavishya Nidhi Enclave, Hauz Rani, Khirki Extension, Sheikh Sarai Phase 1 and 2, Saket, Hauz Khas, Gulmohar Park, Panchsheel Park, Panchsheel Enclave, Pushp Vihar, Chirag Delhi, Masjid Moth, Adhchini, Yusuf Sarai, Kalu Sarai, Shahpur Jat, Humayunpur, Greater Kailash 1 and 2, Lado Sarai, Mehrauli or Vasant Kunj today via our website, WhatsApp or direct call — and discover the convenience of professional doorstep vehicle care starting at just ₹299 for bike and scooty service.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Malviya Nagar
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Malviya Nagar&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM and more — right at your home or society parking near Shivalik Colony and Saket.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Malviya Nagar" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to residents across Malviya Nagar, Shivalik Colony, Saket, Hauz Khas, Sheikh Sarai and Panchsheel Park — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced in Malviya Nagar is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your vehicle running at its best — starting at ₹299 for bike and scooty service, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Malviya Nagar" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Vikram Bisht', img: testimonial1, text: 'Doorstep service near Malviya Nagar Main Market was fast and professional.', time: 'a month ago' },
                { name: 'Pooja Rathi', img: testimonial2, text: 'Transparent billing with video evidence, booked from Shivalik Colony. Very reliable.', time: 'a month ago' },
                { name: 'Ravinder Negi', img: testimonial3, text: 'Great service near Saket, convenient and affordable.', time: 'a month ago' },
                { name: 'Simran Kaur', img: testimonial4, text: 'Quick response near Hauz Khas, professional mechanic. Will recommend.', time: 'a month ago' },
              ].map(t => (
        ...
        {/* FAQs (Malviya Nagar specific — matches FAQPage schema exactly) */}
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in Malviya Nagar — <span className="text-red-600">Common Questions</span>
            </motion.h2>
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike, Scooty or Car Service in Malviya Nagar Today
            </h2>
            <p className="text-sm sm:text-base text-white mb-3 sm:mb-5 max-w-xl mx-auto">
              Same-day doorstep service across Malviya Nagar and nearby areas starting at ₹299. Our mechanic comes to you — no travel, no waiting, no hidden charges.
            </p>
            <a
              href="https://www.garagefixcare.in/bookservice"
...
export default BestBikeServiceMalviyaNagar;