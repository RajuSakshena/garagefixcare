// BestBikeServiceDhaulaKuan.tsx
// Dhaula Kuan specific SEO/content + Home.tsx design system (video hero, Framer Motion, marquees)
...
// Dhaula Kuan specific / existing assets — kept from the master page
...
const BestBikeServiceDhaulaKuan = () => {
  ...
  // Hot Deals marquee images — Dhaula Kuan specific copy/alt text, Home-style assets
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Dhaula Kuan' },
    { src: hotDealsImage2, alt: 'Doorstep scooty service near Dhaula Kuan Metro Station' },
    { src: hotDealsImage3, alt: 'Car engine repair near Moti Bagh and R.K. Puram' },
    { src: hotDealsImage4, alt: 'Roadside vehicle assistance near Vasant Vihar and Naraina' },
    { src: hotDealsImage5, alt: 'Doorstep bike repair deal near Chanakyapuri and Delhi Cantt' },
  ];
  const hotDealsAreaBadges = ['Dhaula Kuan', 'Moti Bagh', 'R.K. Puram', 'Vasant Vihar', 'Naraina', 'Chanakyapuri'];
  ...
  // Service Available marquee — Dhaula Kuan specific phrases
  const serviceCities = [
    { name: 'Bike Service in Dhaula Kuan', color: 'text-indigo-700' },
    { name: 'Scooty Service in Dhaula Kuan', color: 'text-red-700' },
    { name: 'Car Service in Dhaula Kuan', color: 'text-teal-700' },
    { name: 'Doorstep Vehicle Service in Dhaula Kuan', color: 'text-gray-900' },
    { name: 'Bike Repair in Dhaula Kuan', color: 'text-orange-700' },
    { name: 'Scooty Repair in Dhaula Kuan', color: 'text-slate-700' },
    { name: 'Car Repair in Dhaula Kuan', color: 'text-blue-800' },
    { name: 'Same-Day Vehicle Service in Dhaula Kuan', color: 'text-emerald-700' },
    { name: 'Bike Service near Dhaula Kuan Metro', color: 'text-purple-700' },
    { name: 'Scooty Service near Dhaula Kuan', color: 'text-pink-700' },
    { name: 'Car Service near Dhaula Kuan', color: 'text-cyan-700' },
  ];

  // Areas Covered — Dhaula Kuan and nearby service areas
  const coveredAreas = [
    'Dhaula Kuan', 'Dhaula Kuan Enclave I', 'Dhaula Kuan Enclave II', 'Dhaula Kuan Metro Station',
    'Dhaula Kuan Bus Terminal', 'Ring Road', 'NH 48', 'Jheel Park', 'Cariappa Marg',
    'Benito Juarez Marg', 'Rao Tula Ram Marg', 'Moti Bagh', 'South Moti Bagh', 'North Moti Bagh',
    'Shanti Niketan', 'Anand Niketan', 'Satya Niketan', 'R.K. Puram', 'Rama Krishna Puram',
    'Vasant Vihar', 'Vasant Enclave', 'Munirka', 'Munirka Village', 'Naraina', 'Naraina Vihar',
    'Naraina Industrial Area', 'Delhi Cantonment', 'Delhi Cantt', 'Chanakyapuri', 'Diplomatic Enclave',
    'Safdarjung Enclave', 'Bhikaji Cama Place', 'Sarojini Nagar', 'Netaji Nagar', 'South Campus',
    'Benito Juarez Road', 'Africa Avenue', 'Ber Sarai', 'Shankar Vihar',
  ];
  ...
  const cityPages = [
    ...
    { name: 'Moti Bagh', path: '/best-bike-service-moti-bagh' },
    ...
    { name: 'Shankar Vihar', path: '/best-bike-service-shankar-vihar' },
  ...
  const faqs = [
    { q: 'What is the best bike, scooty and car service in Dhaula Kuan?', a: 'Garage Fix Care is Dhaula Kuan\'s highest-rated doorstep service for bikes, scooties and cars, starting at ₹299 with certified mechanics, transparent pricing, genuine parts, and a 10-day service guarantee.' },
    { q: 'How much does bike or scooty service cost in Dhaula Kuan, Delhi?', a: 'Bike and scooty service in Dhaula Kuan at Garage Fix Care starts from ₹299 for 100–125cc vehicles (Regular Service). Classic Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Royal Service (350–450 CC) is ₹599, and Sports Service (above 500 CC) is ₹999. All prices include labour with zero hidden charges.' },
    { q: 'Do you provide car service in Dhaula Kuan too?', a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing in Dhaula Kuan and nearby areas like Moti Bagh, R.K. Puram and Vasant Vihar. Car service pricing is quoted based on your car\'s model and the work required — just book online or call us for a quote.' },
    { q: 'Do you provide doorstep bike and scooty repair near Dhaula Kuan Metro Station?', a: 'Yes, we provide complete doorstep bike and scooty repair across Dhaula Kuan, Dhaula Kuan Enclave I and II, and around Dhaula Kuan Metro Station. Our certified mechanics arrive with all tools, oils, and parts — no garage visit needed.' },
    { q: 'Which areas near Dhaula Kuan are covered for bike, scooty and car service?', a: 'We cover Dhaula Kuan, Dhaula Kuan Enclave I and II, Dhaula Kuan Metro Station, Dhaula Kuan Bus Terminal, Ring Road, NH 48, Jheel Park, Cariappa Marg, Benito Juarez Marg, Rao Tula Ram Marg, Moti Bagh, Shanti Niketan, Anand Niketan, Satya Niketan, R.K. Puram, Vasant Vihar, Munirka, Naraina, Delhi Cantt, Chanakyapuri, Safdarjung Enclave, Bhikaji Cama Place, Sarojini Nagar, Netaji Nagar, South Campus, Ber Sarai and Shankar Vihar.' },
    { q: 'Do you service Royal Enfield bikes near Dhaula Kuan?', a: 'Yes. We specialise in Royal Enfield servicing across Dhaula Kuan and nearby Moti Bagh and Vasant Vihar — Classic 350, Bullet 350, Meteor 350, Himalayan, and Thunderbird — all serviced at your doorstep.' },
    { q: 'How quickly can a mechanic reach me in Dhaula Kuan?', a: 'Our mechanics typically reach your location in Dhaula Kuan or nearby Moti Bagh, R.K. Puram and Vasant Vihar within 2–4 hours of booking, for bikes, scooties and cars alike. For urgent requests, call us and we will prioritise your slot.' },
    { q: 'Is your bike, scooty and car service pricing transparent in Dhaula Kuan?', a: 'Absolutely. We provide a full itemised cost estimate before starting any work, whether it\'s a bike, scooty or car. No surprise bills — what you see is exactly what you pay.' },
    { q: 'Do you service scooties near Moti Bagh and R.K. Puram?', a: 'Yes. We repair and service all scooties near Moti Bagh, R.K. Puram and Vasant Vihar — Honda Activa, TVS Jupiter, Suzuki Access 125, Honda Dio, Hero Maestro — all at your doorstep.' },
    { q: 'Do you offer a warranty on bike, scooty and car service in Dhaula Kuan?', a: 'Every service by Garage Fix Care in Dhaula Kuan includes a 10-day hassle-free service guarantee, whether it\'s a bike, scooty or car. If any issue arises post-service, we address it at no extra cost.' },
    { q: 'How do I book a bike, scooty or car mechanic near me in Dhaula Kuan?', a: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Let us know whether it\'s a bike, scooty or car, share your area near Dhaula Kuan and preferred time slot — we handle the rest.' },
    { q: 'What payment methods are accepted in Dhaula Kuan?', a: 'We accept cash, UPI (Google Pay, PhonePe, Paytm), and all major mobile wallets. Payment is collected only after the service is complete.' },
    { q: 'Do I need to arrange any tools or oils?', a: 'No. Our Dhaula Kuan mechanics arrive fully equipped — tools, genuine Motul/Wurth engine oils, and all required spare parts are brought to your doorstep, for bikes, scooties and cars.' },
    { q: 'Do you handle emergency bike, scooty or car breakdown near Dhaula Kuan or Vasant Vihar?', a: 'Yes. If your bike, scooty or car breaks down anywhere near Dhaula Kuan Metro Station, Moti Bagh or Vasant Vihar, call us immediately and we dispatch a mechanic to your location.' },
    { q: 'What makes Garage Fix Care better than a local Dhaula Kuan workshop?', a: 'We come to you for bikes, scooties and cars, save your travel time, offer transparent itemised billing, use genuine parts, and provide a 10-day warranty — something most local Dhaula Kuan workshops cannot match.' },
  ];

  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in Dhaula Kuan | Doorstep Service Just ₹299"
        description="Garage Fix Care offers doorstep bike, scooty and car service in Dhaula Kuan, Delhi, Moti Bagh, R.K. Puram, Vasant Vihar and nearby areas, starting at just ₹299. Certified mechanics, same-day service at your home."
        canonical="https://www.garagefixcare.in/best-bike-service-dhaula-kuan"
        robots="index, follow"
        og={{
          url: 'https://www.garagefixcare.in/best-bike-service-dhaula-kuan',
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Best bike, scooty and car service in Dhaula Kuan at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in Dhaula Kuan, Moti Bagh and R.K. Puram',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Dhaula Kuan, Delhi. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299.',
            url: 'https://www.garagefixcare.in/best-bike-service-dhaula-kuan',
            ...
            address: {
              '@type': 'PostalAddress',
              addressLocality: 'Dhaula Kuan, New Delhi',
              addressRegion: 'Delhi',
              addressCountry: 'IN',
            },
            geo: { '@type': 'GeoCoordinates', latitude: '28.5921', longitude: '77.1616' },
            areaServed: [
              { '@type': 'Place', name: 'Dhaula Kuan' },
              { '@type': 'Place', name: 'Dhaula Kuan Enclave I' },
              { '@type': 'Place', name: 'Dhaula Kuan Enclave II' },
              { '@type': 'Place', name: 'Dhaula Kuan Metro Station' },
              { '@type': 'Place', name: 'Dhaula Kuan Bus Terminal' },
              { '@type': 'Place', name: 'Jheel Park' },
              { '@type': 'Place', name: 'Cariappa Marg' },
              { '@type': 'Place', name: 'Benito Juarez Marg' },
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Doorstep Bike, Scooty and Car Service in Dhaula Kuan',
            provider: { '@type': 'LocalBusiness', name: 'Garage Fix Care' },
            areaServed: 'Dhaula Kuan, New Delhi',
            description: 'At-home bike, scooty and car servicing starting at ₹299 across Dhaula Kuan, Dhaula Kuan Enclave I and II, Dhaula Kuan Metro Station, Dhaula Kuan Bus Terminal, Ring Road, NH 48, Jheel Park, Cariappa Marg, Benito Juarez Marg, Rao Tula Ram Marg, Moti Bagh, Shanti Niketan, Anand Niketan, Satya Niketan, R.K. Puram, Vasant Vihar, Munirka, Naraina, Delhi Cantt, Chanakyapuri, Safdarjung Enclave, Bhikaji Cama Place, Sarojini Nagar, Netaji Nagar, South Campus, Ber Sarai and Shankar Vihar. Oil change, engine repair, battery replacement, puncture fix and car maintenance — same-day doorstep service.',
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Dhaula Kuan', item: 'https://www.garagefixcare.in/best-bike-service-dhaula-kuan' },
              { '@type': 'ListItem', position: 4, name: 'Best Bike, Scooty and Car Service in Dhaula Kuan', item: 'https://www.garagefixcare.in/best-bike-service-dhaula-kuan' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Dhaula Kuan specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in Dhaula Kuan
        ...
        {/* Dark premium information strip — Dhaula Kuan specific copy */}
        <motion.div
          className="w-full"
          style={{
          ...
          <div className="max-w-[1100px] mx-auto px-[14px] py-[10px] sm:px-6 sm:py-3.5 relative overflow-hidden">
            ...
            <span className="relative inline-flex items-center gap-1.5 mb-1">
              ...
              <span className="text-[8px] sm:text-[9px] font-semibold uppercase tracking-wider" style={{ color: '#ff7a00' }}>
                Garage Fix Care — Dhaula Kuan, Delhi
              </span>
            </span>
            <p className="relative text-[10px] sm:text-sm leading-[1.4] sm:leading-relaxed" style={{ color: '#cbd5e1' }}>
              Skip the garage queue. Our certified mechanics come to your home, office or society across Dhaula Kuan, Dhaula Kuan Enclave I and II, Dhaula Kuan Metro Station, Jheel Park, Cariappa Marg, Benito Juarez Marg, Rao Tula Ram Marg, Moti Bagh, Shanti Niketan, Anand Niketan, Satya Niketan, R.K. Puram, Vasant Vihar, Munirka, Naraina, Delhi Cantt, Chanakyapuri, Safdarjung Enclave, Bhikaji Cama Place, Sarojini Nagar, Netaji Nagar, Ber Sarai and Shankar Vihar — servicing bikes, scooties and cars, from routine maintenance to engine repairs, starting at ₹299. Fast, transparent, and affordable.
            </p>
          </div>
        </motion.div>

        {/* Marquee: Service Available in Dhaula Kuan */}
        ...
        {/* Hot Deals This Week — Dhaula Kuan specific copy, Home-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Limited-time offer for Dhaula Kuan, Moti Bagh and R.K. Puram customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Dhaula Kuan pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service near Dhaula Kuan and Moti Bagh, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service Areas in <span className="text-red-600">Dhaula Kuan</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you live or work in Dhaula Kuan, Dhaula Kuan Enclave I and II, near Dhaula Kuan Metro Station, the Dhaula Kuan Bus Terminal, or in nearby service areas like Jheel Park, Cariappa Marg, Benito Juarez Marg, Rao Tula Ram Marg, Moti Bagh, Shanti Niketan, Anand Niketan, Satya Niketan, R.K. Puram, Vasant Vihar, Munirka, Naraina, Delhi Cantt, Chanakyapuri, Safdarjung Enclave, Bhikaji Cama Place, Sarojini Nagar, Netaji Nagar, Ber Sarai or Shankar Vihar — our bike, scooty and car mechanics reach your doorstep within 2-4 hours. Same-day doorstep service available across the Dhaula Kuan belt and nearby South-West and South Delhi localities, starting at ₹299.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Bike, Scooty &amp; Car Care, <span className="text-red-600">Right at Your Door in Dhaula Kuan</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Dhaula Kuan mechanics handle bikes, scooties and cars at your location, starting at ₹299. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              {bikeServiceCards.map((service, index) => (
                ...
                >
                  <img
                    src={service.img}
                    alt={`${service.name} in Dhaula Kuan`}
        ...
        {/* Comprehensive SEO Content (Dhaula Kuan specific, 1000+ words) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in Dhaula Kuan</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>Dhaula Kuan is one of South Delhi&apos;s busiest and most strategic junctions — the meeting point of Ring Road, NH 48, Cariappa Marg, and Rao Tula Ram Marg, right beside the Dhaula Kuan Metro Station and the Dhaula Kuan Bus Terminal. Thousands of commuters, students, defence families, and diplomatic staff pass through this area daily, parking their bikes, scooties, and cars around Dhaula Kuan Enclave I and II, Jheel Park, and the tree-lined pockets of Moti Bagh and Shanti Niketan. Constant stop-and-go traffic on the Ring Road flyover and NH 48, combined with dust and long idling hours, quickly wears down engine oil, brake pads, air filters, and tyres. Garage Fix Care is Dhaula Kuan&apos;s most trusted doorstep vehicle service, bringing certified, background-verified mechanics directly to your home, office, or society — whether you live right beside Dhaula Kuan Metro Station, in nearby Moti Bagh, R.K. Puram, Vasant Vihar, or in surrounding localities like Chanakyapuri, Safdarjung Enclave, Bhikaji Cama Place, and Shankar Vihar. Our mechanics reach your location within 2–4 hours of booking. Doorstep bike and scooty service in Dhaula Kuan starts at just ₹299 — covering all essential checks including engine oil change, air filter cleaning, spark plug inspection, brake adjustment, and basic electrical check — with every task completed on the spot without you needing to ride to a workshop. We also handle car servicing and repairs at your doorstep, with pricing quoted based on your car&apos;s model and requirement. We service every major two-wheeler brand seen across Dhaula Kuan: Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM, and more, handling everything from daily commuters and premium sports bikes to family scooties like the Honda Activa, TVS Jupiter, and Suzuki Access, alongside popular hatchbacks and sedans. What distinguishes us as the best bike, scooty and car service in Dhaula Kuan is our strict pricing transparency — you receive a full itemised estimate before a single tool is touched, ensuring zero hidden charges at the end. We use only genuine engine oils from Motul and Wurth, paired with manufacturer-approved spare parts, and each service is backed by our 10-day hassle-free service guarantee.</p>
              <p>The dense traffic around Dhaula Kuan Metro Station, the flyover merge at Ring Road and NH 48, and the constant flow through Moti Bagh and R.K. Puram accelerate wear on engine oil, air filters, tyres, and brakes — making regular servicing not just a good habit but a safety necessity for bikes, scooties, and cars alike. Our mechanics carry professional diagnostic tools to identify emerging issues before they become expensive failures, significantly extending your vehicle&apos;s lifespan whether you commute daily through Cariappa Marg or just within the Vasant Vihar belt. We also handle emergency breakdown situations across Dhaula Kuan — if your bike, scooty, or car stops near the Dhaula Kuan Bus Terminal or anywhere on the way toward Munirka or Naraina, call us and we dispatch a mechanic to your exact location immediately. From battery replacement and brake pad changes to clutch cable adjustment and tyre puncture repair, our technicians fix it all on the spot. Garage Fix Care has completed over 1,00,000 services across Delhi NCR, earning a consistent 4.7-star Google rating for professionalism, punctuality, and honest pricing. Book your bike, scooty, or car service in Dhaula Kuan, Dhaula Kuan Enclave I and II, Dhaula Kuan Metro Station, Dhaula Kuan Bus Terminal, Jheel Park, Cariappa Marg, Benito Juarez Marg, Rao Tula Ram Marg, Moti Bagh, Shanti Niketan, Anand Niketan, Satya Niketan, R.K. Puram, Vasant Vihar, Munirka, Naraina, Delhi Cantt, Chanakyapuri, Safdarjung Enclave, Bhikaji Cama Place, Sarojini Nagar, Netaji Nagar, Ber Sarai, or Shankar Vihar today via our website, WhatsApp, or direct call — and discover the convenience of professional doorstep vehicle care starting at just ₹299.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Dhaula Kuan
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Dhaula Kuan&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM, and more — right at your home or office near Moti Bagh and Vasant Vihar.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Dhaula Kuan" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to residents and professionals in Dhaula Kuan, Moti Bagh, and R.K. Puram — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced near Dhaula Kuan is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your vehicle running at its best — starting at ₹299, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Dhaula Kuan" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Vikram Bisht', img: testimonial1, text: 'Doorstep service near Dhaula Kuan Metro Station was fast and professional.', time: 'a month ago' },
                { name: 'Pooja Rathi', img: testimonial2, text: 'Transparent billing with video evidence, booked from Moti Bagh. Very reliable.', time: 'a month ago' },
                { name: 'Ravinder Negi', img: testimonial3, text: 'Great service near R.K. Puram, convenient and affordable.', time: 'a month ago' },
                { name: 'Simran Kaur', img: testimonial4, text: 'Quick response near Vasant Vihar, professional mechanic. Will recommend.', time: 'a month ago' },
              ].map(t => (
        ...
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in Dhaula Kuan — <span className="text-red-600">Common Questions</span>
            </motion.h2>
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike, Scooty or Car Service in Dhaula Kuan Today
            </h2>
...
export default BestBikeServiceDhaulaKuan;