// BestBikeServiceKarolBagh.tsx
// Karol Bagh specific SEO/content + Home.tsx design system (video hero, Framer Motion, marquees)
...
// Karol Bagh specific / existing assets
...
const BestBikeServiceKarolBagh = () => {
  ...
  // Hot Deals marquee images — Karol Bagh specific copy/alt text
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Karol Bagh' },
    { src: hotDealsImage2, alt: 'Doorstep scooty service near Ajmal Khan Road' },
    { src: hotDealsImage3, alt: 'Car engine repair near Pusa Road' },
    { src: hotDealsImage4, alt: 'Roadside vehicle assistance near Rajendra Place' },
    { src: hotDealsImage5, alt: 'Doorstep vehicle repair deal near Patel Nagar' },
  ];
  const hotDealsAreaBadges = ['Karol Bagh', 'Ajmal Khan Road', 'Pusa Road', 'Rajendra Place', 'Patel Nagar', 'Jhandewalan'];
  ...
  const serviceCities = [
    { name: 'Karol Bagh', color: 'text-indigo-700' },
    { name: 'Rajendra Place', color: 'text-red-700' },
    { name: 'Patel Nagar', color: 'text-teal-700' },
    { name: 'Pusa Road', color: 'text-gray-900' },
    { name: 'Jhandewalan', color: 'text-orange-700' },
    { name: 'Paharganj', color: 'text-slate-700' },
  ];

  const coveredAreas = [
    'Karol Bagh', 'Karol Bagh Main Market', 'Ajmal Khan Road', 'Arya Samaj Road',
    'Ghaffar Market', 'Beadonpura', 'WEA Karol Bagh', 'Bank Street',
    'Padam Singh Road', 'Faiz Road', 'Desh Bandhu Gupta Road', 'Tank Road',
  ];
  ...
  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in Karol Bagh | Doorstep Service Just ₹299"
        description="Garage Fix Care offers doorstep bike, scooty and car service in Karol Bagh, Delhi, including Ajmal Khan Road, Ghaffar Market, Pusa Road, Rajendra Place, Patel Nagar and Jhandewalan, starting at just ₹299. Certified mechanics, same-day vehicle repair at your home."
        canonical="https://www.garagefixcare.in/best-bike-service-karol-bagh"
        robots="index, follow"
        og={{
          url: 'https://www.garagefixcare.in/best-bike-service-karol-bagh',
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Best bike, scooty and car service in Karol Bagh at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in Karol Bagh, Delhi',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Karol Bagh. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299.',
            url: 'https://www.garagefixcare.in/best-bike-service-karol-bagh',
            ...
            address: {
              '@type': 'PostalAddress',
              addressLocality: 'Karol Bagh, New Delhi',
              addressRegion: 'Delhi',
              addressCountry: 'IN',
            },
            ...
            areaServed: [
              ...
              { '@type': 'Place', name: 'Karol Bagh Main Market' },
              { '@type': 'Place', name: 'Ajmal Khan Road' },
              { '@type': 'Place', name: 'Arya Samaj Road' },
              { '@type': 'Place', name: 'Ghaffar Market' },
              { '@type': 'Place', name: 'Beadonpura' },
              { '@type': 'Place', name: 'WEA Karol Bagh' },
              { '@type': 'Place', name: 'Bank Street' },
              { '@type': 'Place', name: 'Padam Singh Road' },
              { '@type': 'Place', name: 'Faiz Road' },
              { '@type': 'Place', name: 'Desh Bandhu Gupta Road' },
              { '@type': 'Place', name: 'Tank Road' },
              { '@type': 'Place', name: 'Rajendra Place' },
              { '@type': 'Place', name: 'Patel Nagar' },
              { '@type': 'Place', name: 'Pusa Road' },
            ],
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Doorstep Bike, Scooty and Car Service in Karol Bagh',
            provider: { '@type': 'LocalBusiness', name: 'Garage Fix Care' },
            areaServed: 'Karol Bagh, New Delhi',
            description: 'At-home bike, scooty and car servicing starting at ₹299 across Karol Bagh, Karol Bagh Main Market, Ajmal Khan Road, Arya Samaj Road, Ghaffar Market, Beadonpura, WEA Karol Bagh, Bank Street, Padam Singh Road, Faiz Road, Desh Bandhu Gupta Road and Tank Road. Oil change, engine repair, battery replacement, puncture fix and car maintenance — same-day doorstep service.',
          ...
          },
          {
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'Is bike service available in Karol Bagh?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Garage Fix Care provides doorstep bike service in Karol Bagh starting at just ₹299, with certified mechanics arriving at your home or office within 2–4 hours of booking.' } },
              { '@type': 'Question', name: 'Do you provide scooty repair in Karol Bagh?', acceptedAnswer: { '@type': 'Answer', text: 'Yes, we repair and service all scooties in Karol Bagh — Honda Activa, TVS Jupiter, Suzuki Access 125, Honda Dio and Hero Maestro — at your doorstep with genuine parts and transparent pricing.' } },
              { '@type': 'Question', name: 'Do you provide car service at home in Karol Bagh?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing in Karol Bagh and nearby areas. Car service pricing is quoted based on your car model and the work required — book online or call us for a quote.' } },
              { '@type': 'Question', name: 'What is the starting service price in Karol Bagh?', acceptedAnswer: { '@type': 'Answer', text: 'Bike and scooty service in Karol Bagh starts from ₹299 for 100–125cc vehicles (Basic Service). Standard Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Complete Care (350–450 CC) is ₹599, and Luxury Care (above 500 CC) is ₹999. All prices include labour with no hidden charges.' } },
              { '@type': 'Question', name: 'Is doorstep vehicle service available in Karol Bagh?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Garage Fix Care is a doorstep-first service. Our certified mechanics arrive at your home, apartment or office in Karol Bagh fully equipped with tools, oils and parts — no garage visit needed.' } },
              { '@type': 'Question', name: 'Is same-day service available in Karol Bagh?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Same-day bike, scooty and car service is available across Karol Bagh and surrounding areas. Book before noon and our mechanic typically reaches you the same day.' } },
              { '@type': 'Question', name: 'Do you provide pickup and drop for vehicles in Karol Bagh?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Free pickup and drop is available for bikes, scooties and cars in Karol Bagh whenever the service requires taking the vehicle to our workshop for specialised work.' } },
              { '@type': 'Question', name: 'Which areas around Karol Bagh are covered?', acceptedAnswer: { '@type': 'Answer', text: 'We cover Karol Bagh, Karol Bagh Main Market, Ajmal Khan Road, Arya Samaj Road, Ghaffar Market, Beadonpura, WEA Karol Bagh, Bank Street, Padam Singh Road, Faiz Road, Desh Bandhu Gupta Road, Tank Road, Saraswati Marg, Shastri Park, Jhandewalan and Rajendra Nagar.' } },
              { '@type': 'Question', name: 'Do you cover Rajendra Place and Patel Nagar?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Rajendra Place, East Patel Nagar, West Patel Nagar, South Patel Nagar, Patel Nagar and Prasad Nagar are all well within our regular doorstep service zone. Mechanics reach these areas within 2–4 hours for bikes, scooties and cars.' } },
              { '@type': 'Question', name: 'Do you cover Pusa Road and Jhandewalan?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Pusa Road, Jhandewalan, Jhandewalan Extension, Shadipur and Baljit Nagar are all covered for doorstep bike, scooty and car service with the same ₹299 starting price.' } },
              { '@type': 'Question', name: 'Do you cover Paharganj and Anand Parbat?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Paharganj, Doriwalan, Dev Nagar, Sarai Rohilla, Anand Parbat, Inderpuri and Naraina are all covered for doorstep bike, scooty and car service, including oil change, brake repair and battery replacement.' } },
              { '@type': 'Question', name: 'Can you replace vehicle batteries at home in Karol Bagh?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We replace two-wheeler and car batteries at your doorstep in Karol Bagh using genuine, warranty-backed batteries, with installation included.' } },
              { '@type': 'Question', name: 'Do you repair brakes at your doorstep in Karol Bagh?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Brake pad replacement, brake shoe change and brake adjustment for bikes, scooties and cars are all done at your doorstep in Karol Bagh with genuine parts.' } },
              { '@type': 'Question', name: 'Do you handle engine repairs for bikes, scooties and cars in Karol Bagh?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. From basic engine tuning to full engine overhaul, our certified mechanics handle engine repair for bikes, scooties and cars. Complex jobs are picked up and returned via our free pickup and drop service.' } },
              { '@type': 'Question', name: 'How can I book a vehicle service in Karol Bagh?', acceptedAnswer: { '@type': 'Answer', text: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Share whether it is a bike, scooty or car, your location in Karol Bagh and your preferred time slot — we handle the rest.' } },
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Karol Bagh', item: 'https://www.garagefixcare.in/best-bike-service-karol-bagh' },
              { '@type': 'ListItem', position: 4, name: 'Best Bike, Scooty and Car Service in Karol Bagh', item: 'https://www.garagefixcare.in/best-bike-service-karol-bagh' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Karol Bagh specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in Karol Bagh
        ...
        {/* Dark premium information strip — Karol Bagh specific copy */}
        <motion.div
          className="w-full"
          style={{
        ...
        {/* Hot Deals This Week — Karol Bagh specific copy */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Limited-time offer for Karol Bagh, Rajendra Place and Patel Nagar customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Karol Bagh pricing */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service near Karol Bagh and Rajendra Place, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Areas Covered — Karol Bagh localities */}
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service Areas in <span className="text-red-600">Karol Bagh</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you live in Karol Bagh Main Market, near Ajmal Khan Road, Arya Samaj Road, Ghaffar Market, Beadonpura, WEA Karol Bagh, Bank Street, Padam Singh Road, Faiz Road or Desh Bandhu Gupta Road, our bike, scooty and car mechanics reach your doorstep within 2-4 hours. Same-day doorstep service available across the Karol Bagh belt, starting at ₹299.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Bike, Scooty &amp; Car Care, <span className="text-red-600">Right at Your Door in Karol Bagh</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Karol Bagh mechanics handle bikes, scooties and cars at your location, starting at ₹299. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              {bikeServiceCards.map((service, index) => (
                ...
                >
                  <img
                    src={service.img}
                    alt={`${service.name} in Karol Bagh`}
        ...
        {/* Comprehensive SEO Content (Karol Bagh specific) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in Karol Bagh</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>Karol Bagh is one of Central Delhi&apos;s busiest and most vibrant commercial and residential hubs — home to the iconic Ghaffar Market, the Ajmal Khan Road shopping belt, the wholesale clusters around Beadonpura and Bank Street, and dense residential blocks spread across WEA Karol Bagh, Padam Singh Road, Faiz Road and Desh Bandhu Gupta Road. Vehicle owners here — from shopkeepers and traders to families and working professionals — depend on their bikes, scooties and cars for daily commutes to Paharganj, Connaught Place, ITO, Rajendra Place and further into the capital. Garage Fix Care is Karol Bagh&apos;s trusted doorstep service for bikes, scooties and cars, with certified and background-verified mechanics arriving at your home, apartment or office within 2–4 hours of booking. Doorstep bike and scooty service in Karol Bagh starts at just ₹299 and covers all essential checks — engine oil change, air filter cleaning, spark plug inspection, brake adjustment and basic electrical check — completed on the spot without you needing to ride to a workshop. Car servicing is also available at your doorstep, with pricing quoted transparently based on your car&apos;s model and requirement. We service every major two-wheeler and four-wheeler brand seen across Karol Bagh, Rajendra Place and Patel Nagar — Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM, plus popular hatchbacks and sedans. What makes us the best bike, scooty and car service in Karol Bagh is our strict pricing transparency: you receive a full itemised estimate before any work begins, genuine Motul and Wurth engine oils, manufacturer-approved spare parts and a 10-day hassle-free service guarantee.</p>
              <p>The relentless traffic on Ajmal Khan Road and Pusa Road, the frequent short trips between Ghaffar Market, Beadonpura and Bank Street, and the dusty stretches near Jhandewalan and Paharganj accelerate wear on engine oil, air filters, tyres and brakes — making regular servicing a safety necessity rather than a luxury, for bikes, scooties and cars alike. Our mechanics carry professional diagnostic tools to identify emerging issues before they turn into expensive failures, extending your vehicle&apos;s lifespan whether you commute daily to Rajendra Place and Patel Nagar or simply drive within the colony. We also handle emergency breakdowns across Karol Bagh and nearby areas — if your bike, scooty or car stops near the Karol Bagh Metro Station, Ajmal Khan Road or on the way to Paharganj, call us and we dispatch a mechanic to your exact location immediately. From battery replacement and brake pad changes to clutch cable adjustment, tyre puncture repair and engine diagnostics, our technicians fix it all on the spot. Garage Fix Care has completed over 1,00,000 services across Delhi NCR and earned a consistent 4.7-star Google rating for professionalism, punctuality and honest pricing. Book your bike, scooty or car service in Karol Bagh, Karol Bagh Main Market, Ajmal Khan Road, Arya Samaj Road, Ghaffar Market, Beadonpura, WEA Karol Bagh, Bank Street, Padam Singh Road, Faiz Road, Desh Bandhu Gupta Road, Tank Road, Saraswati Marg, Shastri Park, Jhandewalan, Jhandewalan Extension, Paharganj, Rajendra Nagar, New Rajendra Nagar, Old Rajendra Nagar, Rajendra Place, East Patel Nagar, West Patel Nagar, South Patel Nagar, Patel Nagar, Pusa Road, Prasad Nagar, Baljit Nagar, Shadipur, Shankar Road, Baba Farid Puri, Naraina, Inderpuri, Anand Parbat, Sarai Rohilla, Doriwalan, Dev Nagar or Punjabi Bagh — via our website, WhatsApp, or a direct call, and discover professional doorstep vehicle care starting at just ₹299.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Karol Bagh
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Karol Bagh&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM, and more — right at your home or office near Ajmal Khan Road and Rajendra Place.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Karol Bagh" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to residents of Karol Bagh, Rajendra Place and Patel Nagar — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced near Karol Bagh is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your vehicle running at its best — starting at ₹299, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Karol Bagh" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Vikram Bisht', img: testimonial1, text: 'Doorstep service in Karol Bagh was fast and professional.', time: 'a month ago' },
                { name: 'Pooja Rathi', img: testimonial2, text: 'Transparent billing with video evidence, booked from Rajendra Place. Very reliable.', time: 'a month ago' },
                { name: 'Ravinder Negi', img: testimonial3, text: 'Great service near Patel Nagar, convenient and affordable.', time: 'a month ago' },
                { name: 'Simran Kaur', img: testimonial4, text: 'Quick response near Pusa Road, professional mechanic. Will recommend.', time: 'a month ago' },
              ].map(t => (
        ...
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in Karol Bagh — <span className="text-red-600">Common Questions</span>
            </motion.h2>
            <motion.div className="space-y-3" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              {[
                { q: 'Is bike service available in Karol Bagh?', a: 'Yes. Garage Fix Care provides doorstep bike service in Karol Bagh starting at just ₹299, with certified mechanics arriving at your home or office within 2–4 hours of booking.' },
                { q: 'Do you provide scooty repair in Karol Bagh?', a: 'Yes, we repair and service all scooties in Karol Bagh — Honda Activa, TVS Jupiter, Suzuki Access 125, Honda Dio and Hero Maestro — at your doorstep with genuine parts and transparent pricing.' },
                { q: 'Do you provide car service at home in Karol Bagh?', a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing in Karol Bagh and nearby areas. Car service pricing is quoted based on your car model and the work required — book online or call us for a quote.' },
                { q: 'What is the starting service price in Karol Bagh?', a: 'Bike and scooty service in Karol Bagh starts from ₹299 for 100–125cc vehicles (Basic Service). Standard Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Complete Care (350–450 CC) is ₹599, and Luxury Care (above 500 CC) is ₹999. All prices include labour with no hidden charges.' },
                { q: 'Is doorstep vehicle service available in Karol Bagh?', a: 'Yes. Garage Fix Care is a doorstep-first service. Our certified mechanics arrive at your home, apartment or office in Karol Bagh fully equipped with tools, oils and parts — no garage visit needed.' },
                { q: 'Is same-day service available in Karol Bagh?', a: 'Yes. Same-day bike, scooty and car service is available across Karol Bagh and surrounding areas. Book before noon and our mechanic typically reaches you the same day.' },
                { q: 'Do you provide pickup and drop for vehicles in Karol Bagh?', a: 'Yes. Free pickup and drop is available for bikes, scooties and cars in Karol Bagh whenever the service requires taking the vehicle to our workshop for specialised work.' },
                { q: 'Which areas around Karol Bagh are covered?', a: 'We cover Karol Bagh, Karol Bagh Main Market, Ajmal Khan Road, Arya Samaj Road, Ghaffar Market, Beadonpura, WEA Karol Bagh, Bank Street, Padam Singh Road, Faiz Road, Desh Bandhu Gupta Road, Tank Road, Saraswati Marg, Shastri Park, Jhandewalan and Rajendra Nagar.' },
                { q: 'Do you cover Rajendra Place and Patel Nagar?', a: 'Yes. Rajendra Place, East Patel Nagar, West Patel Nagar, South Patel Nagar, Patel Nagar and Prasad Nagar are all well within our regular doorstep service zone. Mechanics reach these areas within 2–4 hours for bikes, scooties and cars.' },
                { q: 'Do you cover Pusa Road and Jhandewalan?', a: 'Yes. Pusa Road, Jhandewalan, Jhandewalan Extension, Shadipur and Baljit Nagar are all covered for doorstep bike, scooty and car service with the same ₹299 starting price.' },
                { q: 'Do you cover Paharganj and Anand Parbat?', a: 'Yes. Paharganj, Doriwalan, Dev Nagar, Sarai Rohilla, Anand Parbat, Inderpuri and Naraina are all covered for doorstep bike, scooty and car service, including oil change, brake repair and battery replacement.' },
                { q: 'Can you replace vehicle batteries at home in Karol Bagh?', a: 'Yes. We replace two-wheeler and car batteries at your doorstep in Karol Bagh using genuine, warranty-backed batteries, with installation included.' },
                { q: 'Do you repair brakes at your doorstep in Karol Bagh?', a: 'Yes. Brake pad replacement, brake shoe change and brake adjustment for bikes, scooties and cars are all done at your doorstep in Karol Bagh with genuine parts.' },
                { q: 'Do you handle engine repairs for bikes, scooties and cars in Karol Bagh?', a: 'Yes. From basic engine tuning to full engine overhaul, our certified mechanics handle engine repair for bikes, scooties and cars. Complex jobs are picked up and returned via our free pickup and drop service.' },
                { q: 'How can I book a vehicle service in Karol Bagh?', a: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Share whether it is a bike, scooty or car, your location in Karol Bagh and your preferred time slot — we handle the rest.' },
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike, Scooty or Car Service in Karol Bagh Today
            </h2>
...
export default BestBikeServiceKarolBagh;