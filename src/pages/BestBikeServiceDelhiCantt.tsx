...
const BestBikeServiceDelhiCantt = () => {
  ...
  const heroAlts = [
    "Best bike service in Delhi Cantt at doorstep",
    "Doorstep bike repair near Brar Square",
    "Professional motorcycle repair Sadar Bazaar Delhi Cantt",
    "Certified bike mechanic near Dhaula Kuan and Naraina"
  ];
  useEffect(() => {
  ...
  const carouselImages = [
    { src: bikeServiceOfferImage, alt: "Bike service offer Delhi Cantt" },
    { src: doorstepImage, alt: "Doorstep bike service Kirby Place" },
    { src: engineImage, alt: "Bike engine repair Gopinath Bazaar" },
    { src: roadsideImage, alt: "Roadside bike assistance near Subroto Park" },
  ];
    ...
    <>
      ...
      <div className="min-h-screen">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 items-center">
                ...
                <div>
                  ...
                  <p className="font-poppins text-xs sm:text-sm leading-relaxed text-white/90 mb-3 sm:mb-4">
                    Get the most trusted bike service in Delhi Cantt right at your doorstep. Whether you're stationed in the Army Area, live near Brar Square, Kirby Place, Gopinath Bazaar, Sadar Bazaar, or anywhere close to Dhaula Kuan, Naraina, Subroto Park, or Palam, our expert mechanics handle everything from oil change to engine overhaul. No garage queues, no hidden costs — just honest, affordable, and professional bike care.
                  </p>
        ...
        <section className="py-8 bg-slate-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-center mb-8"><div className="flex items-center"><h2 className="text-2xl sm:text-4xl font-bold mr-4"><span className="text-white">Hot Deals</span> <span className="text-red-600">This Week</span></h2><Flame className="h-8 w-8 text-orange-500" /></div><p className="text-lg text-white text-center">Limited-time offer for Delhi Cantt, Dhaula Kuan and Naraina customers! Get up to 10% off on bike repairs and servicing at your doorstep. Hurry—these deals won't last long!</p></div>
          </div>
        ...
        <section className="py-12 bg-slate-900">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-white mb-6">Transparent pricing for doorstep bike service near Delhi Cantt and Dhaula Kuan. Labour charges based on engine size — no hidden fees.</p>
        ...
        <section className="py-8 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">We Cover All Major Areas in <span className="text-red-600">Delhi Cantt</span></h2>
            ...
            <p className="text-white text-base max-w-3xl mx-auto">Whether you live in Delhi Cantonment, Brar Square, Kirby Place, Gopinath Bazaar, Sadar Bazaar, near Dhaula Kuan, Naraina, Subroto Park, in the Army Area, or close to Palam, our bike mechanics reach your doorstep within 2-4 hours. Same-day bike service available across the Delhi Cantt belt.</p>
          </div>
        </section>
        ...
        <section className="py-12 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">Complete Bike Care, <span className="text-red-600">Right at Your Door in Delhi Cantt</span></h2>
            <p className="text-white mb-6">From routine oil changes to full engine repair — our Delhi Cantt mechanics handle it all.</p>
        ...
        <section className="py-10 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">Why Garage Fix Care is the <span className="text-red-600">Best Bike Service in Delhi Cantt</span></h2>
        ...
        <section className="py-8 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-6 items-center">
            <div><p className="text-xs">Get Rs.10 Off On First Service in Delhi Cantt</p><h2 className="text-3xl font-bold">GarageFixCare <span className="text-red-600">Service Warranty</span></h2><p className="mb-4">Delhi Cantt's trusted doorstep bike service. We service all motorcycle and scooter brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM, and more — right at your home or office near Sadar Bazaar and Dhaula Kuan.</p><div className="flex gap-2"><img src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg" alt="Google Play" className="h-10" /><img src="https://developer.apple.com/assets/elements/badges/download-on-the-app-store.svg" alt="App Store" className="h-10" /></div></div>
        ...
        <section className="py-12 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-6 items-center">
            ...
            <div className="order-1"><h2 className="text-3xl font-bold mb-2">Why Choose <span className="text-red-600">GarageFixCare?</span></h2><p>We bring certified mechanics directly to residents of Delhi Cantt, Dhaula Kuan, and Naraina — honest pricing, genuine parts, zero hassle.</p><ul className="space-y-2 mt-4">{["Hassle-Free Doorstep Service", "Certified and Skilled Technicians", "Honest Pricing", "Certified Genuine Parts", "Your Satisfaction Guaranteed", "Fast and Professional Service"].map(item => <li key={item} className="flex items-center"><span className="text-red-500 mr-1">◆</span> {item}</li>)}</ul></div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10">
          ...
          <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-4 gap-4 mt-6">
            {[{ name: "Vikram Bisht", img: testimonial1, text: "Doorstep service near Brar Square was fast and professional.", time: "a month ago" }, { name: "Pooja Rathi", img: testimonial2, text: "Transparent billing with video evidence, booked from Sadar Bazaar. Very reliable.", time: "a month ago" }, { name: "Ravinder Negi", img: testimonial3, text: "Great service near Dhaula Kuan, convenient and affordable.", time: "a month ago" }, { name: "Simran Kaur", img: testimonial4, text: "Quick response near Naraina, professional mechanic. Will recommend.", time: "a month ago" }].map(t => (
        ...
        {/* FAQs (15 items - Delhi Cantt specific) */}
        <section className="bg-slate-900 py-10">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-3xl font-bold text-white text-center mb-6">Bike Service in Delhi Cantt — <span className="text-red-600">Common Questions</span></h2>
        ...
        <section className="py-8 bg-slate-800 text-center">
          <h2 className="text-3xl font-bold text-white mb-2">Book Bike Service in Delhi Cantt Today</h2>
