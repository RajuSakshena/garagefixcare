        ...
        <div className="min-h-screen">
          ...
          <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
            <section className="relative text-white overflow-hidden">
              ...
              {/* The video wrapper uses aspect-video to maintain natural ratio and avoid crop */}
              ...
              {/* Hero content overlay — absolute over the video */}
              <div className="absolute inset-0 z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12 flex flex-col justify-between">
                {/* TOP ZONE — H1 + subheading (Ghaziabad specific) */}
                <motion.div
                  className="top-5 left-4 right-4 sm:relative sm:top-auto sm:left-auto sm:right-auto sm:w-full lg:max-w-[560px]"
                  initial="hidden"
                  animate="visible"
                ...
                <motion.div
                  className="bottom-3 left-4 right-4 sm:relative sm:bottom-auto sm:left-auto sm:right-auto sm:w-full lg:max-w-[560px] sm:mt-0"
                  initial="hidden"
                  animate="visible"
                  variants={heroStaggerContainer}
                >
