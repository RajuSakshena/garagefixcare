...
const BestBikeServiceGhaziabad = () => {
  ...
  const heroAlts = [
    "Best bike service in Ghaziabad at doorstep",
    "Doorstep bike repair in Ghaziabad",
    "Professional motorcycle repair Ghaziabad",
    "Certified bike mechanic near me Ghaziabad"
  ];
  useEffect(() => {
  ...
  const carouselImages = [
    { src: bikeServiceOfferImage, alt: "Bike service offer Ghaziabad" },
    { src: doorstepImage, alt: "Doorstep bike service Ghaziabad" },
    { src: engineImage, alt: "Bike engine repair Ghaziabad" },
    { src: roadsideImage, alt: "Roadside bike assistance Ghaziabad" },
  ];
    ...
    <>
      ...
      <div className="min-h-screen">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 items-center">
                ...
                <div>
                  ...
                  <p className="font-poppins text-xs sm:text-sm leading-relaxed text-white/90 mb-3 sm:mb-4">
                    Get the most trusted bike service in Ghaziabad right at your doorstep. Whether you live in Indirapuram, Vaishali, Raj Nagar Extension, Crossings Republik, Vasundhara, or Kaushambi, our expert mechanics handle everything from oil change to engine overhaul. No garage queues, no hidden costs — just honest, affordable, and professional service.
                  </p>
        ...
        <section className="py-8 bg-slate-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-center mb-8"><div className="flex items-center"><h2 className="text-2xl sm:text-4xl font-bold mr-4"><span className="text-white">Hot Deals</span> <span className="text-red-600">This Week</span></h2><Flame className="h-8 w-8 text-orange-500" /></div><p className="text-lg text-white text-center">Limited-time offer for Ghaziabad customers! Get up to 10% off on bike repairs and servicing at your doorstep. Hurry—these deals won’t last long!</p></div>
          </div>
        ...
        <section className="py-12 bg-slate-900">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-white mb-6">Transparent pricing for doorstep bike service in Ghaziabad. Labour charges based on engine size — no hidden fees.</p>
        ...
        <section className="py-8 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-white text-base max-w-3xl mx-auto">Whether you live in Indirapuram, Vaishali, Raj Nagar Extension, Crossings Republik, Vasundhara, or Kaushambi, our bike mechanics reach your doorstep within 2-4 hours. Same-day bike service available across Ghaziabad.</p>
          </div>
        </section>
        ...
        <section className="py-12 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">Complete Bike Care, <span className="text-red-600">Right at Your Door in Ghaziabad</span></h2>
            <p className="text-white mb-6">From routine oil changes to full engine repair — our Ghaziabad mechanics handle it all.</p>
        ...
        <section className="py-12 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-6 items-center">
            ...
            <div className="order-1"><h2 className="text-3xl font-bold mb-2">Why Choose <span className="text-red-600">GarageFixCare?</span></h2><p>We bring certified mechanics directly to Ghaziabad residents — honest pricing, genuine parts, zero hassle.</p><ul className="space-y-2 mt-4">{["Hassle-Free Doorstep Service", "Certified and Skilled Technicians", "Honest Pricing", "Certified Genuine Parts", "Your Satisfaction Guaranteed", "Fast and Professional Service"].map(item => <li key={item} className="flex items-center"><span className="text-red-500 mr-1">◆</span> {item}</li>)}</ul></div>
          </div>
        </section>
