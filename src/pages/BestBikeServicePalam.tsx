// BestBikeServicePalam.tsx
// Palam specific SEO/content + Home.tsx design system (video hero, Framer Motion, marquees)
// Rebuilt from BestBikeServiceDelhiCantt.tsx master template — architecture, animation
// system, hero, pricing cards, and section design match Delhi Cantt 1:1; all copy,
// SEO, schema, and location data below is Palam-specific.
...
// Common assets shared with Delhi Cantt architecture
...
const BestBikeServicePalam = () => {
  ...
  // Hot Deals marquee images — Palam specific copy/alt text, Home-style assets
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Palam' },
    { src: hotDealsImage2, alt: 'Doorstep bike service near Palam Colony' },
    { src: hotDealsImage3, alt: 'Bike engine repair near Dashrath Puri' },
    { src: hotDealsImage4, alt: 'Roadside bike assistance near Dwarka Sector 8' },
    { src: hotDealsImage5, alt: 'Doorstep bike repair deal near IGI Airport Palam' },
  ];
  const hotDealsAreaBadges = ['Palam', 'Palam Colony', 'Dwarka', 'Raj Nagar', 'Dashrath Puri', 'Manglapuri'];
  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Palam specific) */}
              <motion.div
        ...
        {/* Dark premium information strip — Palam specific copy */}
        <motion.div
          className="w-full"
          style={{
          ...
          <div className="max-w-[1100px] mx-auto px-[14px] py-[10px] sm:px-6 sm:py-3.5 relative overflow-hidden">
            ...
            <span className="relative inline-flex items-center gap-1.5 mb-1">
              ...
              <span className="text-[8px] sm:text-[9px] font-semibold uppercase tracking-wider" style={{ color: '#ff7a00' }}>
                Garage Fix Care — Palam
              </span>
            </span>
            <p className="relative text-[10px] sm:text-sm leading-[1.4] sm:leading-relaxed" style={{ color: '#cbd5e1' }}>
              Skip the garage queue. Our certified mechanics come to your home, society gate or office across Palam Colony, Palam Village, Raj Nagar, Dashrath Puri, Dwarka Sector 7, 8, 9, Manglapuri, Delhi Cantonment and the IGI Airport area — handling everything from routine servicing to engine repairs. Fast, transparent, and affordable.
            </p>
          </div>
        </motion.div>
        ...
        {/* Hot Deals This Week — Palam specific copy, Home-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Exclusive limited-period offers for Palam residents! Grab up to 10% off on two-wheeler servicing and repairs at your doorstep. Book before slots fill up!
              </p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Palam pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Clear, upfront pricing for doorstep bike servicing in Palam. Labour charges are engine-size based — no surprise additions at the end.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Areas Covered — Palam localities */}
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              We Cover All Major Areas in <span className="text-red-600">Palam</span>
            </motion.h2>
            <motion.div
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Every Bike Problem Solved, <span className="text-red-600">Right in Your Palam Neighbourhood</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From basic tune-ups for daily commuters to advanced overhauls — our Palam mechanics bring the workshop to you.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Comprehensive Bike Service Content (Palam specific SEO copy) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Palam
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Palam&apos;s go-to doorstep bike service. We work on every major motorcycle and scooty brand — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM and more — at your home, office, or society parking in Palam Colony, Palam Village, Raj Nagar and Dwarka sectors.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Palam" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                Why Palam Riders <span className="text-red-600">Choose GarageFixCare?</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                From Dashrath Puri&apos;s crowded lanes to Dwarka Sector 9&apos;s wide avenues — Palam&apos;s two-wheeler owners trust us for honesty, expertise, and doorstep convenience.
              </p>
              <ul className="space-y-2 text-left">
                {['Mechanics Come to Your Palam Address', 'Transparent Bill Before Work Begins', 'Genuine OEM-Grade Spare Parts Only', '10-Day Post-Service Guarantee', 'Skilled in All Major Bike Brands', 'Quick Slots Available Same Day'].map(item => (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2 sm:mb-4">
                How <span className="text-red-600">GarageFixCare</span> Works in Palam?
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike fixed in Palam Colony or Dwarka Sector 8 is now as easy as ordering food. Pick a slot, our mechanic arrives, and the job gets done at your doorstep.
              </p>
              <ul className="space-y-2 text-left">
                {['Book Online or Call Us', 'Mechanic Dispatched to You', 'Full Service at Your Location', 'Itemised Cost Shared Upfront', '10-Day Work Guarantee', 'Pay After Job is Done'].map(item => (
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Palam" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Surendra Singh', img: testimonial1, text: 'Outstanding doorstep service near Palam Colony. The mechanic arrived on time and completed everything professionally.', time: 'a month ago' },
                { name: 'Dharmendra Gupta', img: testimonial2, text: 'Very transparent. They shared the full cost breakdown before starting. My scooter runs great now — booked from Raj Nagar.', time: 'a month ago' },
                { name: 'Rohit Prasad', img: testimonial3, text: 'Excellent value. Saved me so much time — no need to ride to a garage from Dashrath Puri.', time: 'a month ago' },
                { name: 'Prabhjeet Sharma', img: testimonial4, text: 'Fast response near Dwarka Sector 8 and skilled mechanics. I\u2019ll definitely book again for my Royal Enfield.', time: 'a month ago' },
              ].map(t => (
