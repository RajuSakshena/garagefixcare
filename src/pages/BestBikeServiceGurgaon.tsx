// BestBikeServiceGurgaon.tsx
// Gurgaon specific SEO/content + Delhi Cantt master design system
...
const BestBikeServiceGurgaon = () => {
  ...
  // Hot Deals marquee images — Gurgaon specific copy/alt text
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Gurgaon' },
    { src: hotDealsImage2, alt: 'Doorstep bike service near DLF Phase 1' },
    { src: hotDealsImage3, alt: 'Bike engine repair near Cyber City, Gurgaon' },
    { src: hotDealsImage4, alt: 'Roadside vehicle assistance near Golf Course Road' },
    { src: hotDealsImage5, alt: 'Doorstep vehicle repair near Sohna Road' },
  ];
  const hotDealsAreaBadges = ['Gurgaon', 'DLF Phase 1', 'DLF Phase 2', 'Golf Course Road', 'Sohna Road', 'Cyber City'];
  ...
  const serviceCities = [
    ...
    { name: 'Sector 14', color: 'text-red-700' },
    { name: 'Sector 29', color: 'text-teal-700' },
    { name: 'DLF Phase 1', color: 'text-gray-900' },
    { name: 'DLF Phase 5', color: 'text-orange-700' },
    { name: 'Cyber City', color: 'text-slate-700' },
  ];

  const coveredAreas = [
    'Sector 14', 'Sector 29', 'Sector 56', 'Sector 57',
    'DLF Phase 1', 'DLF Phase 2', 'DLF Phase 3', 'DLF Phase 4',
    'DLF Phase 5', 'Golf Course Road', 'Sohna Road', 'MG Road', 'Cyber City',
  ];
  ...
  const faqs = [
    {
      q: 'What is the best bike, scooty and car service in Gurgaon?',
      a: "Garage Fix Care is Gurgaon's trusted doorstep service for bikes, scooties and cars, starting at just ₹299 for bike and scooty service, with certified mechanics, transparent pricing, genuine parts and a 10-day service guarantee.",
    },
    {
      q: 'How much does bike service cost in Gurgaon?',
      a: 'Bike service in Gurgaon starts from ₹299 for 100–125cc vehicles (Regular Service). Classic Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Royal Service (350–450 CC) is ₹599, and Sports Service (above 500 CC) is ₹999. All prices include labour with zero hidden charges.',
    },
    {
      q: 'How much does scooty service cost in Gurgaon?',
      a: 'Scooty service in Gurgaon uses the same transparent CC-based pricing as bike service — starting at ₹299 for 100–125cc scooties like the Honda Activa or TVS Jupiter, up to ₹999 for larger engine sizes. Every price includes labour, with no hidden add-ons.',
    },
    {
      q: 'Do you provide doorstep car service in Gurgaon?',
      a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing and repairs in Gurgaon and nearby areas. Car service is quoted transparently based on your car model and the work required — just book online or call us for a quote.',
    },
    {
      q: 'Do you provide doorstep service in DLF Phase 1?',
      a: 'Yes. DLF Phase 1 is fully covered under our doorstep service zone for bikes, scooties and cars. Same-day service is available subject to location and technician availability — share your address during booking.',
    },
    {
      q: 'Do you provide bike and scooty service in DLF Phase 2?',
      a: 'Yes, DLF Phase 2 is covered for doorstep bike and scooty repair. Our certified mechanics arrive with tools, oils and common spare parts — no garage visit needed.',
    },
    {
      q: 'Do you provide vehicle service in DLF Phase 3?',
      a: 'Yes, DLF Phase 3 is part of our Gurgaon doorstep service zone. We handle bikes, scooties and cars at your home, society parking or office, starting at ₹299 for bike and scooty service.',
    },
    {
      q: 'Do you provide doorstep service in DLF Phase 4?',
      a: 'Yes, DLF Phase 4 is covered for doorstep bike, scooty and car service. Share your address during booking and we will assign a mechanic accordingly.',
    },
    {
      q: 'Do you provide bike, scooty and car service in DLF Phase 5?',
      a: 'Yes, DLF Phase 5 is covered. Same-day doorstep service is available subject to technician availability, for bikes, scooties and cars alike.',
    },
    {
      q: 'Do you provide service near Golf Course Road and Sohna Road?',
      a: 'Yes. Golf Course Road and Sohna Road both fall within our Gurgaon doorstep service zone for bikes, scooties and cars.',
    },
    {
      q: 'Do you provide service near Cyber City and MG Road?',
      a: 'Yes. Cyber City and MG Road are fully covered for doorstep vehicle service, including bikes, scooties and cars. Book online or call us and share your location.',
    },
    {
      q: 'Do you provide emergency breakdown assistance in Gurgaon?',
      a: 'Yes. If your bike, scooty or car breaks down anywhere in Gurgaon, call us immediately and we dispatch a mechanic to your location for on-spot repair or recovery.',
    },
    {
      q: 'Do you provide battery replacement and engine repair?',
      a: 'Yes. Our mechanics handle battery replacement, engine repair, brake repair, tyre service, clutch cable adjustment and other common repairs at your doorstep, for bikes, scooties and cars.',
    },
    {
      q: 'Do you provide pickup and drop service?',
      a: 'Free pickup and drop is available when a service requires workshop-level work — for example if a specific spare part is needed that cannot be fitted on-site. Most routine services are completed directly at your doorstep.',
    },
  ];
  ...
  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in Gurgaon | Doorstep Service Just ₹299"
        description="Garage Fix Care offers doorstep bike, scooty and car service in Gurgaon, covering Sector 14, Sector 29, Sector 56, Sector 57, DLF Phase 1, DLF Phase 2, DLF Phase 3, DLF Phase 4, DLF Phase 5, Golf Course Road, Sohna Road, MG Road and Cyber City, starting at just ₹299. Certified mechanics, transparent pricing and same-day doorstep service."
        ...
        og={{
          ...
          imageAlt: 'Best bike, scooty and car service in Gurgaon at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in Gurgaon, Cyber City and Golf Course Road',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Gurgaon. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299 for bike and scooty service.',
            url: 'https://www.garagefixcare.in/best-bike-service-gurgaon',
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Doorstep Bike, Scooty and Car Service in Gurgaon',
            provider: { '@type': 'LocalBusiness', name: 'Garage Fix Care' },
            areaServed: 'Gurgaon',
            description: 'At-home bike, scooty and car servicing across Gurgaon including Sector 14, Sector 29, Sector 56, Sector 57, DLF Phase 1, DLF Phase 2, DLF Phase 3, DLF Phase 4, DLF Phase 5, Golf Course Road, Sohna Road, MG Road and Cyber City. Bike and scooty service starts at ₹299, covering oil change, engine repair, battery replacement, brake repair, tyre service and puncture fix. Car service is quote-based and depends on the car model and work required — same-day doorstep service subject to availability.',
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Best Bike, Scooty and Car Service in Gurgaon', item: 'https://www.garagefixcare.in/best-bike-service-gurgaon' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Gurgaon specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in Gurgaon
                ...
                >
                  Trusted by residents across Sector 14, Sector 29, Sector 56, Sector 57, DLF Phase 1, DLF Phase 2, DLF Phase 3, DLF Phase 4, DLF Phase 5, Golf Course Road, Sohna Road, MG Road and Cyber City — our certified mechanics handle bikes, scooties and cars right at your doorstep.
                </motion.p>
              </motion.div>
        ...
        {/* Dark premium information strip — Gurgaon specific copy */}
        <motion.div
          className="w-full"
          style={{
        ...
        {/* Hot Deals This Week — Gurgaon specific copy, Delhi Cantt-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Limited-time offer for Gurgaon, Cyber City and Golf Course Road customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-white/70 max-w-xl mx-auto">Service support for leading two-wheeler brands across Gurgaon.</p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Gurgaon pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service in Gurgaon, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Areas Covered — Gurgaon localities */}
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              We Cover All Major Areas in <span className="text-red-600">Gurgaon</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you live in Sector 14, Sector 29, Sector 56, Sector 57, DLF Phase 1, DLF Phase 2, DLF Phase 3, DLF Phase 4, DLF Phase 5, close to Golf Course Road, Sohna Road, MG Road or Cyber City, our bike, scooty and car mechanics reach your doorstep. Same-day doorstep service is available across Gurgaon, subject to location and technician availability, starting at ₹299 for bike and scooty service.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Bike, Scooty &amp; Car Care, <span className="text-red-600">Right at Your Door in Gurgaon</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Gurgaon mechanics handle bikes, scooties and cars at your location, starting at ₹299 for bike and scooty service. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Comprehensive SEO Content (Gurgaon specific) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in Gurgaon</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>Gurgaon is one of the fastest-growing cities in India, a place where daily life moves at an extraordinary pace — from the corporate corridors of Cyber City and Golf Course Road to the residential depth of Sector 14, Sector 29, Sector 56 and Sector 57, and the established neighbourhoods of DLF Phase 1, DLF Phase 2, DLF Phase 3, DLF Phase 4 and DLF Phase 5. Vehicle owners in this city deserve a bike, scooty and car service that matches that pace — reliable, transparent and delivered right at the doorstep. Garage Fix Care is Gurgaon&apos;s trusted doorstep vehicle service, bringing certified and background-verified mechanics directly to your home, society parking or office, whether you are based near Sohna Road, close to MG Road, or just off the Cyber City belt. Our mechanics typically reach your location within 2–4 hours of booking, subject to availability. Doorstep bike and scooty service starts at just ₹299 — covering all essential checks including engine oil change, air filter cleaning, spark plug inspection, brake adjustment and basic electrical check — with every task completed on the spot. We also handle car servicing and repairs at your doorstep, with pricing quoted based on your car&apos;s model and requirement. We service every major two-wheeler brand seen across Gurgaon: Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM and more, from daily commuters and family scooties like the Honda Activa, TVS Jupiter and Suzuki Access, to premium machines like the Royal Enfield Classic 350 and KTM Duke 390, alongside popular hatchbacks and sedans. What distinguishes us as the best bike, scooty and car service in Gurgaon is our strict pricing transparency — you receive a full itemised estimate before a single tool is touched, ensuring zero hidden charges at the end. We use only genuine engine oils from Motul and Wurth, paired with manufacturer-approved spare parts, and each service is backed by our 10-day hassle-free service guarantee.</p>
              <p>The stop-start traffic around Cyber City and MG Road, the relentless dust and seasonal heat of the NCR, and the sheer number of kilometres racked up by daily commuters between DLF Phase 1, DLF Phase 2, DLF Phase 3, DLF Phase 4 and DLF Phase 5 all accelerate wear on engine oil, air filters, tyres and brakes — making regular servicing a genuine safety necessity for bikes, scooties and cars alike. Our mechanics carry professional diagnostic tools to identify emerging issues before they become expensive failures, significantly extending your vehicle&apos;s lifespan whether you commute daily along Golf Course Road or just occasionally ride into Sohna Road. We also handle emergency breakdown situations across Gurgaon — if your bike, scooty or car stops near Sector 14 or anywhere on the way to Sector 56, call us and we dispatch a mechanic to your exact location as soon as possible. From battery replacement and brake pad changes to clutch cable adjustment and tyre puncture repair, our technicians fix it all on the spot without towing. Garage Fix Care has completed over 1,00,000 services across Gurgaon and Delhi NCR, earning a consistent 4.7-star Google rating for professionalism, punctuality and honest pricing. Book your bike, scooty or car service in Sector 14, Sector 29, Sector 56, Sector 57, DLF Phase 1, DLF Phase 2, DLF Phase 3, DLF Phase 4, DLF Phase 5, Golf Course Road, Sohna Road, MG Road or Cyber City today via our website, WhatsApp or direct call — and discover the convenience of professional doorstep vehicle care starting at just ₹299 for bike and scooty service.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Gurgaon
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Gurgaon&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM and more — right at your home or office near Sector 14 and Cyber City.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Gurgaon" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to residents and professionals across Gurgaon, DLF Phase 1 to DLF Phase 5, Cyber City and Golf Course Road — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced in Gurgaon is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your vehicle running at its best — starting at ₹299 for bike and scooty service, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Gurgaon" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Surendra Singh', img: testimonial1, text: 'Excellent doorstep service in DLF Phase 1. Professional and knowledgeable mechanic.', time: 'a month ago' },
                { name: 'Dharmendra Gupta', img: testimonial2, text: 'Transparent billing with video evidence, booked near Sector 29. Very reliable.', time: 'a month ago' },
                { name: 'Rohit Prasad', img: testimonial3, text: 'Great service near Golf Course Road, convenient and affordable.', time: 'a month ago' },
                { name: 'Prabhjeet Sharma', img: testimonial4, text: 'Quick response near Cyber City, professional mechanic. Will recommend.', time: 'a month ago' },
              ].map(t => (
        ...
        {/* FAQs (Gurgaon specific — matches FAQPage schema exactly) */}
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in Gurgaon — <span className="text-red-600">Common Questions</span>
            </motion.h2>
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike, Scooty or Car Service in Gurgaon Today
            </h2>
            <p className="text-sm sm:text-base text-white mb-3 sm:mb-5 max-w-xl mx-auto">
              Same-day doorstep service across Gurgaon and nearby areas starting at ₹299. Our mechanic comes to you — no travel, no waiting, no hidden charges.
            </p>
            <a
              href="https://www.garagefixcare.in/bookservice"
