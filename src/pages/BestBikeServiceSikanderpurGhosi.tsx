// BestBikeServiceSikanderpurGhosi.tsx
// Sikanderpur Ghosi specific SEO/content + Delhi Cantt master design system
...
const BestBikeServiceSikanderpurGhosi = () => {
  ...
  // Hot Deals marquee images — Sikanderpur Ghosi specific copy/alt text
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Sikanderpur Ghosi, Gurugram' },
    { src: hotDealsImage2, alt: 'Doorstep scooty service near Sikanderpur Metro Station' },
    { src: hotDealsImage3, alt: 'Car engine repair near Cyber Hub, Gurgaon' },
    { src: hotDealsImage4, alt: 'Roadside vehicle assistance near MG Road' },
    { src: hotDealsImage5, alt: 'Doorstep bike and car repair deal near IFFCO Chowk' },
  ];
  const hotDealsAreaBadges = ['Sikanderpur Ghosi', 'Sikanderpur Metro', 'MG Road', 'Cyber Hub', 'DLF Phase 2', 'IFFCO Chowk'];
  ...
  const coveredAreas = [
    'Sikanderpur Ghosi', 'Sikanderpur Metro Station', 'DLF Phase 2', 'DLF Phase 3',
    'MG Road', 'Cyber Hub', 'Udyog Vihar', 'Golf Course Road',
    'Nathupur', 'Bristol Chowk', 'IFFCO Chowk',
  ];
  ...
  const faqs = [
    {
      q: 'What is the best bike, scooty and car service in Sikanderpur Ghosi?',
      a: "Garage Fix Care is Sikanderpur Ghosi's trusted doorstep service for bikes, scooties and cars, starting at just ₹299 for bike and scooty service, with certified mechanics, transparent pricing, genuine parts and a 10-day service guarantee.",
    },
    {
      q: 'How much does bike, scooty or car service cost in Sikanderpur Ghosi?',
      a: 'Bike and scooty service in Sikanderpur Ghosi starts from ₹299 for 100–125cc vehicles (Regular Service). Classic Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Royal Service (350–450 CC) is ₹599, and Sports Service (above 500 CC) is ₹999, all with labour included and no hidden charges. Car service is quote-based and depends on your car model and the work required.',
    },
    {
      q: 'Do you provide car service in Sikanderpur Ghosi too?',
      a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing and repairs in Sikanderpur Ghosi and nearby Gurugram areas. Car service is quoted transparently based on your car model and the specific work needed — just book online or call us for a quote.',
    },
    {
      q: 'Do you provide doorstep bike and scooty repair near Sikanderpur Metro Station?',
      a: 'Yes, we provide complete doorstep bike and scooty repair around Sikanderpur Metro Station, Sikanderpur Ghosi and the wider DLF Phase 2 / DLF Phase 3 belt. Our certified mechanics arrive with tools, oils and common spare parts — no garage visit needed.',
    },
    {
      q: 'Which areas near Sikanderpur Ghosi are covered for bike, scooty and car service?',
      a: 'We cover Sikanderpur Ghosi, Sikanderpur Metro Station, DLF Phase 2, DLF Phase 3, MG Road, Cyber Hub, Udyog Vihar, Golf Course Road, Nathupur, Bristol Chowk and IFFCO Chowk for bikes, scooties and cars.',
    },
    {
      q: 'Do you service Royal Enfield and other major bike brands near MG Road?',
      a: 'Yes. We specialise in Royal Enfield servicing across Sikanderpur Ghosi and MG Road — Classic 350, Bullet 350, Meteor 350, Hunter 350 and Himalayan — and we also handle Hero, Honda, Bajaj, TVS, Suzuki, Yamaha and KTM models at your doorstep.',
    },
    {
      q: 'How quickly can a mechanic reach me in Sikanderpur Ghosi?',
      a: 'Our mechanics typically reach locations around Sikanderpur Ghosi, MG Road and the DLF Phase 2 / Phase 3 belt within 2–4 hours of booking, subject to availability and traffic. For urgent breakdowns, call us and we will prioritise your slot.',
    },
    {
      q: 'Is your bike, scooty and car service pricing transparent in Sikanderpur Ghosi?',
    ...
    {
      q: 'Do you provide service near Cyber Hub and DLF Phase 2 / DLF Phase 3?',
      a: 'Yes. Cyber Hub, DLF Phase 2 and DLF Phase 3 all fall within our doorstep service zone for bikes, scooties and cars, with mechanics reaching you typically within 2–4 hours of booking.',
    },
    {
      q: 'Do you offer a warranty on bike, scooty and car service in Sikanderpur Ghosi?',
      a: 'Every service by Garage Fix Care in Sikanderpur Ghosi includes a 10-day hassle-free service guarantee, whether it is a bike, scooty or car. If any issue arises post-service, we address it at no extra cost.',
    },
    {
      q: 'How do I book a bike, scooty or car mechanic near me in Sikanderpur Ghosi?',
      a: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Let us know whether it is a bike, scooty or car, share your area near Sikanderpur Ghosi and preferred time slot — we handle the rest.',
    },
    {
      q: 'What payment methods are accepted in Sikanderpur Ghosi?',
  ...
  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in Sikanderpur Ghosi | Doorstep Service Just ₹299"
        description="Garage Fix Care offers doorstep bike, scooty and car service in Sikanderpur Ghosi, Gurugram, and nearby areas including Sikanderpur Metro Station, MG Road, Cyber Hub, DLF Phase 2, DLF Phase 3, Udyog Vihar, Golf Course Road, Nathupur, Bristol Chowk and IFFCO Chowk, starting at just ₹299. Certified mechanics and same-day service at your doorstep."
        ...
        og={{
          ...
          imageAlt: 'Best bike, scooty and car service in Sikanderpur Ghosi at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in Sikanderpur Ghosi, MG Road and Cyber Hub',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Sikanderpur Ghosi, Gurugram. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299 for bike and scooty service.',
            url: 'https://www.garagefixcare.in/best-bike-service-sikanderpur-ghosi',
            ...
            address: {
              '@type': 'PostalAddress',
              addressLocality: 'Sikanderpur Ghosi, Gurugram',
              addressRegion: 'Haryana',
              addressCountry: 'IN',
            },
            geo: { '@type': 'GeoCoordinates', latitude: '28.4794', longitude: '77.0937' },
            areaServed: [
              { '@type': 'Place', name: 'Sikanderpur Ghosi' },
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Doorstep Bike, Scooty and Car Service in Sikanderpur Ghosi',
            provider: { '@type': 'LocalBusiness', name: 'Garage Fix Care' },
            areaServed: 'Sikanderpur Ghosi, Gurugram',
            description: 'At-home bike, scooty and car servicing across Sikanderpur Ghosi and nearby Gurugram areas including Sikanderpur Metro Station, MG Road, Cyber Hub, DLF Phase 2, DLF Phase 3, Udyog Vihar, Golf Course Road, Nathupur, Bristol Chowk and IFFCO Chowk. Bike and scooty service starts at ₹299, covering oil change, engine repair, battery replacement, brake repair, tyre service and puncture fix. Car service is quote-based and depends on the car model and work required — same-day doorstep service.',
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Best Bike, Scooty and Car Service in Sikanderpur Ghosi', item: 'https://www.garagefixcare.in/best-bike-service-sikanderpur-ghosi' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Sikanderpur Ghosi specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in Sikanderpur Ghosi
                ...
                >
                  Trusted by residents and businesses around Sikanderpur Ghosi, Sikanderpur Metro Station, MG Road, Cyber Hub, DLF Phase 2, DLF Phase 3 and nearby areas — our certified mechanics handle bikes, scooties and cars right at your doorstep.
                </motion.p>
              </motion.div>
        ...
        {/* Dark premium information strip — Sikanderpur Ghosi specific copy */}
        <motion.div
          className="w-full"
          style={{
        ...
        {/* Hot Deals This Week — Sikanderpur Ghosi specific copy, Delhi Cantt-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Limited-time offer for Sikanderpur Ghosi, MG Road and Cyber Hub customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-white/70 max-w-xl mx-auto">Service support for leading two-wheeler brands across Sikanderpur Ghosi and Gurugram.</p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Sikanderpur Ghosi pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service in Sikanderpur Ghosi and nearby Gurugram areas, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Areas Covered — Sikanderpur Ghosi localities */}
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              We Cover All Major Areas in <span className="text-red-600">Sikanderpur Ghosi</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you live in Sikanderpur Ghosi, near Sikanderpur Metro Station, around DLF Phase 2 or DLF Phase 3, close to MG Road, Cyber Hub, Udyog Vihar, Golf Course Road, Nathupur, Bristol Chowk or IFFCO Chowk, our bike, scooty and car mechanics typically reach your doorstep within 2–4 hours, subject to availability. Same-day doorstep service is available across the Sikanderpur Ghosi belt, starting at ₹299 for bike and scooty service.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Bike, Scooty &amp; Car Care, <span className="text-red-600">Right at Your Door in Sikanderpur Ghosi</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Sikanderpur Ghosi mechanics handle bikes, scooties and cars at your location, starting at ₹299 for bike and scooty service. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              {bikeServiceCards.map((service, index) => (
                ...
                >
                  <img
                    src={service.img}
                    alt={`${service.name} in Sikanderpur Ghosi`}
        ...
        {/* Comprehensive SEO Content (Sikanderpur Ghosi specific) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in Sikanderpur Ghosi</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>Sikanderpur Ghosi sits at the busy crossroads of Gurugram, wedged between the residential towers of DLF Phase 2 and DLF Phase 3, the commercial corridor of Udyog Vihar, and the employment hubs of Cyber Hub and MG Road. Riders here move fast — commuting between home and office, navigating the IFFCO Chowk and Bristol Chowk junctions daily, and crossing through the Sikanderpur Metro Station corridor. Vehicle owners in this area deserve a bike, scooty and car service that respects their time and matches the pace of Gurugram life — reliable, transparent and delivered right at the doorstep. Garage Fix Care is Sikanderpur Ghosi&apos;s trusted doorstep vehicle service, bringing certified and background-verified mechanics directly to your home, society parking or office, whether you are based near Nathupur, close to Golf Course Road, or just off the Sikanderpur Metro stretch. Our mechanics typically reach your location within 2–4 hours of booking, subject to availability. Doorstep bike and scooty service starts at just ₹299 — covering all essential checks including engine oil change, air filter cleaning, spark plug inspection, brake adjustment and basic electrical check — with every task completed on the spot. We also handle car servicing and repairs at your doorstep, with pricing quoted based on your car&apos;s model and requirement. We service every major two-wheeler brand seen across the Sikanderpur belt: Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM and more, from daily commuters and family scooties like the Honda Activa, TVS Jupiter and Suzuki Access, to premium machines like the Royal Enfield Classic 350 and KTM Duke 390, alongside popular hatchbacks and sedans. What distinguishes us as the best bike, scooty and car service in Sikanderpur Ghosi is our strict pricing transparency — you receive a full itemised estimate before a single tool is touched, ensuring zero hidden charges at the end. We use only genuine engine oils from Motul and Wurth, paired with manufacturer-approved spare parts, and each service is backed by our 10-day hassle-free service guarantee.</p>
              <p>The stop-start traffic at IFFCO Chowk and Bristol Chowk, combined with Gurugram&apos;s construction dust and seasonal heat, wears down engine oil, air filters, tyres and brakes far faster than the service manual suggests — making regular servicing a genuine safety necessity for bikes, scooties and cars alike. Our mechanics carry professional diagnostic tools to identify emerging issues before they become expensive failures, significantly extending your vehicle&apos;s lifespan whether you commute daily through MG Road or just occasionally ride into Cyber Hub. We also handle emergency breakdown situations across Sikanderpur Ghosi — if your bike, scooty or car stops near the Sikanderpur Metro Station or anywhere on the way to Udyog Vihar, call us and we dispatch a mechanic to your exact location as soon as possible. From battery replacement and brake pad changes to clutch cable adjustment and tyre puncture repair, our technicians fix it all on the spot without towing. Garage Fix Care has completed over 1,00,000 services across Gurugram and Delhi NCR, earning a consistent 4.7-star Google rating for professionalism, punctuality and honest pricing. Book your bike, scooty or car service in Sikanderpur Ghosi, Sikanderpur Metro Station, DLF Phase 2, DLF Phase 3, MG Road, Cyber Hub, Udyog Vihar, Golf Course Road, Nathupur, Bristol Chowk or IFFCO Chowk today via our website, WhatsApp or direct call — and discover the convenience of professional doorstep vehicle care starting at just ₹299 for bike and scooty service.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Sikanderpur Ghosi
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Sikanderpur Ghosi&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM and more — right at your home or office near Sikanderpur Metro Station, MG Road and Cyber Hub.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Sikanderpur Ghosi" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to residents and businesses of Sikanderpur Ghosi, DLF Phase 2, DLF Phase 3 and Cyber Hub — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced in Sikanderpur Ghosi is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your vehicle running at its best — starting at ₹299 for bike and scooty service, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Sikanderpur Ghosi" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                ...
                { name: 'Rohit Prasad', img: testimonial3, text: 'My bike broke down near Cyber Hub. GarageFixCare reached me quickly. Lifesaver.', time: 'a month ago' },
        ...
        {/* FAQs (Sikanderpur Ghosi specific — matches FAQPage schema exactly) */}
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in Sikanderpur Ghosi — <span className="text-red-600">Common Questions</span>
            </motion.h2>
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Your Bike, Scooty or Car Service in Sikanderpur Ghosi Today
            </h2>
            <p className="text-sm sm:text-base text-white mb-3 sm:mb-5 max-w-xl mx-auto">
              Same-day doorstep service across Sikanderpur Ghosi and nearby Gurugram areas starting at ₹299. Our mechanic comes to you — no travel, no waiting, no hidden charges.
            </p>
            <a
              href="https://www.garagefixcare.in/bookservice"
