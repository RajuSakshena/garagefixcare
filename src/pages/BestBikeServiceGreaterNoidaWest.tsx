// BestBikeServiceGreaterNoidaWest.tsx
// Greater Noida West specific SEO/content + Home.tsx design system (video hero, Framer Motion, marquees)
...
// Greater Noida West specific / existing assets — kept from the original page
...
const BestBikeServiceGreaterNoidaWest = () => {
  ...
  // Hot Deals marquee images — Greater Noida West specific copy/alt text, Home-style assets
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Greater Noida West' },
    { src: hotDealsImage2, alt: 'Doorstep bike service near Gaur City' },
    { src: hotDealsImage3, alt: 'Bike engine repair near Cherry County' },
    { src: hotDealsImage4, alt: 'Roadside bike assistance near Ace City' },
    { src: hotDealsImage5, alt: 'Doorstep bike repair deal near Techzone 4' },
  ];
  const hotDealsAreaBadges = ['Greater Noida West', 'Gaur City', 'Cherry County', 'Ace City', 'Noida Extension', 'Techzone 4'];
  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Greater Noida West specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Trusted by residents across Gaur City 1, Gaur City 2, Cherry County, Ace City, Supertech Eco Village, Bisrakh, Techzone 4, Nirala Estate and Ek Murti Chowk — our expert mechanics handle everything from oil change to engine overhaul, right at your doorstep.
                </motion.p>
              </motion.div>
        ...
        {/* Dark premium information strip — Greater Noida West specific copy */}
        <motion.div
          className="w-full"
          style={{
          ...
          <div className="max-w-[1100px] mx-auto px-[14px] py-[10px] sm:px-6 sm:py-3.5 relative overflow-hidden">
            ...
            <span className="relative inline-flex items-center gap-1.5 mb-1">
              ...
              <span className="text-[8px] sm:text-[9px] font-semibold uppercase tracking-wider" style={{ color: '#ff7a00' }}>
                Garage Fix Care — Greater Noida West
              </span>
            </span>
            <p className="relative text-[10px] sm:text-sm leading-[1.4] sm:leading-relaxed" style={{ color: '#cbd5e1' }}>
              Skip the garage queue. Our certified mechanics come to your society, home or office across Gaur City 1, Gaur City 2, Cherry County, Ace City, Supertech Eco Village, Bisrakh, Techzone 4, Nirala Estate and Ek Murti Chowk — handling everything from routine servicing to engine repairs. Fast, transparent, and affordable.
            </p>
          </div>
        </motion.div>
        ...
        {/* Hot Deals This Week — Greater Noida West specific copy, Home-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Limited-time offer for Greater Noida West and Noida Extension customers! Get up to 10% off on bike repairs and servicing at your doorstep. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Greater Noida West pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike service across Greater Noida West and Noida Extension. Check the labour charges below based on your bike&apos;s engine size — no hidden fees, no surprises.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Areas Covered — Greater Noida West societies */}
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              We Cover All Major Societies in <span className="text-red-600">Greater Noida West</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you live in Gaur City 1, Gaur City 2, Cherry County, Ace City, Supertech Eco Village, near Bisrakh, Techzone 4, Nirala Estate, or close to Ek Murti Chowk, our bike mechanics reach your doorstep within 2-4 hours. Same-day bike service available across Greater Noida West and Noida Extension.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Bike Care, <span className="text-red-600">Right at Your Door in Greater Noida West</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Greater Noida West mechanics handle it all at your location. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              {bikeServiceCards.map((service, index) => (
                ...
                >
                  <img
                    src={service.img}
                    alt={`${service.name} in Greater Noida West`}
        ...
        {/* Comprehensive Bike Service Content (Greater Noida West specific, 1000+ words) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike Service in Greater Noida West</span>
            </motion.h2>
            <motion.div
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Greater Noida West
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Greater Noida West&apos;s trusted doorstep bike service. We service all motorcycle and scooter brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM, and more — right at your home or society.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Greater Noida West" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics directly to residents of Greater Noida West and Noida Extension — honest pricing, genuine parts, zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike serviced in Greater Noida West is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your bike running at its best — all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Greater Noida West" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Ankit Verma', img: testimonial1, text: 'Booked a service for my bike in Gaur City 2, mechanic arrived on time and finished quickly.', time: '3 weeks ago' },
                { name: 'Shalini Tyagi', img: testimonial2, text: 'Transparent pricing, no extra charges. Got it serviced at Cherry County itself.', time: 'a month ago' },
                { name: 'Vivek Chauhan', img: testimonial3, text: 'Great doorstep service near Ace City, saved me a trip to the workshop.', time: 'a month ago' },
                { name: 'Pooja Singh', img: testimonial4, text: 'Quick and professional mechanic near Supertech Eco Village. Highly recommend.', time: '2 months ago' },
              ].map(t => (
        ...
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike Service in Greater Noida West — <span className="text-red-600">Common Questions</span>
            </motion.h2>
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike Service in Greater Noida West Today
            </h2>
