// BestBikeServiceKashmereGate.tsx
// Kashmere Gate specific SEO/content + Home.tsx design system (video hero, Framer Motion, marquees)
...
// Kashmere Gate specific / existing assets — kept from the master page
...
const BestBikeServiceKashmereGate = () => {
  ...
  // Hot Deals marquee images — Kashmere Gate specific copy/alt text, Home-style assets
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Kashmere Gate' },
    { src: hotDealsImage2, alt: 'Doorstep scooty service near Kashmere Gate ISBT' },
    { src: hotDealsImage3, alt: 'Car engine repair near Mori Gate and Tis Hazari' },
    { src: hotDealsImage4, alt: 'Roadside vehicle assistance near Civil Lines and Yamuna Bazar' },
    { src: hotDealsImage5, alt: 'Doorstep bike repair deal near Chandni Chowk and Old Delhi' },
  ];
  const hotDealsAreaBadges = ['Kashmere Gate', 'ISBT', 'Mori Gate', 'Civil Lines', 'Tis Hazari', 'Chandni Chowk'];
  ...
  // Service Available marquee — Kashmere Gate specific phrases
  const serviceCities = [
    { name: 'Bike Service in Kashmere Gate', color: 'text-indigo-700' },
    { name: 'Scooty Service in Kashmere Gate', color: 'text-red-700' },
    { name: 'Car Service in Kashmere Gate', color: 'text-teal-700' },
    { name: 'Doorstep Vehicle Service in Kashmere Gate', color: 'text-gray-900' },
    { name: 'Bike Repair in Kashmere Gate', color: 'text-orange-700' },
    { name: 'Scooty Repair in Kashmere Gate', color: 'text-slate-700' },
    { name: 'Car Repair in Kashmere Gate', color: 'text-blue-800' },
    { name: 'Same-Day Vehicle Service in Kashmere Gate', color: 'text-emerald-700' },
    { name: 'Bike Service near Kashmere Gate ISBT', color: 'text-purple-700' },
    { name: 'Scooty Service near Kashmere Gate Metro', color: 'text-pink-700' },
    { name: 'Car Service near Mori Gate', color: 'text-cyan-700' },
  ];

  // Areas Covered — Kashmere Gate and nearby service areas
  const coveredAreas = [
    'Kashmere Gate', 'Kashmere Gate Main Road', 'Kashmere Gate Metro Station', 'Kashmere Gate ISBT',
    'ISBT Kashmere Gate', 'ISBT Road', 'Mori Gate', 'Mori Gate Bus Stand', 'Mori Gate Terminal',
    'Shamnath Marg', 'Kudasiya Park', 'Yamuna Bazar', 'Yamuna Bazaar', 'Civil Lines', 'Under Hill Road',
    'Tis Hazari', 'Tis Hazari Court', 'Old Delhi', 'Chandni Chowk', 'Lal Qila / Red Fort',
    'Delhi Junction / Old Delhi Railway Station', "St. James' Church", 'Kashmere Gate University Area',
    'Delhi University North Campus', 'Kamla Nehru Ridge', 'Bela Road', 'Rajpur Road', 'Alipur Road',
    'Subzi Mandi', 'Sabzi Mandi', 'Sadar Bazaar', 'Bara Hindu Rao', 'Pul Mithai', 'Lahori Gate',
    'Fatehpuri', 'Daryaganj', 'Jama Masjid', 'Civil Lines Metro',
  ];

  // City Coverage / Internal Links
  const cityPages = [
    { name: 'Delhi', path: '/best-bike-service-delhi' },
    { name: 'Chandni Chowk', path: '/best-bike-service-chandni-chowk' },
    { name: 'Civil Lines', path: '/best-bike-service-civil-lines' },
    { name: 'Sadar Bazaar', path: '/best-bike-service-sadar-bazaar' },
    { name: 'Daryaganj', path: '/best-bike-service-daryaganj' },
    { name: 'Karol Bagh', path: '/best-bike-service-karol-bagh' },
    { name: 'Shastri Nagar', path: '/best-bike-service-shastri-nagar' },
    { name: 'Pitampura', path: '/best-bike-service-pitampura' },
    { name: 'NSP', path: '/best-bike-service-nsp' },
  ...
  const faqs = [
    { q: 'What is the best bike, scooty and car service in Kashmere Gate?', a: 'Garage Fix Care is Kashmere Gate\'s highest-rated doorstep service for bikes, scooties and cars, starting at ₹299 with certified mechanics, transparent pricing, genuine parts, and a 10-day service guarantee.' },
    { q: 'How much does bike or scooty service cost in Kashmere Gate, Delhi?', a: 'Bike and scooty service in Kashmere Gate at Garage Fix Care starts from ₹299 for 100–125cc vehicles (Regular Service). Classic Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Royal Service (350–450 CC) is ₹599, and Sports Service (above 500 CC) is ₹999. All prices include labour with zero hidden charges.' },
    { q: 'Do you provide car service in Kashmere Gate too?', a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing in Kashmere Gate and nearby areas like Civil Lines, Mori Gate and Chandni Chowk. Car service pricing is quoted based on your car\'s model and the work required — just book online or call us for a quote.' },
    { q: 'Do you provide doorstep bike and scooty repair near Kashmere Gate ISBT?', a: 'Yes, we provide complete doorstep bike and scooty repair across Kashmere Gate, ISBT Kashmere Gate, ISBT Road and the surrounding area. Our certified mechanics arrive with all tools, oils, and parts — no garage visit needed.' },
    { q: 'Which areas near Kashmere Gate are covered for bike, scooty and car service?', a: 'We cover Kashmere Gate, Kashmere Gate ISBT, ISBT Road, Mori Gate, Shamnath Marg, Yamuna Bazar, Civil Lines, Under Hill Road, Tis Hazari, Old Delhi, Chandni Chowk, Delhi Junction, Delhi University North Campus, Subzi Mandi, Sadar Bazaar, Daryaganj, Jama Masjid, and many more nearby service areas.' },
    { q: 'Do you service Royal Enfield bikes near Kashmere Gate?', a: 'Yes. We specialise in Royal Enfield servicing across Kashmere Gate and nearby Civil Lines and Tis Hazari — Classic 350, Bullet 350, Meteor 350, Himalayan, and Thunderbird — all serviced at your doorstep.' },
    { q: 'How quickly can a mechanic reach me in Kashmere Gate?', a: 'Our mechanics typically reach your location in Kashmere Gate or nearby Mori Gate, Civil Lines and Tis Hazari within 2–4 hours of booking, for bikes, scooties and cars alike. For urgent requests, call us and we will prioritise your slot.' },
    { q: 'Is your bike, scooty and car service pricing transparent in Kashmere Gate?', a: 'Absolutely. We provide a full itemised cost estimate before starting any work, whether it\'s a bike, scooty or car. No surprise bills — what you see is exactly what you pay.' },
    { q: 'Do you service scooties near Chandni Chowk and Daryaganj?', a: 'Yes. We repair and service all scooties near Chandni Chowk, Daryaganj and Old Delhi — Honda Activa, TVS Jupiter, Suzuki Access 125, Honda Dio, Hero Maestro — all at your doorstep.' },
    { q: 'Do you offer a warranty on bike, scooty and car service in Kashmere Gate?', a: 'Every service by Garage Fix Care in Kashmere Gate includes a 10-day hassle-free service guarantee, whether it\'s a bike, scooty or car. If any issue arises post-service, we address it at no extra cost.' },
    { q: 'How do I book a bike, scooty or car mechanic near me in Kashmere Gate?', a: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Let us know whether it\'s a bike, scooty or car, share your area near Kashmere Gate and preferred time slot — we handle the rest.' },
    { q: 'What payment methods are accepted in Kashmere Gate?', a: 'We accept cash, UPI (Google Pay, PhonePe, Paytm), and all major mobile wallets. Payment is collected only after the service is complete.' },
    { q: 'Do I need to arrange any tools or oils?', a: 'No. Our Kashmere Gate mechanics arrive fully equipped — tools, genuine Motul/Wurth engine oils, and all required spare parts are brought to your doorstep, for bikes, scooties and cars.' },
    { q: 'Do you handle emergency bike, scooty or car breakdown near Kashmere Gate Metro or ISBT?', a: 'Yes. If your bike, scooty or car breaks down anywhere near Kashmere Gate Metro Station, ISBT Kashmere Gate or Mori Gate, call us immediately and we dispatch a mechanic to your location.' },
    { q: 'What makes Garage Fix Care better than a local Kashmere Gate workshop?', a: 'We come to you for bikes, scooties and cars, save your travel time, offer transparent itemised billing, use genuine parts, and provide a 10-day warranty — something most local Kashmere Gate workshops cannot match.' },
  ];

  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in Kashmere Gate | Doorstep Service Just ₹299"
        description="Garage Fix Care offers doorstep bike, scooty and car service in Kashmere Gate, Delhi, Civil Lines, Mori Gate, Tis Hazari and nearby areas, starting at just ₹299. Certified mechanics, same-day service at your home."
        canonical="https://www.garagefixcare.in/best-bike-service-kashmere-gate"
        robots="index, follow"
        og={{
          url: 'https://www.garagefixcare.in/best-bike-service-kashmere-gate',
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Best bike, scooty and car service in Kashmere Gate at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in Kashmere Gate, Civil Lines and Mori Gate',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Kashmere Gate, Delhi. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299.',
            url: 'https://www.garagefixcare.in/best-bike-service-kashmere-gate',
            ...
            address: {
              '@type': 'PostalAddress',
              addressLocality: 'Kashmere Gate, New Delhi',
              addressRegion: 'Delhi',
              addressCountry: 'IN',
            },
            geo: { '@type': 'GeoCoordinates', latitude: '28.6675', longitude: '77.2283' },
            areaServed: [
              { '@type': 'Place', name: 'Kashmere Gate' },
              { '@type': 'Place', name: 'Kashmere Gate Metro Station' },
              { '@type': 'Place', name: 'Kashmere Gate ISBT' },
              { '@type': 'Place', name: 'ISBT Road' },
              { '@type': 'Place', name: 'Mori Gate' },
              { '@type': 'Place', name: 'Shamnath Marg' },
              { '@type': 'Place', name: 'Yamuna Bazar' },
              { '@type': 'Place', name: 'Civil Lines' },
              { '@type': 'Place', name: 'Under Hill Road' },
              { '@type': 'Place', name: 'Tis Hazari' },
              { '@type': 'Place', name: 'Old Delhi' },
              { '@type': 'Place', name: 'Chandni Chowk' },
              { '@type': 'Place', name: 'Delhi Junction / Old Delhi Railway Station' },
              { '@type': 'Place', name: 'Delhi University North Campus' },
              { '@type': 'Place', name: 'Subzi Mandi' },
              { '@type': 'Place', name: 'Sadar Bazaar' },
              { '@type': 'Place', name: 'Daryaganj' },
              { '@type': 'Place', name: 'Jama Masjid' },
            ],
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Doorstep Bike, Scooty and Car Service in Kashmere Gate',
            provider: { '@type': 'LocalBusiness', name: 'Garage Fix Care' },
            areaServed: 'Kashmere Gate, New Delhi',
            description: 'At-home bike, scooty and car servicing starting at ₹299 across Kashmere Gate, Kashmere Gate ISBT, ISBT Road, Mori Gate, Shamnath Marg, Yamuna Bazar, Civil Lines, Under Hill Road, Tis Hazari, Old Delhi, Chandni Chowk, Delhi Junction, Delhi University North Campus, Subzi Mandi, Sadar Bazaar, Daryaganj and Jama Masjid. Oil change, engine repair, battery replacement, puncture fix and car maintenance — same-day doorstep service.',
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Kashmere Gate', item: 'https://www.garagefixcare.in/best-bike-service-kashmere-gate' },
              { '@type': 'ListItem', position: 4, name: 'Best Bike, Scooty and Car Service in Kashmere Gate', item: 'https://www.garagefixcare.in/best-bike-service-kashmere-gate' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Kashmere Gate specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in Kashmere Gate
        ...
        {/* Dark premium information strip — Kashmere Gate specific copy */}
        <motion.div
          className="w-full"
          style={{
          ...
          <div className="max-w-[1100px] mx-auto px-[14px] py-[10px] sm:px-6 sm:py-3.5 relative overflow-hidden">
            ...
            <span className="relative inline-flex items-center gap-1.5 mb-1">
              ...
              <span className="text-[8px] sm:text-[9px] font-semibold uppercase tracking-wider" style={{ color: '#ff7a00' }}>
                Garage Fix Care — Kashmere Gate, Delhi
              </span>
            </span>
            <p className="relative text-[10px] sm:text-sm leading-[1.4] sm:leading-relaxed" style={{ color: '#cbd5e1' }}>
              Skip the garage queue. Our certified mechanics come to your home, office or society across Kashmere Gate, Kashmere Gate ISBT, ISBT Road, Mori Gate, Shamnath Marg, Yamuna Bazar, Civil Lines, Under Hill Road, Tis Hazari, Old Delhi, Chandni Chowk, Delhi Junction, Delhi University North Campus, Subzi Mandi, Sadar Bazaar, Daryaganj and Jama Masjid — servicing bikes, scooties and cars, from routine maintenance to engine repairs, starting at ₹299. Fast, transparent, and affordable.
            </p>
          </div>
        </motion.div>

        {/* Marquee: Service Available in Kashmere Gate */}
        ...
        {/* Hot Deals This Week — Kashmere Gate specific copy, Home-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Limited-time offer for Kashmere Gate, Civil Lines and Mori Gate customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Kashmere Gate pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service near Kashmere Gate and Civil Lines, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service Areas in <span className="text-red-600">Kashmere Gate</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you live or work in Kashmere Gate, near Kashmere Gate ISBT, Kashmere Gate Metro Station, ISBT Road or Mori Gate, or in nearby service areas like Shamnath Marg, Yamuna Bazar, Civil Lines, Under Hill Road, Tis Hazari, Old Delhi, Chandni Chowk, Delhi Junction, Delhi University North Campus, Subzi Mandi, Sadar Bazaar, Daryaganj or Jama Masjid — our bike, scooty and car mechanics reach your doorstep within 2-4 hours. Same-day doorstep service available across the Kashmere Gate belt and nearby Central and North Delhi localities, starting at ₹299.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Bike, Scooty &amp; Car Care, <span className="text-red-600">Right at Your Door in Kashmere Gate</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Kashmere Gate mechanics handle bikes, scooties and cars at your location, starting at ₹299. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              {bikeServiceCards.map((service, index) => (
                ...
                >
                  <img
                    src={service.img}
                    alt={`${service.name} in Kashmere Gate`}
        ...
        {/* Comprehensive SEO Content (Kashmere Gate specific, 1000+ words) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in Kashmere Gate</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>Kashmere Gate is one of Delhi&apos;s oldest and busiest transit hubs — home to the historic Kashmere Gate ISBT, a major interchange of the Delhi Metro, and the gateway that connects Old Delhi with Civil Lines and the Delhi University North Campus. Thousands of commuters, students, and residents pass through Kashmere Gate daily, parking their bikes, scooties, and cars in and around ISBT Road, Mori Gate, Shamnath Marg, and Yamuna Bazar. Constant stop-and-go traffic on these roads, combined with dust from the nearby ridge and heritage areas, quickly wears down engine oil, brake pads, air filters, and tyres. Garage Fix Care is Kashmere Gate&apos;s most trusted doorstep vehicle service, bringing certified, background-verified mechanics directly to your home, office, or society — whether you live right beside the ISBT, in nearby Civil Lines, Tis Hazari, Old Delhi, or in surrounding localities like Subzi Mandi, Sadar Bazaar, Daryaganj, and Jama Masjid. Our mechanics reach your location within 2–4 hours of booking. Doorstep bike and scooty service in Kashmere Gate starts at just ₹299 — covering all essential checks including engine oil change, air filter cleaning, spark plug inspection, brake adjustment, and basic electrical check — with every task completed on the spot without you needing to ride to a workshop. We also handle car servicing and repairs at your doorstep, with pricing quoted based on your car&apos;s model and requirement. We service every major two-wheeler brand seen across Kashmere Gate: Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM, and more, handling everything from daily commuters and premium sports bikes to family scooties like the Honda Activa, TVS Jupiter, and Suzuki Access, alongside popular hatchbacks and sedans. What distinguishes us as the best bike, scooty and car service in Kashmere Gate is our strict pricing transparency — you receive a full itemised estimate before a single tool is touched, ensuring zero hidden charges at the end. We use only genuine engine oils from Motul and Wurth, paired with manufacturer-approved spare parts, and each service is backed by our 10-day hassle-free service guarantee.</p>
              <p>The dense traffic around Kashmere Gate ISBT, the narrow lanes of Mori Gate and Old Delhi, and the constant flow along Shamnath Marg and Tis Hazari accelerate wear on engine oil, air filters, tyres, and brakes — making regular servicing not just a good habit but a safety necessity for bikes, scooties, and cars alike. Our mechanics carry professional diagnostic tools to identify emerging issues before they become expensive failures, significantly extending your vehicle&apos;s lifespan whether you commute daily through Kashmere Gate Metro Station or just within the Civil Lines belt. We also handle emergency breakdown situations across Kashmere Gate — if your bike, scooty, or car stops near Delhi University North Campus or anywhere on the way toward Daryaganj or Jama Masjid, call us and we dispatch a mechanic to your exact location immediately. From battery replacement and brake pad changes to clutch cable adjustment and tyre puncture repair, our technicians fix it all on the spot. Garage Fix Care has completed over 1,00,000 services across Delhi NCR, earning a consistent 4.7-star Google rating for professionalism, punctuality, and honest pricing. Book your bike, scooty, or car service in Kashmere Gate, Kashmere Gate ISBT, ISBT Road, Mori Gate, Shamnath Marg, Yamuna Bazar, Civil Lines, Under Hill Road, Tis Hazari, Old Delhi, Chandni Chowk, Delhi Junction, Delhi University North Campus, Subzi Mandi, Sadar Bazaar, Daryaganj, or Jama Masjid today via our website, WhatsApp, or direct call — and discover the convenience of professional doorstep vehicle care starting at just ₹299.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Kashmere Gate
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Kashmere Gate&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM, and more — right at your home or office near Civil Lines and Tis Hazari.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Kashmere Gate" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to residents and professionals in Kashmere Gate, Civil Lines, and Tis Hazari — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced near Kashmere Gate is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your vehicle running at its best — starting at ₹299, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Kashmere Gate" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Vikram Bisht', img: testimonial1, text: 'Doorstep service near Kashmere Gate ISBT was fast and professional.', time: 'a month ago' },
                { name: 'Pooja Rathi', img: testimonial2, text: 'Transparent billing with video evidence, booked from Civil Lines. Very reliable.', time: 'a month ago' },
                { name: 'Ravinder Negi', img: testimonial3, text: 'Great service near Tis Hazari, convenient and affordable.', time: 'a month ago' },
                { name: 'Simran Kaur', img: testimonial4, text: 'Quick response near Chandni Chowk, professional mechanic. Will recommend.', time: 'a month ago' },
              ].map(t => (
        ...
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in Kashmere Gate — <span className="text-red-600">Common Questions</span>
            </motion.h2>
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike, Scooty or Car Service in Kashmere Gate Today
            </h2>
...
export default BestBikeServiceKashmereGate;