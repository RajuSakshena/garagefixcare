// BestBikeServiceRamaKrishnaPuram.tsx
// Rama Krishna Puram (R.K. Puram) specific SEO/content + Delhi Cantt master design system
...
const BestBikeServiceRamaKrishnaPuram = () => {
  ...
  // Hot Deals marquee images — Rama Krishna Puram specific copy/alt text
  const carouselImages = [
    { src: hotDealsImage1, alt: 'Bike service offer in Rama Krishna Puram, Delhi' },
    { src: hotDealsImage2, alt: 'Doorstep scooty service near R.K. Puram Sector 4' },
    { src: hotDealsImage3, alt: 'Car engine repair near Munirka' },
    { src: hotDealsImage4, alt: 'Roadside vehicle assistance near Dhaula Kuan' },
    { src: hotDealsImage5, alt: 'Doorstep vehicle repair deal near Vasant Vihar' },
  ];
  const hotDealsAreaBadges = ['R.K. Puram', 'Munirka', 'Vasant Vihar', 'Moti Bagh', 'Dhaula Kuan', 'Safdarjung Enclave'];
  ...
  const serviceCities = [
    { name: 'R.K. Puram', color: 'text-indigo-700' },
    { name: 'Munirka', color: 'text-red-700' },
    { name: 'Vasant Vihar', color: 'text-teal-700' },
    { name: 'Moti Bagh', color: 'text-gray-900' },
    { name: 'Dhaula Kuan', color: 'text-orange-700' },
    { name: 'Safdarjung Enclave', color: 'text-slate-700' },
  ];

  const coveredAreas = [
    'Rama Krishna Puram', 'R.K. Puram Sector 1', 'R.K. Puram Sector 2', 'R.K. Puram Sector 3',
    'R.K. Puram Sector 4', 'R.K. Puram Sector 5', 'R.K. Puram Sector 6', 'R.K. Puram Sector 7',
    'R.K. Puram Sector 8', 'R.K. Puram Sector 9', 'R.K. Puram Sector 10', 'R.K. Puram Sector 11',
    'R.K. Puram Sector 12', 'R.K. Puram Sector 13', 'Munirka', 'Munirka Village',
    'Munirka Enclave', 'Vasant Vihar', 'Vasant Enclave', 'Moti Bagh',
    'Shanti Niketan', 'Anand Niketan', 'Satya Niketan', 'South Campus',
    'Dhaula Kuan', 'Naraina', 'Naraina Vihar', 'Safdarjung Enclave',
    'Bhikaji Cama Place', 'Vasant Kunj', 'Ber Sarai', 'Rao Tula Ram Marg',
  ];
  ...
  const faqs = [
    {
      q: 'What is the best bike, scooty and car service in Rama Krishna Puram?',
      a: "Garage Fix Care is Rama Krishna Puram's trusted doorstep service for bikes, scooties and cars, starting at just ₹299 for bike and scooty service, with certified mechanics, transparent pricing, genuine parts and a 10-day service guarantee.",
    },
    {
      q: 'How much does bike or scooty service cost in R.K. Puram?',
      a: 'Bike and scooty service in Rama Krishna Puram starts from ₹299 for 100–125cc vehicles (At-Home Basic Service). Standard Service (135–200 CC) is ₹399, Premium Service (220–300 CC) is ₹499, Complete Care (350–450 CC) is ₹599, and Luxury Care (above 500 CC) is ₹999. All prices include labour with zero hidden charges.',
    },
    {
      q: 'Do you provide car service in Rama Krishna Puram too?',
      a: 'Yes. Alongside bikes and scooties, we offer doorstep car servicing and repairs in Rama Krishna Puram and nearby areas. Car service is quoted transparently based on your car model and the work required — just book online or call us for a quote.',
    },
    {
      q: 'Which R.K. Puram sectors are covered for doorstep service?',
      a: 'We cover R.K. Puram Sector 1 through Sector 13, along with nearby areas including Munirka, Munirka Village, Munirka Enclave, Vasant Vihar, Vasant Enclave, Moti Bagh, Shanti Niketan, Anand Niketan, Satya Niketan, South Campus, Dhaula Kuan, Naraina, Naraina Vihar, Safdarjung Enclave, Bhikaji Cama Place, Vasant Kunj, Ber Sarai and Rao Tula Ram Marg.',
    },
    {
      q: 'Do you provide doorstep service in R.K. Puram societies and apartments?',
      a: 'Yes. Our mechanics regularly service vehicles inside residential societies, DDA flats and apartment complexes across all R.K. Puram sectors. Share your society name, sector and gate number while booking — we come directly to your parking bay.',
    },
    {
      q: 'Do you handle emergency breakdown near Munirka or Dhaula Kuan?',
      a: 'Yes. If your bike, scooty or car breaks down near Munirka, Dhaula Kuan, Vasant Vihar or anywhere in the Rama Krishna Puram area, call us immediately and we dispatch a mechanic to your location for on-spot repair.',
    },
    {
      q: 'Do you provide doorstep vehicle service in Vasant Vihar and Moti Bagh?',
      a: 'Yes. Vasant Vihar, Moti Bagh, Shanti Niketan, Anand Niketan, Satya Niketan and Safdarjung Enclave all fall within our doorstep service zone for bikes, scooties and cars. Same-day doorstep service is available subject to location and technician availability.',
    },
    {
      q: 'Do you service Royal Enfield and other major bike brands in Rama Krishna Puram?',
      a: 'Yes. We specialise in Royal Enfield servicing across Rama Krishna Puram — Classic 350, Bullet 350, Meteor 350, Hunter 350 and Himalayan — and we also handle Hero, Honda, Bajaj, TVS, Suzuki, Yamaha and KTM models at your doorstep.',
    },
    {
      q: 'Is your bike, scooty and car service pricing transparent in R.K. Puram?',
    ...
    {
      q: 'Do you offer a warranty on bike, scooty and car service in Rama Krishna Puram?',
      a: 'Every service by Garage Fix Care in Rama Krishna Puram includes a 10-day hassle-free service guarantee, whether it is a bike, scooty or car. If any issue arises post-service, we address it at no extra cost.',
    },
    {
      q: 'Do you provide free pickup and drop for service in Rama Krishna Puram?',
    ...
    {
      q: 'How do I book a bike, scooty or car mechanic near me in Rama Krishna Puram?',
      a: 'You can book via our website, WhatsApp us on 9540553759, or call directly. Let us know whether it is a bike, scooty or car, share your R.K. Puram sector or nearby area, and your preferred time slot — we handle the rest.',
    },
  ];
  ...
  return (
    <>
      <SEOHelmet
        title="Best Bike, Scooty and Car Service in Rama Krishna Puram | Doorstep Service Just ₹299"
        description="Garage Fix Care offers doorstep bike, scooty and car service in Rama Krishna Puram (R.K. Puram), Delhi, covering R.K. Puram Sector 1 to Sector 13, Munirka, Vasant Vihar, Moti Bagh, Shanti Niketan, Anand Niketan, Satya Niketan, Dhaula Kuan and Safdarjung Enclave, starting at just ₹299. Certified mechanics, transparent pricing and same-day doorstep service."
        canonical="https://www.garagefixcare.in/best-bike-service-rama-krishna-puram"
        robots="index, follow"
        og={{
          url: 'https://www.garagefixcare.in/best-bike-service-rama-krishna-puram',
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Best bike, scooty and car service in Rama Krishna Puram at doorstep by Garage Fix Care',
          type: 'website',
        }}
        twitter={{
          image: 'https://www.garagefixcare.in/og-banner.png',
          imageAlt: 'Doorstep bike, scooty and car service in R.K. Puram, Munirka and Vasant Vihar',
        }}
        structuredData={[
          {
            ...
            description: 'Best bike, scooty and car service in Rama Krishna Puram (R.K. Puram), Delhi. Doorstep repair, servicing, oil change and battery replacement for bikes, scooties and cars, starting at just ₹299 for bike and scooty service.',
            url: 'https://www.garagefixcare.in/best-bike-service-rama-krishna-puram',
            ...
            address: {
              '@type': 'PostalAddress',
              addressLocality: 'Rama Krishna Puram, New Delhi',
              addressRegion: 'Delhi',
              addressCountry: 'IN',
            },
            geo: { '@type': 'GeoCoordinates', latitude: '28.5654', longitude: '77.1769' },
            areaServed: [
              { '@type': 'Place', name: 'Rama Krishna Puram' },
              { '@type': 'Place', name: 'R.K. Puram Sector 1' },
              { '@type': 'Place', name: 'R.K. Puram Sector 2' },
              { '@type': 'Place', name: 'R.K. Puram Sector 3' },
              { '@type': 'Place', name: 'R.K. Puram Sector 4' },
              { '@type': 'Place', name: 'R.K. Puram Sector 5' },
              { '@type': 'Place', name: 'R.K. Puram Sector 6' },
              { '@type': 'Place', name: 'R.K. Puram Sector 7' },
              { '@type': 'Place', name: 'R.K. Puram Sector 8' },
              { '@type': 'Place', name: 'R.K. Puram Sector 9' },
              { '@type': 'Place', name: 'R.K. Puram Sector 10' },
              { '@type': 'Place', name: 'R.K. Puram Sector 11' },
              { '@type': 'Place', name: 'R.K. Puram Sector 12' },
              { '@type': 'Place', name: 'R.K. Puram Sector 13' },
              { '@type': 'Place', name: 'Munirka' },
              { '@type': 'Place', name: 'Munirka Village' },
              { '@type': 'Place', name: 'Munirka Enclave' },
              { '@type': 'Place', name: 'Vasant Vihar' },
              { '@type': 'Place', name: 'Vasant Enclave' },
              { '@type': 'Place', name: 'Moti Bagh' },
              { '@type': 'Place', name: 'Shanti Niketan' },
              { '@type': 'Place', name: 'Anand Niketan' },
              { '@type': 'Place', name: 'Satya Niketan' },
              { '@type': 'Place', name: 'South Campus' },
              { '@type': 'Place', name: 'Dhaula Kuan' },
              { '@type': 'Place', name: 'Naraina' },
              { '@type': 'Place', name: 'Naraina Vihar' },
              { '@type': 'Place', name: 'Safdarjung Enclave' },
              { '@type': 'Place', name: 'Bhikaji Cama Place' },
              { '@type': 'Place', name: 'Vasant Kunj' },
              { '@type': 'Place', name: 'Ber Sarai' },
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Doorstep Bike, Scooty and Car Service in Rama Krishna Puram',
            provider: { '@type': 'LocalBusiness', name: 'Garage Fix Care' },
            areaServed: 'Rama Krishna Puram, New Delhi',
            description: 'At-home bike, scooty and car servicing across Rama Krishna Puram and nearby South-West Delhi areas including R.K. Puram Sector 1 to Sector 13, Munirka, Munirka Village, Munirka Enclave, Vasant Vihar, Vasant Enclave, Moti Bagh, Shanti Niketan, Anand Niketan, Satya Niketan, South Campus, Dhaula Kuan, Naraina, Naraina Vihar, Safdarjung Enclave, Bhikaji Cama Place, Vasant Kunj, Ber Sarai and Rao Tula Ram Marg. Bike and scooty service starts at ₹299, covering oil change, engine repair, battery replacement, brake repair, tyre service and puncture fix. Car service is quote-based and depends on the car model and work required — same-day doorstep service subject to availability.',
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Best Bike, Scooty and Car Service in Rama Krishna Puram', item: 'https://www.garagefixcare.in/best-bike-service-rama-krishna-puram' },
            ],
          },
        ]}
      />
      ...
      <div className="min-h-screen">
        ...
        <main className="bg-slate-800" style={{ paddingTop: `${heroTopOffset}px` }}>
          <section className="relative text-white overflow-hidden min-h-[700px] sm:min-h-[600px] lg:min-h-[680px]">
            ...
            <div className="absolute inset-0 sm:relative z-10 w-full sm:px-6 lg:pl-[6vw] lg:pr-6 sm:py-10 lg:py-12">
              {/* TOP ZONE — H1 + subheading (Rama Krishna Puram specific) */}
              <motion.div
              ...
              >
                ...
                >
                  Best Bike, Scooty and Car Service in Rama Krishna Puram
                ...
                >
                  Trusted by residents across R.K. Puram Sector 1 to Sector 13, Munirka, Vasant Vihar, Moti Bagh, Shanti Niketan, Anand Niketan, Satya Niketan, Dhaula Kuan and Safdarjung Enclave — our certified mechanics handle bikes, scooties and cars right at your doorstep.
                </motion.p>
              </motion.div>
        ...
        {/* Dark premium information strip — Rama Krishna Puram specific copy */}
        <motion.div
          className="w-full"
          style={{
        ...
        <div className="bg-sky-100 border-y border-gray-200 py-2 overflow-hidden">
          <div className="flex items-center text-sm sm:text-sm font-semibold max-w-7xl mx-auto">
            <div className="flex-shrink-0 px-2 sm:px-2 pr-2">
              <span className="text-red-600 mr-1 sm:mr-2 font-bold">Doorstep Bike Service in R.K. Puram </span>
        ...
        {/* Hot Deals This Week — Rama Krishna Puram specific copy, Delhi Cantt-style marquee */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-white max-w-7xl mx-auto mt-2 text-center">
                Limited-time offer for R.K. Puram, Munirka and Vasant Vihar customers! Get up to 10% off on bike, scooty and car repairs and servicing at your doorstep, starting at ₹299. Hurry—these deals won&apos;t last long!
              </p>
            </motion.div>
          </div>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-white/70 max-w-xl mx-auto">Service support for leading two-wheeler brands across Rama Krishna Puram and Delhi.</p>
            </motion.div>
          </div>
        ...
        {/* At-Home Service Price List — Rama Krishna Puram pricing (premium vertical service-plan cards) */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-base sm:text-xl text-white mb-10 sm:mb-12 max-w-3xl mx-auto">
                Transparent pricing for doorstep bike and scooty service in Rama Krishna Puram and nearby South-West Delhi areas, starting at just ₹299. Check the labour charges below based on your two-wheeler&apos;s engine size — no hidden fees, no surprises. Looking for car service instead? Tap Cars above for a tailored quote.
              </p>
            </motion.div>
            <motion.div
        ...
        {/* Areas Covered — Rama Krishna Puram localities */}
        <section className="py-10 sm:py-14 bg-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service Areas in <span className="text-red-600">Rama Krishna Puram</span>
            </motion.h2>
            <motion.div
            ...
            <motion.p
              ...
              viewport={viewportOnce}
            >
              Whether you live in R.K. Puram Sector 1 to Sector 13, Munirka, Munirka Village, Munirka Enclave, Vasant Vihar, Vasant Enclave, Moti Bagh, Shanti Niketan, Anand Niketan, Satya Niketan, South Campus, Dhaula Kuan, Naraina, Naraina Vihar, Safdarjung Enclave, Bhikaji Cama Place, Vasant Kunj, Ber Sarai or Rao Tula Ram Marg, our bike, scooty and car mechanics reach your doorstep. Same-day doorstep service is available across the Rama Krishna Puram belt, subject to location and technician availability, starting at ₹299 for bike and scooty service.
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
                Complete Bike, Scooty &amp; Car Care, <span className="text-red-600">Right at Your Door in Rama Krishna Puram</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4 sm:mb-6 max-w-2xl mx-auto">
                From routine oil changes to full engine repair — our Rama Krishna Puram mechanics handle bikes, scooties and cars at your location, starting at ₹299 for bike and scooty service. No waiting, no hassle.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              {bikeServiceCards.map((service, index) => (
                ...
                >
                  <img
                    src={service.img}
                    alt={`${service.name} in Rama Krishna Puram`}
        ...
        {/* Comprehensive SEO Content (Rama Krishna Puram specific) */}
        <section className="py-10 sm:py-14 bg-slate-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Why Garage Fix Care is the <span className="text-red-600">Best Bike, Scooty and Car Service in Rama Krishna Puram</span>
            </motion.h2>
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <p>Rama Krishna Puram — known locally as R.K. Puram — is one of South-West Delhi&apos;s most well-planned residential areas, with its numbered sectors stretching from Sector 1 to Sector 13 and bordered by bustling commercial and academic hubs like Munirka, Vasant Vihar, Moti Bagh and the South Campus of Delhi University. Thousands of two-wheeler and car owners here depend on their vehicles for daily office commutes, college runs, market trips to Munirka and Vasant Vihar, and metro feeder rides to R.K. Puram Metro Station and Munirka Metro Station. Garage Fix Care is Rama Krishna Puram&apos;s trusted doorstep vehicle service, bringing certified and background-verified mechanics directly to your home, society parking or office — whether you live in Sector 4, Sector 5, Sector 6, Sector 8, Sector 9, Sector 12 or anywhere else in R.K. Puram, or are based closer to Munirka, Vasant Vihar, Shanti Niketan or Safdarjung Enclave. Our mechanics typically reach your location within 2–4 hours of booking, subject to availability. Doorstep bike and scooty service starts at just ₹299 — covering all essential checks including engine oil change, air filter cleaning, spark plug inspection, brake adjustment and basic electrical check — with every task completed on the spot. We also handle car servicing and repairs at your doorstep, with pricing quoted based on your car&apos;s model and requirement. We service every major two-wheeler brand seen across Rama Krishna Puram: Hero, Honda, Bajaj, TVS, Suzuki, Yamaha, Royal Enfield, KTM and more, from daily commuters and family scooties like the Honda Activa, TVS Jupiter and Suzuki Access, to premium machines like the Royal Enfield Classic 350 and KTM Duke 390, alongside popular hatchbacks and sedans. What distinguishes us as the best bike, scooty and car service in Rama Krishna Puram is our strict pricing transparency — you receive a full itemised estimate before a single tool is touched, ensuring zero hidden charges at the end. We use only genuine engine oils from Motul and Wurth, paired with manufacturer-approved spare parts, and each service is backed by our 10-day hassle-free service guarantee.</p>
              <p>Rama Krishna Puram&apos;s dense residential layout, the constant traffic around Munirka&apos;s market area, and the busy flow towards Dhaula Kuan and Rao Tula Ram Marg all accelerate wear on engine oil, air filters, tyres and brakes — making regular servicing a genuine safety necessity for bikes, scooties and cars alike. Our mechanics carry professional diagnostic tools to identify emerging issues before they become expensive failures, significantly extending your vehicle&apos;s lifespan whether you commute daily towards Bhikaji Cama Place or just ride around your sector. We also handle emergency breakdown situations across Rama Krishna Puram — if your bike, scooty or car stops near Munirka Metro Station, Vasant Vihar or anywhere on the way to Naraina Vihar, call us and we dispatch a mechanic to your exact location as soon as possible. From battery replacement and brake pad changes to clutch cable adjustment and tyre puncture repair, our technicians fix it all on the spot without towing. Garage Fix Care has completed over 1,00,000 services across Delhi NCR, earning a consistent 4.7-star Google rating for professionalism, punctuality and honest pricing. Book your bike, scooty or car service in R.K. Puram Sector 1, Sector 2, Sector 3, Sector 4, Sector 5, Sector 6, Sector 7, Sector 8, Sector 9, Sector 10, Sector 11, Sector 12 or Sector 13, or nearby areas like Munirka, Munirka Village, Munirka Enclave, Vasant Vihar, Vasant Enclave, Moti Bagh, Shanti Niketan, Anand Niketan, Satya Niketan, South Campus, Dhaula Kuan, Naraina, Naraina Vihar, Safdarjung Enclave, Bhikaji Cama Place, Vasant Kunj, Ber Sarai or Rao Tula Ram Marg today via our website, WhatsApp or direct call — and discover the convenience of professional doorstep vehicle care starting at just ₹299 for bike and scooty service.</p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <p className="text-xs sm:text-sm font-semibold text-orange-400 uppercase tracking-wide mb-1">
                Get Rs.10 Off On First Service in Rama Krishna Puram
              </p>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2">
                GarageFixCare <span className="text-red-600">Service Warranty</span>
              </h2>
              <p className="text-sm sm:text-base text-white mb-4">
                Rama Krishna Puram&apos;s trusted doorstep bike, scooty and car service, starting at ₹299. We service all major motorcycle, scooter and car brands — Royal Enfield, Hero, Honda, Bajaj, TVS, Yamaha, KTM and more — right at your home or society parking near Munirka and Vasant Vihar.
              </p>
            </motion.div>
            <motion.div
        ...
        <section className="py-12 sm:py-16 bg-slate-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div
              ...
              viewport={viewportOnce}
            >
              <img src={whyChooseImg} alt="Why Choose GarageFixCare in Rama Krishna Puram" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
            <motion.div className="order-1 lg:order-2" variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                We bring certified mechanics for bikes, scooties and cars directly to residents across Rama Krishna Puram, Munirka, Vasant Vihar, Moti Bagh and Safdarjung Enclave — doorstep service starting at ₹299, with honest pricing, genuine parts and zero hassle.
              </p>
        ...
        <section className="bg-slate-800 text-white py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-center">
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <p className="text-sm sm:text-base text-white mb-4">
                Getting your bike, scooty or car serviced in Rama Krishna Puram is simple. Book online or call us, and a skilled mechanic arrives at your doorstep with everything needed to get your vehicle running at its best — starting at ₹299 for bike and scooty service, all done on the spot.
              </p>
              <ul className="space-y-2 text-left">
            ...
            <motion.div className="flex justify-center" variants={scaleIn} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              <img src={bmw310Image} alt="How GarageFixCare Works in Rama Krishna Puram" className="rounded-xl shadow-lg w-full max-w-xs sm:max-w-sm" loading="lazy" decoding="async" />
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-slate-800 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {[
                { name: 'Vikram Bisht', img: testimonial1, text: 'Doorstep service in R.K. Puram Sector 4 was fast and professional.', time: 'a month ago' },
                { name: 'Pooja Rathi', img: testimonial2, text: 'Transparent billing with video evidence, booked from Munirka. Very reliable.', time: 'a month ago' },
        ...
        {/* FAQs (Rama Krishna Puram specific — matches FAQPage schema exactly) */}
        <section className="bg-slate-900 py-10 sm:py-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              ...
              viewport={viewportOnce}
            >
              Bike, Scooty &amp; Car Service in Rama Krishna Puram — <span className="text-red-600">Common Questions</span>
            </motion.h2>
        ...
        <section className="py-10 sm:py-14 bg-slate-800">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-3">
              Book Bike, Scooty or Car Service in Rama Krishna Puram Today
            </h2>
            <p className="text-sm sm:text-base text-white mb-3 sm:mb-5 max-w-xl mx-auto">
              Same-day doorstep service across Rama Krishna Puram and nearby areas starting at ₹299. Our mechanic comes to you — no travel, no waiting, no hidden charges.
            </p>
            <a
              href="https://www.garagefixcare.in/bookservice"
...
export default BestBikeServiceRamaKrishnaPuram;